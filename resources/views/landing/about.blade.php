...
<body>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded align-self-end" style="margin-top: 80px" src="{{ asset('frontend/img/Capture001.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="d-inline-block rounded-pill py-1 px-4" style="border: 1px solid #fd7e14">About Us</p>

                    <h1 class="mb-4">History of Barangay Imbatug</h1>
    ...
    <div class="container-fluid" style="background: linear-gradient(to right, #800080, #FF4500); margin-bottom:-50px">
                ...
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <div class="slideshow" style="display: none;">
                            ...
                            <p class="text-white mb-4 pb-2">Your Vision content here.</p>
                        </div>
                        <div class="slideshow" style="display: none;">
                            <h1 class="text-white mb-4">Core Values</h1>
                            <p class="text-white mb-4 pb-2">Your Core Values content here.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid" style="height: 300px; width:auto; margin-top:50px; margin-left:50px;" src="{{ asset('frontend/img/mission.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Set the interval for the slideshow (e.g., every 5 seconds)
            var slideshowInterval = setInterval(nextSlide, 5000);
        
            // Optionally, you can pause the slideshow on hover
