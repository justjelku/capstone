...
<head>
    <meta charset="utf-8">
    <title>Barangay Imbatug | Services</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s" style="background: gainsboro">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('barangay.service') }}" class="nav-item nav-link active">Services</a>
        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item"><a class="text-white" href="#">Officials</a></li>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <p class="d-inline-block rounded-pill py-1 px-4" style="color: orange; font-size: 30px; border: 2px solid orange;">Services</p>
