                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="tribe" id="tribeSelect" class="form-select mb-3 form-control">
                                        ...
                                        <option value="other">Other</option> <!-- Corrected closing tag -->
                                    </select>
                                    <input type="text" class="form-control mb-3" id="otherTribeInput" name="tribe" placeholder="Enter tribe" style="display: none;">
                                </div>
                            </div>                            
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="religion" class="form-select mb-3 form-control" id="religionSelect">
                                    ...
                                    <input type="text" class="form-control mb-3" id="otherReligionInput" name="religion" placeholder="Enter religion" style="display: none;">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="registered_voter" class="form-select mb-3 form-control" id="voterSelect">
                                        <option value="" selected disabled>Select answer</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                    <input type="text" name="registered_voter" id="otherVoterInput" class="form-control mb-3" placeholder="Enter precint information" style="display: none;">
                                </div>
                            </div>
...
tribeSelect.addEventListener('change', (event) => {
  const selectedOption = event.target.value;

  if (selectedOption === 'other') {
    otherTribeInput.style.display = 'block';
    otherTribeInput.disabled = false; // Enable the input field if 'Other' is selected
  } else {
    otherTribeInput.style.display = 'none';
    otherTribeInput.disabled = true; // Disable the input field if other options are selected
    otherTribeInput.value = ''; // Clear the input value
  }
});
...
religionSelect.addEventListener('change', (event) => {
  const selectedOption = event.target.value;

  if (selectedOption === 'Others') {
    otherReligionInput.style.display = 'block';
    otherReligionInput.disabled = false; // Enable the input field if 'Other' is selected
  } else {
    otherReligionInput.style.display = 'none';
    otherReligionInput.disabled = true; // Disable the input field if other options are selected
...
<script>
    ...
    const otherVoterInput = document.getElementById('otherVoterInput');
    
    
    voterSelect.addEventListener('change', (event) => {
      const selectedOption = event.target.value;
    
      if (selectedOption === 'Yes') {
        otherVoterInput.style.display = 'block';
        otherVoterInput.disabled = false; // Enable the input field if 'Other' is selected
      } else {
        otherVoterInput.style.display = 'none';
        otherVoterInput.disabled = true; // Disable the input field if other options are selected
        otherVoterInput.value = ''; // Clear the input value
      }
    });
