                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="status" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Resigned" {{ $edit_official->status == 'Resigned' ? 'selected' : '' }}>Resigned</option>
                                        <option value="Suspended" {{ $edit_official->status == 'Suspended' ? 'selected' : '' }}>Suspended</option>
                                        <option value="Elected" {{ $edit_official->status == 'Elected' ? 'selected' : '' }}>Elected</option>
                                        <option value="Appointed" {{ $edit_official->status == 'Appointed' ? 'selected' : '' }}>Appointed</option>
                                    </select>
                                </div>
                            </div><!-- Col -->
                        </div><!-- Row -->
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="term_start" name="term_start" class="form-control flatpickr-input active" placeholder="Select date" value="{{ old('term_start', $edit_official->term_start) }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="term_end" name="term_end" class="form-control flatpickr-input active" placeholder="Select date" value="{{ old('term_end', $edit_official->term_end) }}">
                                        <span class="input-group-text input-group-addon" data-toggle="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
                                                <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                                <line x1="16" y1="2" x2="16" y2="6"></line>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="purok" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Purok 1" {{ $edit_official->purok == 'Purok 1' ? 'selected' : '' }}>Purok 1</option>
                                        <option value="Purok 2" {{ $edit_official->purok == 'Purok 2' ? 'selected' : '' }}>Purok 2</option>
                                        <option value="Purok 3" {{ $edit_official->purok == 'Purok 3' ? 'selected' : '' }}>Purok 3</option>
                                        <option value="Purok 4" {{ $edit_official->purok == 'Purok 4' ? 'selected' : '' }}>Purok 4</option>
                                        <option value="Purok 5" {{ $edit_official->purok == 'Purok 5' ? 'selected' : '' }}>Purok 5</option>
                                        <option value="Purok 6" {{ $edit_official->purok == 'Purok 6' ? 'selected' : '' }}>Purok 6</option>
                                        <option value="Purok 7" {{ $edit_official->purok == 'Purok 7' ? 'selected' : '' }}>Purok 7</option>
                                        <option value="Purok 8" {{ $edit_official->purok == 'Purok 8' ? 'selected' : '' }}>Purok 8</option>
                                        <option value="Purok 9" {{ $edit_official->purok == 'Purok 9' ? 'selected' : '' }}>Purok 9</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
