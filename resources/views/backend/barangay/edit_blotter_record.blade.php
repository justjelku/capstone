                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="incident_type" placeholder="Enter incident type" class="form-control custom-input @error('incident_type') is-invalid @enderror" value="{{ $edit_blotter_record->incident_type }}">
                                    @error('incident_type')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name "respondent_phone" placeholder="Enter respondent phone" class="form-control custom-input @error('respondent_phone') is-invalid @enderror" value="{{ $edit_blotter_record->respondent_phone }}" >
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="respondent_age" placeholder="Enter respondent age" class="form-control custom-input @error('respondent_age') is-invalid @enderror" value="{{ $edit_blotter_record->_age }}" >
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="complainant_phone" placeholder="Enter complainant phone" class="form-control custom-input @error('complainant_phone') is-invalid @enderror" value="{{ $edit_blotter_record->complainant_phone }}">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="complainant_age" placeholder="Enter complainant age" class="form-control custom-input @error('complainant_age') is-invalid @enderror" value="{{ $edit_blotter_record->complainant_age }}" >
                            ...
                            <div class="col-sm-12">
    							<div class="mb-3">
        							...
        							<textarea name="list_mediators" placeholder="Enter mediators names" rows="6" class="form-control custom-input @error('list_mediators') is-invalid @enderror">{{ old('list_mediators', $edit_blotter_record->list_mediators) }}</textarea>
