                  ...
                  <table id="dataTableExample" class="table border-secondary border-top table-bordered table-hover table-striped">
                    <thead style="background: #FCD299">
                      <tr>
                        ...
                        <th style="text-align: center;">1st Quarter Assembly</th>
                        <th style="text-align: center;">2nd Quater Assembly</th>
                        <th style="text-align: center;">3rd Quater Assembly</th>
                        <th style="text-align: center;">4th Quater Assembly</th>
