...
!function () {
  ...
  var s = "undefined" != typeof window ? window : Function("return this;")(),
      r = function (e, t, n) {
    var a = window.Prism;
    window.Prism = {
      manual: !0
    ...
    var s = function (e) {
      var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
        ...
        util: {
          ...
          clone: function e(t, n) {
            ...
            switch (n = n || {}, s.util.type(t)) {
              ...
              case "Array":
                return r = s.util.objId(t), n[r] ? n[r] : (a = [], n[r] = a, t.forEach(function (t, s) {
                  a[s] = e(t, n);
                }), a);
        ...
        highlightElement: function highlightElement(t, n, a) {
          ...
          function u(e) {
            l.highlightedCode = e, s.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, s.hooks.run("after-highlight", l), s.hooks.run("complete", l), a && a.call(l.element);
          }

          if (s.hooks.run("before-sanity-check", l), (o = l.element.parentElement) && "pre" === o.nodeName.toLowerCase() && !o.hasAttribute("tabindex") && o.setAttribute("tabindex", "0"), !l.code) return s.hooks.run("complete", l), void (a && a.call(l.element));
        ...
        highlight: function highlight(e, t, n) {
          ...
          if (s.hooks.run("before-tokenize", a), !a.grammar) throw new Error('The language "' + a.language + '" has no grammar.');
          return a.tokens = s.tokenize(a.code, a.grammar), s.hooks.run("after-tokenize", a), r.stringify(s.util.encode(a.tokens), a.language);
        },
        tokenize: function tokenize(e, t) {
          ...
          var s = new l();
          return u(s, s.head, e), o(e, s, t, s.head, 0), function (e) {
        ...
        hooks: {
          ...
          run: function run(e, t) {
            var n = s.hooks.all[e];
            if (n && n.length) for (var a, r = 0; a = n[r++];) {
              a(t);
            }
          }
        },
        ...
        for (var g in n) {
          if (n.hasOwnProperty(g) && n[g]) {
            ...
            for (var b = 0; b < p.length; ++b) {
              ...
              for (var v = h.pattern || h, _ = a.next, x = l; _ !== t.tail && !(d && x >= d.reach); x += _.value.length, _ = _.next) {
                var F = _.value;
                ...
                if (!(F instanceof r)) {
                  ...
                  if (B && (N = u(t, N, B), x += B.length), c(t, N, S), _ = u(t, N, new r(g, f ? s.tokenize(j, f) : j, w, j)), T && u(t, _, T), S > 1) {
                    var O = {
                      cause: g + "," + b,
                      reach: P
                    };
                    o(e, t, n, _.prev, x, O), d && O.reach > d.reach && (d.reach = O.reach);
                  }
                }
              }
            }
      ...
      function c(e, t, n) {
        for (var a = t.next, s = 0; s < n && a !== e.tail; s++) {
          a = a.next;
        }
      ...
      if (e.Prism = s, r.stringify = function e(t, n) {
    ...
    return s.languages.clike = {
      ...
      Object.defineProperties(e.languages["markup-templating"] = {}, {
        buildPlaceholders: {
          value: function value(n, a, s, r) {
            if (n.language === a) {
              var i = n.tokenStack = [];
              n.code = n.code.replace(s, function (e) {
                if ("function" == typeof r && !r(e)) return e;

                for (var s, o = i.length; -1 !== n.code.indexOf(s = t(a, o));) {
                  ++o;
                }
                  ...
                  if ("string" == typeof u || u.content && "string" == typeof u.content) {
                    ...
                    if (b > -1) {
                      ...
                      var h = g.substring(0, b),
                          ...
                          y = [];
                      h && y.push.apply(y, i([h])), y.push(f), m && y.push.apply(y, i([m])), "string" == typeof u ? o.splice.apply(o, [l, 1].concat(y)) : u.content = y;
                    }
    ...
    }), delete s.languages.c["boolean"], function (e) {
      ...
      e.languages.csharp = e.languages.extend("clike", {
        ...
        "class-name": [{
          ...
          pattern: n(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [h, _]),
          lookbehind: !0,
          inside: x
        }, {
        ...
        "type-list": {
          pattern: n(/\b((?:<<0>>\s+<<1>>|record\s+<<1>>\s*<<5>>|where\s+<<2>>)\s*:\s*)(?:<<3>>|<<4>>|<<1>>\s*<<5>>|<<6>>)(?:\s*,\s*(?:<<3>>|<<4>>|<<6>>))*(?=\s*(?:where|[{;]|=>|$))/.source, [u, f, h, _, c.source, b, /\bnew\s*\(\s*\)/.source]),
          lookbehind: !0,
          inside: {
            "record-arguments": {
    ...
    }(s), s.languages.javascript = s.languages.extend("clike", {
      ...
      operator: /[-+%=]=?|!=|:=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
      punctuation: /[{}[\];(),.:]/
    }, s.languages.python["string-interpolation"].inside.interpolation.inside.rest = s.languages.python, s.languages.py = s.languages.python, function (e) {
      ...
      var n = "(?:" + [/([^a-zA-Z0-9\s{(\[<=])(?:(?!\1)[^\\]|\\[\s\S])*\1/.source, /\((?:[^()\\]|\\[\s\S]|\((?:[^()\\]|\\[\s\S])*\))*\)/.source, /\{(?:[^{}\\]|\\[\s\S]|\{(?:[^{}\\]|\\[\s\S])*\})*\}/.source, /\[(?:[^\[\]\\]|\\[\s\S]|\[(?:[^\[\]\\]|\\[\s\S])*\])*\]/.source, /<(?:[^<>\\]|\\[\s\S]|<(?:[^<>\\]|\\[\s\S])*>)*>/.source].join("|") + ")",
    ...
    return function (t) {
      ...
      o = i("codesample_languages"),
      l = i("codesample_global_prismjs"),
      u = function u(e) {
    return s.Prism && l(e) ? s.Prism : r;
  },
      c = function c(e) {
    return e && "PRE" === e.nodeName && -1 !== e.className.indexOf("language-");
  },
      d = function d(e) {
    var t = e.selection ? e.selection.getNode() : null;
    return a = t, c(t) ? n.some(a) : n.none();
    var a;
  },
      g = function g(e) {
    var s = function (e) {
      return o(e) || [{
        ...
        r = (c = s, function (e, t) {
      return 0 < e.length ? n.some(e[0]) : n.none();
    }(c)).fold(t(""), function (e) {
      return e.value;
    }),
        i = function (e, t) {
      return d(e).fold(function () {
        return t;
      }, function (e) {
      ...
      onSubmit: function onSubmit(t) {
        ...
        (function (e, t, n) {
          ...
          e.undoManager.transact(function () {
            var r = d(e);
            return n = a.DOM.encode(n), r.fold(function () {
              e.insertContent('<pre id="__new" class="language-' + t + '">' + n + "</pre>");
              var a = s.select("#__new")[0];
              s.setAttrib(a, "id", null), e.selection.select(a);
            }, function (a) {
              s.setAttrib(a, "class", "language-" + t), a.innerHTML = n, u(e).highlightElement(a), e.selection.select(a);
            });
          });
        })(e, n.language, n.code), t.close();
      }
    });
  },
      p = (b = /^\s+|\s+$/g, function (e) {
    return e.replace(b, "");
  });

  var b,
      h = tinymce.util.Tools.resolve("tinymce.util.Tools");
  e.add("codesample", function (e) {
    (function (e) {
      var t = e.options.register;
      t("codesample_languages", {
        processor: "object[]"
      }), t("codesample_global_prismjs", {
        processor: "boolean",
        "default": !1
      });
    })(e), function (e) {
      e.on("PreProcess", function (t) {
        ...
        h.each(h.grep(a, c), function (e) {
          var t = e.textContent;
          var a;

          for (n.setAttrib(e, "class", p(n.getAttrib(e, "class"))), n.setAttrib(e, "contentEditable", null), n.setAttrib(e, "data-mce-highlighted", null); a = e.firstChild;) {
            e.removeChild(a);
          }
        ...
        var t = e.dom,
            n = h.grep(t.select("pre"), function (e) {
          return c(e) && "true" !== t.getAttrib(e, "data-mce-highlighted");
        });
        n.length && e.undoManager.transact(function () {
          h.each(n, function (n) {
            var a;
            h.each(t.select("br", n), function (n) {
              t.replace(e.getDoc().createTextNode("\n"), n);
            }), n.innerHTML = t.encode(null !== (a = n.textContent) && void 0 !== a ? a : ""), u(e).highlightElement(n), t.setAttrib(n, "data-mce-highlighted", !0), n.className = p(n.className);
          });
        });
      }), e.on("PreInit", function () {
        e.parser.addNodeFilter("pre", function (e) {
          var t;

          for (var _n = 0, _a = e.length; _n < _a; _n++) {
            var _a2 = e[_n];
            -1 !== (null !== (t = _a2.attr("class")) && void 0 !== t ? t : "").indexOf("language-") && (_a2.attr("contenteditable", "false"), _a2.attr("data-mce-highlighted", "false"));
          }
        });
      });
    }(e), function (e) {
      var t = function t() {
        return e.execCommand("codesample");
      };
      ...
      }), e.ui.registry.addMenuItem("codesample", {
        text: "Code sample...",
        icon: "code-sample",
        onAction: t
      });
      ...
      e.addCommand("codesample", function () {
        ...
        e.selection.isCollapsed() || c(t) ? g(e) : e.formatter.toggle("code");
      });
    }(e), e.on("dblclick", function (t) {
      c(t.target) && g(e);
    });
  });
}();