  ...
  return function () {
    var e = {
      ...
      260: function _(e, t, n) {
        ...
        if ((!T || !E || E === k) && (E = w.prototype, T)) for (r in L) {
      ...
      1048: function _(e, t, n) {
        ...
        e.exports = [].copyWithin || function (e, t) {
          ...
          for (l < s && s < l + f && (p = -1, l += f - 1, s += f - 1); f-- > 0;) {
      ...
      8457: function _(e, t, n) {
        ...
        e.exports = function (e) {
          var t,
              ...
              b = l(d),
              x = 0;
          if (m && (g = r(g, y > 2 ? arguments[2] : void 0, 2)), null == b || v == Array && a(b)) for (n = new v(t = u(d.length)); t > x; x++) {
            h = m ? g(d[x], x) : d[x], s(n, x, h);
          } else for (p = (f = b.call(d)).next, n = new v(); !(c = p.call(f)).done; x++) {
        ...
        var r = n(9974),
          ...
          return function (d, v, y, g) {
            for (var m, b, x = o(d), w = i(x), E = r(v, y, 3), k = a(w.length), A = 0, S = g || u, F = t ? S(d, k) : n || p ? S(d, 0) : void 0; k > A; A++) {
              if ((h || A in w) && (b = E(m = w[A], A, x), e)) if (t) F[A] = b;else if (b) switch (e) {
                case 3:
                  return !0;
      ...
      7321: function _(e, t, n) {
        ...
        e.exports = function (e) {
          var t,
              ...
              y = void 0 !== v,
              g = o(h);
          if (null != g && !a(g)) for (p = (f = g.call(h)).next, h = []; !(c = p.call(f)).done;) {
            h.push(c.value);
          }

          for (y && d > 2 && (v = u(v, arguments[2], 2)), n = i(h.length), l = new (s(this))(n), t = 0; n > t; t++) {
            l[t] = y ? v(h[t], t) : h[t];
          }
      ...
      7042: function _(e, t, n) {
        ...
        r({
          ...
          slice: function slice(e, t) {
            ...
            for (r = new (void 0 === n ? Array : n)(d(g - y, 0)), c = 0; y < g; y++, c++) {
              y in f && l(r, c, f[y]);
            }
      ...
      561: function _(e, t, n) {
        ...
        r({
          ...
          splice: function splice(e, t) {
            ...
            } else if (n > r) for (v = b - r; v > x; v--) {
              g = v + n - 1, (y = v + r - 1) in m ? m[g] = m[y] : delete m[g];
            }
      ...
      3123: function _(e, t, n) {
        ...
        r("split", 2, function (e, t, n) {
          ...
          return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (e, n) {
            ...
            for (var u, s, l, c = [], p = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), d = 0, y = new RegExp(e.source, p + "g"); (u = f.call(y, r)) && !((s = y.lastIndex) > d && (c.push(r.slice(d, u.index)), u.length > 1 && u.index < r.length && h.apply(c, u.slice(1)), l = u[0].length, d = s, c.length >= o));) {
      ...
      3948: function _(e, t, n) {
        ...
        for (var f in i) {
          ...
          if (h) {
            ...
            if (h[l] || a(h, l, f), i[f]) for (var d in o) {
              if (h[d] !== o[d]) try {
                a(h, d, o[d]);
              } catch (e) {
                h[d] = o[d];
        ...
        u(H, {
          ...
          set: function set(e, t) {
            ...
            for (var n, r = C(this), i = r.entries, o = !1, a = e + "", u = t + "", s = 0; s < i.length; s++) {
              (n = i[s]).key === a && (o ? i.splice(s--, 1) : (o = !0, n.value = u));
            }
      ...
      285: function _(e, t, n) {
        ...
        var r,
          ...
          if (null !== c) for (a = l - c, l = 7; 0 != l && a > 0;) {
            ...
            switch (a = o[p], c) {
              ...
              case xe:
                if (a == r || "/" == a || "\\" == a && X(e) || !n && ("?" == a || "#" == a)) {
                  if (".." === (l = (l = d).toLowerCase()) || "%2e." === l || ".%2e" === l || "%2e%2e" === l ? (te(e), "/" == a || "\\" == a && X(e) || e.path.push("")) : ne(d) ? "/" == a || "\\" == a && X(e) || e.path.push("") : ("file" == e.scheme && !e.path.length && J(d) && (e.host && (e.host = ""), d = d.charAt(0) + ":"), e.path.push(d)), d = "", "file" == e.scheme && (a == r || "?" == a || "#" == a)) for (; e.path.length > 1 && "" === e.path[0];) {
                    e.path.shift();
                  }
          ...
          value: function value(e) {
            ...
            this._transformFiles(e, function (n) {
              ...
              if (e[0].upload.chunked) {
                ...
                }, t.options.parallelChunkUploads) for (var s = 0; s < o.upload.totalChunkCount; s++) {
                  u();
                } else u();
              } else {
          ...
          value: function value(e, t) {
            ...
            if (this.options.params) {
              ...
              for (var v in "function" == typeof d && (d = d.call(this, e, o, e[0].upload.chunked ? this._getChunk(e[0], o) : null)), d) {
                var y = d[v];
                if (Array.isArray(y)) for (var g = 0; g < y.length; g++) {
                  h.append(v, y[g]);
                } else h.append(v, y);
              }
            }
          ...
          value: function value(e, t, n) {
            if (e[0].upload.chunked) {
              ...
              for (var o = 0; o < r.upload.totalChunkCount; o++) {
                r.upload.chunks[o] && void 0 !== r.upload.chunks[o].progress && (r.upload.progress += r.upload.chunks[o].progress, r.upload.total += r.upload.chunks[o].total, r.upload.bytesSent += r.upload.chunks[o].bytesSent);
              }
