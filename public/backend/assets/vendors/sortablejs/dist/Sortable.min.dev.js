...
!function (t, e) {
  ...
  function Y(t, e) {
    for (var n = t.lastElementChild; n && (n === Bt.ghost || "none" === P(n, "display") || e && !p(n, e));) {
  ...
  function B(t, e) {
    ...
    for (; t = t.previousElementSibling;) {
      "TEMPLATE" === t.nodeName.toUpperCase() || t === Bt.clone || e && !p(t, e) || n++;
    }
  ...
  var H = [],
    ...
    mount: function mount(e) {
      for (var t in L) {
        !L.hasOwnProperty(t) || t in e || (e[t] = L[t]);
      }
  ...
  Bt.prototype = {
    ...
    _prepareDragStart: function _prepareDragStart(t, e, n) {
      ...
      n && !q && n.parentNode === r && (o = k(n), $ = r, V = (q = n).parentNode, Q = q.nextSibling, J = n, at = a.group, st = {
        ...
        clientX: (e || t).clientX,
        clientY: (e || t).clientY
      }, ht = st.clientX - o.left, ft = st.clientY - o.top, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, q.style["will-change"] = "all", o = function o() {
        z("delayEnded", i, {
          evt: t
    ...
    _emulateDragOver: function _emulateDragOver() {
      if (ct) {
        ...
        for (var t = document.elementFromPoint(ct.clientX, ct.clientY), e = t; t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(ct.clientX, ct.clientY)) !== e;) {
          e = t;
        }
    ...
    _appendGhost: function _appendGhost() {
      if (!Z) {
        ...
        if (Ot) {
          for (bt = t; "static" === P(bt, "position") && "none" === P(bt, "transform") && bt !== document;) {
            bt = bt.parentNode;
          }
    ...
    toArray: function toArray() {
      for (var t, e = [], n = this.el.children, o = 0, i = n.length, r = this.options; o < i; o++) {
        N(t = n[o], r.draggable, this.el, !1) && e.push(t.getAttribute(r.dataIdAttr) || function (t) {
  ...
  return Bt.mount(new function () {
    ...
    return t.prototype = {
      ...
      setupClone: function setupClone(t) {
        ...
        if (this.isMultiDrag) {
          for (var n = 0; n < ce.length; n++) {
            ue.push(_(ce[n])), ue[n].sortableIndex = ce[n].sortableIndex, ue[n].draggable = !1, ue[n].style["will-change"] = "", I(ue[n], this.options.selectedClass, !1), ce[n] === ae && I(ue[n], this.options.chosenClass, !1);
          }
      ...
      drop: function drop(t) {
        ...
        if (e) {
          var c,
              ...
              h = this.options,
              f = o.children;
          if (!fe) if (h.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), I(ae, h.selectedClass, !~ce.indexOf(ae)), ~ce.indexOf(ae)) ce.splice(ce.indexOf(ae), 1), ie = null, W({
            sortable: i,
            rootEl: n,
            name: "deselect",
            targetEl: ae,
            ...
            if (ce.push(ae), W({
              ...
              if (~p && ~t && p !== t) for (var g, m = p < t ? (g = p, t) : (g = t, p + 1); g < m; g++) {
                ~ce.indexOf(f[g]) || (I(f[g], h.selectedClass, !0), ce.push(f[g]), W({
                  sortable: i,
                  rootEl: n,
                  name: "select",
                  targetEl: f[g],
      ...
      _deselectMultiDrag: function _deselectMultiDrag(t) {
        if (!(void 0 !== fe && fe || re !== this.sortable || t && N(t.target, this.options.draggable, this.sortable.el, !1) || t && 0 !== t.button)) for (; ce.length;) {
          var e = ce[0];
