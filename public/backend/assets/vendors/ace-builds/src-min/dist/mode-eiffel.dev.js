    ...
    this.$rules = {
      start: [{
        ...
        token: function token(e) {
          var t = s(e);
          return t === "identifier" && e === e.toUpperCase() && (t = "entity.name.type"), t;
        },
...
}), define("ace/mode/eiffel", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/eiffel_highlight_rules"], function (e, t, n) {
  "use strict";
