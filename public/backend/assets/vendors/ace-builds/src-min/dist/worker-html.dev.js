...
!function (e) {
  ...
  n.exports = function r(t, n, i) {
    ...
    2: [function (e, t, n) {
      ...
      f.consumeEntity = function (e, t, n) {
        ...
        if (c === i.EOF) return !1;
        l += c;
        if (c == "	" || c == "\n" || c == "\x0b" || c == " " || c == "<" || c == "&") return e.unget(l), !1;
        if (n === c) return e.unget(l), !1;

        if (c == "#") {
          c = e.shift(1);
          if (c === i.EOF) return t._parseError("expected-numeric-entity-but-got-eof"), e.unget(l), !1;
          l += c;
          var h = 10,
              p = a;
    ...
    3: [function (e, t, n) {
      function r() {
        this.data = "", this.start = 0, this.committed = 0, this.eof = !1, this.lastLocation = {
          line: 0,
          column: 0
        };
      }

      r.EOF = -1, r.DRAIN = -2, r.prototype = {
    ...
    5: [function (e, t, n) {
      ...
      u.prototype._parseError = function (e, t) {
        ...
        } else e.type === "EndTag" && (e.selfClosing && this._parseError("self-closing-flag-on-end-tag"), e.data.length !== 0 && this._parseError("attributes-in-end-tag"));
        this._tokenHandler.processToken(e), e.type === "StartTag" && e.selfClosing && !this._tokenHandler.isSelfClosingFlagAcknowledged() && this._parseError("non-void-element-with-trailing-solidus", {
          name: e.name
        });
        ...
        function n(e) {
          var n = e["char"]();
          if (n === r.EOF) return t._emitToken({
            type: "EOF",
            data: null
          }), !1;
          if (n === "&") t.setState(a);else if (n === "<") t.setState(j);else if (n === "\0") t._emitToken({
            type: "Characters",
            data: n
          }), e.commit();else {
        ...
        function a(e) {
          ...
          return t.setState(n), t._emitToken({
            type: "Characters",
            data: r || "&"
          }), !0;
        }
        ...
        function f(e) {
          ...
          if (n === "&") t.setState(l);else if (n === "<") t.setState(d);else if (n === "\0") t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), e.commit();else {
            var i = e.matchUntil("&|<|\0");
        ...
        function l(e) {
          ...
          return t.setState(f), t._emitToken({
            type: "Characters",
            data: n || "&"
          }), !0;
        }
        ...
        function c(e) {
          ...
          if (n === "<") t.setState(g);else if (n === "\0") t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), e.commit();else {
            var i = e.matchUntil("<|\0");
        ...
        function h(e) {
          ...
          if (n === "\0") t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), e.commit();else {
            var i = e.matchUntil("\0");
        ...
        function p(e) {
          ...
          if (n === "<") t.setState(w);else if (n === "\0") t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), e.commit();else {
            var i = e.matchUntil("<|\0");
        ...
        function d(e) {
          var n = e["char"]();
          return n === "/" ? (this._temporaryBuffer = "", t.setState(v)) : (t._emitToken({
            type: "Characters",
            data: "<"
          }), e.unget(n), t.setState(f)), !0;
        }

        function v(e) {
          var n = e["char"]();
          return o(n) ? (this._temporaryBuffer += n, t.setState(m)) : (t._emitToken({
            type: "Characters",
            data: "</"
          }), e.unget(n), t.setState(f)), !0;
        }
        ...
        function m(e) {
          ...
          return s(i) && r ? (t._currentToken = {
            type: "EndTag",
            name: this._temporaryBuffer,
            data: [],
            selfClosing: !1
          }, t.setState(q)) : i === "/" && r ? (t._currentToken = {
            type: "EndTag",
            name: this._temporaryBuffer,
            data: [],
            selfClosing: !1
          }, t.setState(K)) : i === ">" && r ? (t._currentToken = {
            type: "EndTag",
            name: this._temporaryBuffer,
            data: [],
            selfClosing: !1
          }, t._emitCurrentToken(), t.setState(n)) : o(i) ? (this._temporaryBuffer += i, e.commit()) : (t._emitToken({
            type: "Characters",
            data: "</" + this._temporaryBuffer
          }), e.unget(i), t.setState(f)), !0;
        }

        function g(e) {
          var n = e["char"]();
          return n === "/" ? (this._temporaryBuffer = "", t.setState(y)) : (t._emitToken({
            type: "Characters",
            data: "<"
          }), e.unget(n), t.setState(c)), !0;
        }

        function y(e) {
          var n = e["char"]();
          return o(n) ? (this._temporaryBuffer += n, t.setState(b)) : (t._emitToken({
            type: "Characters",
            data: "</"
          }), e.unget(n), t.setState(c)), !0;
        }
        ...
        function b(e) {
          ...
          return s(i) && r ? (t._currentToken = {
            ...
            type: "Characters",
            data: "</" + this._temporaryBuffer
          }), e.unget(i), t.setState(c)), !0;
        }

        function w(e) {
          var n = e["char"]();
          return n === "/" ? (this._temporaryBuffer = "", t.setState(E)) : n === "!" ? (t._emitToken({
            type: "Characters",
            data: "<!"
          }), t.setState(x)) : (t._emitToken({
            type: "Characters",
            data: "<"
          }), e.unget(n), t.setState(p)), !0;
        }

        function E(e) {
          var n = e["char"]();
          return o(n) ? (this._temporaryBuffer += n, t.setState(S)) : (t._emitToken({
            type: "Characters",
            data: "</"
          }), e.unget(n), t.setState(p)), !0;
        }
        ...
        function S(e) {
          ...
          return s(r) && n ? (t._currentToken = {
            type: "EndTag",
            name: "script",
            data: [],
            selfClosing: !1
          }, t.setState(q)) : r === "/" && n ? (t._currentToken = {
            type: "EndTag",
            name: "script",
            data: [],
            selfClosing: !1
          }, t.setState(K)) : r === ">" && n ? (t._currentToken = {
            type: "EndTag",
            name: "script",
            data: [],
            selfClosing: !1
          }, t._emitCurrentToken()) : o(r) ? (this._temporaryBuffer += r, e.commit()) : (t._emitToken({
            type: "Characters",
            data: "</" + this._temporaryBuffer
          }), e.unget(r), t.setState(p)), !0;
        }

        function x(e) {
          var n = e["char"]();
          return n === "-" ? (t._emitToken({
            type: "Characters",
            data: "-"
          }), t.setState(T)) : (e.unget(n), t.setState(p)), !0;
        }
        ...
        function T(e) {
          ...
          return n === "-" ? (t._emitToken({
            type: "Characters",
            data: "-"
          }), t.setState(k)) : (e.unget(n), t.setState(p)), !0;
        }

        function N(e) {
          var i = e["char"]();
          if (i === r.EOF) e.unget(i), t.setState(n);else if (i === "-") t._emitToken({
            type: "Characters",
            data: "-"
          }), t.setState(C);else if (i === "<") t.setState(L);else if (i === "\0") t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), e.commit();else {
        ...
        function C(e) {
          var i = e["char"]();
          return i === r.EOF ? (e.unget(i), t.setState(n)) : i === "-" ? (t._emitToken({
            type: "Characters",
            data: "-"
          }), t.setState(k)) : i === "<" ? t.setState(L) : i === "\0" ? (t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), t.setState(N)) : (t._emitToken({
            type: "Characters",
            data: i
          }), t.setState(N)), !0;
        }
        ...
        function k(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-script"), e.unget(i), t.setState(n)) : i === "<" ? t.setState(L) : i === ">" ? (t._emitToken({
            type: "Characters",
            data: ">"
          }), t.setState(p)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), t.setState(N)) : (t._emitToken({
            type: "Characters",
        ...
        function L(e) {
          var n = e["char"]();
          return n === "/" ? (this._temporaryBuffer = "", t.setState(A)) : o(n) ? (t._emitToken({
            type: "Characters",
            data: "<" + n
          }), this._temporaryBuffer = n, t.setState(M)) : (t._emitToken({
            type: "Characters",
            data: "<"
          }), e.unget(n), t.setState(N)), !0;
        }

        function A(e) {
          var n = e["char"]();
          return o(n) ? (this._temporaryBuffer = n, t.setState(O)) : (t._emitToken({
            type: "Characters",
            data: "</"
          }), e.unget(n), t.setState(N)), !0;
        }
        ...
        function O(e) {
          ...
          return s(i) && r ? (t._currentToken = {
            ...
            data: [],
            selfClosing: !1
          }, t.setState(n), t._emitCurrentToken()) : o(i) ? (this._temporaryBuffer += i, e.commit()) : (t._emitToken({
            type: "Characters",
            data: "</" + this._temporaryBuffer
          }), e.unget(i), t.setState(N)), !0;
        }

        function M(e) {
          var n = e["char"]();
          return s(n) || n === "/" || n === ">" ? (t._emitToken({
            type: "Characters",
            data: n
          }), this._temporaryBuffer.toLowerCase() === "script" ? t.setState(_) : t.setState(N)) : o(n) ? (t._emitToken({
            type: "Characters",
            data: n
          }), this._temporaryBuffer += n, e.commit()) : (e.unget(n), t.setState(N)), !0;
        }

        function _(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-script"), e.unget(i), t.setState(n)) : i === "-" ? (t._emitToken({
            type: "Characters",
            data: "-"
          }), t.setState(D)) : i === "<" ? (t._emitToken({
            type: "Characters",
            data: "<"
          }), t.setState(H)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), e.commit()) : (t._emitToken({
            type: "Characters",
            data: i
          }), e.commit()), !0;
        }
        ...
        function D(e) {
          ...
          return i === r.EOF ? (t._parseError("eof-in-script"), e.unget(i), t.setState(n)) : i === "-" ? (t._emitToken({
            type: "Characters",
            data: "-"
          }), t.setState(P)) : i === "<" ? (t._emitToken({
            type: "Characters",
            data: "<"
          }), t.setState(H)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
            data: "\uFFFD"
          }), t.setState(_)) : (t._emitToken({
            type: "Characters",
            data: i
          }), t.setState(_)), !0;
        }
        ...
        function P(e) {
          ...
          return i === r.EOF ? (t._parseError("eof-in-script"), e.unget(i), t.setState(n)) : i === "-" ? (t._emitToken({
            type: "Characters",
            data: "-"
          }), e.commit()) : i === "<" ? (t._emitToken({
            type: "Characters",
            data: "<"
          }), t.setState(H)) : i === ">" ? (t._emitToken({
            type: "Characters",
            data: ">"
          }), t.setState(p)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._emitToken({
            type: "Characters",
        ...
        function H(e) {
          ...
          return n === "/" ? (t._emitToken({
            type: "Characters",
            data: "/"
          }), this._temporaryBuffer = "", t.setState(B)) : (e.unget(n), t.setState(_)), !0;
        }
        ...
        function B(e) {
          ...
          return s(n) || n === "/" || n === ">" ? (t._emitToken({
            type: "Characters",
            data: n
          }), this._temporaryBuffer.toLowerCase() === "script" ? t.setState(N) : t.setState(_)) : o(n) ? (t._emitToken({
            type: "Characters",
            data: n
          }), this._temporaryBuffer += n, e.commit()) : (e.unget(n), t.setState(_)), !0;
        }

        function j(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("bare-less-than-sign-at-eof"), t._emitToken({
            type: "Characters",
            data: "<"
          }), e.unget(i), t.setState(n)) : o(i) ? (t._currentToken = {
            type: "StartTag",
            name: i.toLowerCase(),
            data: []
          }, t.setState(I)) : i === "!" ? t.setState(G) : i === "/" ? t.setState(F) : i === ">" ? (t._parseError("expected-tag-name-but-got-right-bracket"), t._emitToken({
            type: "Characters",
            data: "<>"
          }), t.setState(n)) : i === "?" ? (t._parseError("expected-tag-name-but-got-question-mark"), e.unget(i), t.setState(Q)) : (t._parseError("expected-tag-name"), t._emitToken({
            type: "Characters",
            data: "<"
          }), e.unget(i), t.setState(n)), !0;
        }
        ...
        function F(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("expected-closing-tag-but-got-eof"), t._emitToken({
            type: "Characters",
            data: "</"
          }), e.unget(i), t.setState(n)) : o(i) ? (t._currentToken = {
            type: "EndTag",
            name: i.toLowerCase(),
            data: []
          }, t.setState(I)) : i === ">" ? (t._parseError("expected-closing-tag-but-got-right-bracket"), t.setState(n)) : (t._parseError("expected-closing-tag-but-got-char", {
            data: i
          }), e.unget(i), t.setState(Q)), !0;
        }

        function I(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-tag-name"), e.unget(i), t.setState(n)) : s(i) ? t.setState(q) : o(i) ? t._currentToken.name += i.toLowerCase() : i === ">" ? t._emitCurrentToken() : i === "/" ? t.setState(K) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.name += "\uFFFD") : t._currentToken.name += i, e.commit(), !0;
        }

        function q(e) {
          var i = e["char"]();
          if (i === r.EOF) t._parseError("expected-attribute-name-but-got-eof"), e.unget(i), t.setState(n);else {
            if (s(i)) return !0;
            o(i) ? (t._currentToken.data.push({
              nodeName: i.toLowerCase(),
              nodeValue: ""
            }), t.setState(R)) : i === ">" ? t._emitCurrentToken() : i === "/" ? t.setState(K) : i === "'" || i === '"' || i === "=" || i === "<" ? (t._parseError("invalid-character-in-attribute-name"), t._currentToken.data.push({
              nodeName: i,
              nodeValue: ""
            }), t.setState(R)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data.push({
              nodeName: "\uFFFD",
              nodeValue: ""
        ...
        function R(e) {
          var i = e["char"](),
              u = !0,
              a = !1;
          i === r.EOF ? (t._parseError("eof-in-attribute-name"), e.unget(i), t.setState(n), a = !0) : i === "=" ? t.setState(z) : o(i) ? (t._currentAttribute().nodeName += i.toLowerCase(), u = !1) : i === ">" ? a = !0 : s(i) ? t.setState(U) : i === "/" ? t.setState(K) : i === "'" || i === '"' ? (t._parseError("invalid-character-in-attribute-name"), t._currentAttribute().nodeName += i, u = !1) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentAttribute().nodeName += "\uFFFD") : (t._currentAttribute().nodeName += i, u = !1);
        ...
        function U(e) {
          var i = e["char"]();
          if (i === r.EOF) t._parseError("expected-end-of-tag-but-got-eof"), e.unget(i), t.setState(n);else {
            if (s(i)) return !0;
            i === "=" ? t.setState(z) : i === ">" ? t._emitCurrentToken() : o(i) ? (t._currentToken.data.push({
              nodeName: i,
              nodeValue: ""
            }), t.setState(R)) : i === "/" ? t.setState(K) : i === "'" || i === '"' || i === "<" ? (t._parseError("invalid-character-after-attribute-name"), t._currentToken.data.push({
              nodeName: i,
              nodeValue: ""
            }), t.setState(R)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data.push({
              nodeName: "\uFFFD",
        ...
        function z(e) {
          var i = e["char"]();
          if (i === r.EOF) t._parseError("expected-attribute-value-but-got-eof"), e.unget(i), t.setState(n);else {
            if (s(i)) return !0;
        ...
        function W(e) {
          var i = e["char"]();
          if (i === r.EOF) t._parseError("eof-in-attribute-value-double-quote"), e.unget(i), t.setState(n);else if (i === '"') t.setState(J);else if (i === "&") this._additionalAllowedCharacter = '"', t.setState($);else if (i === "\0") t._parseError("invalid-codepoint"), t._currentAttribute().nodeValue += "\uFFFD";else {
            var s = e.matchUntil('[\0"&]');
        ...
        function X(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-attribute-value-single-quote"), e.unget(i), t.setState(n)) : i === "'" ? t.setState(J) : i === "&" ? (this._additionalAllowedCharacter = "'", t.setState($)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentAttribute().nodeValue += "\uFFFD") : t._currentAttribute().nodeValue += i + e.matchUntil("\0|['&]"), !0;
        }

        function V(e) {
          var i = e["char"]();
          if (i === r.EOF) t._parseError("eof-after-attribute-value"), e.unget(i), t.setState(n);else if (s(i)) t.setState(q);else if (i === "&") this._additionalAllowedCharacter = ">", t.setState($);else if (i === ">") t._emitCurrentToken();else if (i === '"' || i === "'" || i === "=" || i === "`" || i === "<") t._parseError("unexpected-character-in-unquoted-attribute-value"), t._currentAttribute().nodeValue += i, e.commit();else if (i === "\0") t._parseError("invalid-codepoint"), t._currentAttribute().nodeValue += "\uFFFD";else {
            var o = e.matchUntil("\0|[	\n\x0b\f \r&<>\"'=`]");
            o === r.EOF && (t._parseError("eof-in-attribute-value-no-quotes"), t._emitCurrentToken()), e.commit(), t._currentAttribute().nodeValue += i + o;
          }
          return !0;
        }

        function $(e) {
          var n = i.consumeEntity(e, t, this._additionalAllowedCharacter);
          return this._currentAttribute().nodeValue += n || "&", this._additionalAllowedCharacter === '"' ? t.setState(W) : this._additionalAllowedCharacter === "'" ? t.setState(X) : this._additionalAllowedCharacter === ">" && t.setState(V), !0;
        }

        function J(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-after-attribute-value"), e.unget(i), t.setState(n)) : s(i) ? t.setState(q) : i === ">" ? (t.setState(n), t._emitCurrentToken()) : i === "/" ? t.setState(K) : (t._parseError("unexpected-character-after-attribute-value"), e.unget(i), t.setState(q)), !0;
        }

        function K(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("unexpected-eof-after-solidus-in-tag"), e.unget(i), t.setState(n)) : i === ">" ? (t._currentToken.selfClosing = !0, t.setState(n), t._emitCurrentToken()) : (t._parseError("unexpected-character-after-solidus-in-tag"), e.unget(i), t.setState(q)), !0;
        }

        function Q(e) {
          var r = e.matchUntil(">");
          return r = r.replace(/\u0000/g, "\uFFFD"), e["char"](), t._emitToken({
            type: "Comment",
            data: r
          }), t.setState(n), !0;
        }
        ...
        function G(e) {
          var n = e.shift(2);
          if (n === "--") t._currentToken = {
            type: "Comment",
            data: ""
          }, t.setState(Z);else {
            var i = e.shift(5);
            if (i === r.EOF || n === r.EOF) return t._parseError("expected-dashes-or-doctype"), t.setState(Q), e.unget(n), !0;
            n += i, n.toUpperCase() === "DOCTYPE" ? (t._currentToken = {
              type: "Doctype",
              name: "",
              publicId: null,
              systemId: null,
              forceQuirks: !1
            }, t.setState(st)) : t._tokenHandler.isCdataSectionAllowed() && n === "[CDATA[" ? t.setState(Y) : (t._parseError("expected-dashes-or-doctype"), e.unget(n), t.setState(Q));
          }
          return !0;
        }
        ...
        function Y(e) {
          var r = e.matchUntil("]]>");
          return e.shift(3), r && t._emitToken({
            type: "Characters",
            data: r
          }), t.setState(n), !0;
        }
        ...
        function Z(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-comment"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(et) : i === ">" ? (t._parseError("incorrect-comment"), t._emitToken(t._currentToken), t.setState(n)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "\uFFFD") : (t._currentToken.data += i, t.setState(tt)), !0;
        }

        function et(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-comment"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(rt) : i === ">" ? (t._parseError("incorrect-comment"), t._emitToken(t._currentToken), t.setState(n)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "\uFFFD") : (t._currentToken.data += "-" + i, t.setState(tt)), !0;
        }

        function tt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-comment"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(nt) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "\uFFFD") : (t._currentToken.data += i, e.commit()), !0;
        }

        function nt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-comment-end-dash"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(rt) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "-\uFFFD", t.setState(tt)) : (t._currentToken.data += "-" + i + e.matchUntil("\0|-"), e["char"]()), !0;
        }

        function rt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-comment-double-dash"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === ">" ? (t._emitToken(t._currentToken), t.setState(n)) : i === "!" ? (t._parseError("unexpected-bang-after-double-dash-in-comment"), t.setState(it)) : i === "-" ? (t._parseError("unexpected-dash-after-double-dash-in-comment"), t._currentToken.data += i) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "--\uFFFD", t.setState(tt)) : (t._parseError("unexpected-char-in-comment"), t._currentToken.data += "--" + i, t.setState(tt)), !0;
        }

        function it(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-comment-end-bang-state"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === ">" ? (t._emitToken(t._currentToken), t.setState(n)) : i === "-" ? (t._currentToken.data += "--!", t.setState(nt)) : (t._currentToken.data += "--!" + i, t.setState(tt)), !0;
        }

        function st(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("expected-doctype-name-but-got-eof"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) ? t.setState(ot) : (t._parseError("need-space-after-doctype"), e.unget(i), t.setState(ot)), !0;
        }

        function ot(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("expected-doctype-name-but-got-eof"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) || (i === ">" ? (t._parseError("expected-doctype-name-but-got-right-bracket"), t._currentToken.forceQuirks = !0, t.setState(n), t._emitCurrentToken()) : (o(i) && (i = i.toLowerCase()), t._currentToken.name = i, t.setState(ut))), !0;
        }

        function ut(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._currentToken.forceQuirks = !0, e.unget(i), t._parseError("eof-in-doctype-name"), t.setState(n), t._emitCurrentToken()) : s(i) ? t.setState(at) : i === ">" ? (t.setState(n), t._emitCurrentToken()) : (o(i) && (i = i.toLowerCase()), t._currentToken.name += i, e.commit()), !0;
        }

        function at(e) {
          var i = e["char"]();
          if (i === r.EOF) t._currentToken.forceQuirks = !0, e.unget(i), t._parseError("eof-in-doctype"), t.setState(n), t._emitCurrentToken();else if (!s(i)) if (i === ">") t.setState(n), t._emitCurrentToken();else {
            if (["p", "P"].indexOf(i) > -1) {
            ...
            e.unget(i), t._currentToken.forceQuirks = !0, i === r.EOF ? (t._parseError("eof-in-doctype"), e.unget(i), t.setState(n), t._emitCurrentToken()) : (t._parseError("expected-space-or-right-bracket-in-doctype", {
              data: i
            }), t.setState(wt));
          }
          return !0;
        ...
        function ft(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) ? t.setState(lt) : i === "'" || i === '"' ? (t._parseError("unexpected-char-in-doctype"), e.unget(i), t.setState(lt)) : (e.unget(i), t.setState(lt)), !0;
        }

        function lt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) || (i === '"' ? (t._currentToken.publicId = "", t.setState(ct)) : i === "'" ? (t._currentToken.publicId = "", t.setState(ht)) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t.setState(n), t._emitCurrentToken()) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt))), !0;
        }

        function ct(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : i === '"' ? t.setState(pt) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t.setState(n), t._emitCurrentToken()) : t._currentToken.publicId += i, !0;
        }
        ...
        function pt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) ? t.setState(dt) : i === ">" ? (t.setState(n), t._emitCurrentToken()) : i === '"' ? (t._parseError("unexpected-char-in-doctype"), t._currentToken.systemId = "", t.setState(gt)) : i === "'" ? (t._parseError("unexpected-char-in-doctype"), t._currentToken.systemId = "", t.setState(yt)) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt)), !0;
        }

        function dt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) || (i === ">" ? (t._emitCurrentToken(), t.setState(n)) : i === '"' ? (t._currentToken.systemId = "", t.setState(gt)) : i === "'" ? (t._currentToken.systemId = "", t.setState(yt)) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt))), !0;
        }

        function vt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) ? t.setState(mt) : i === "'" || i === '"' ? (t._parseError("unexpected-char-in-doctype"), e.unget(i), t.setState(mt)) : (e.unget(i), t.setState(mt)), !0;
        }

        function mt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) || (i === '"' ? (t._currentToken.systemId = "", t.setState(gt)) : i === "'" ? (t._currentToken.systemId = "", t.setState(yt)) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), t.setState(n)) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt))), !0;
        }

        function gt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : i === '"' ? t.setState(bt) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), t.setState(n)) : t._currentToken.systemId += i, !0;
        }
        ...
        function bt(e) {
          var i = e["char"]();
          return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) || (i === ">" ? (t._emitCurrentToken(), t.setState(n)) : (t._parseError("unexpected-char-in-doctype"), t.setState(wt))), !0;
        }

        function wt(e) {
          var i = e["char"]();
          return i === r.EOF ? (e.unget(i), t._emitCurrentToken(), t.setState(n)) : i === ">" && (t._emitCurrentToken(), t.setState(n)), !0;
        }

        u.DATA = n, u.RCDATA = f, u.RAWTEXT = c, u.SCRIPT_DATA = p, u.PLAINTEXT = h, this._state = u.DATA, this._inputStream.append(e), this._tokenHandler.startTokenization(this), this._inputStream.eof = !0;
        var t = this;
    ...
    6: [function (e, t, n) {
      ...
      function g() {
        ...
        t.base = {
        ...
        }, t.beforeHTML = Object.create(t.base), t.beforeHTML.start_tag_handlers = {
          html: "startTagHtml",
          "-default": "startTagOther"
        ...
        }, t.afterAfterBody = Object.create(t.base), t.afterAfterBody.start_tag_handlers = {
          html: "startTagHtml",
          "-default": "startTagOther"
          ...
          e.parseError("unexpected-start-tag", {
            name: t
          }), e.setInsertionMode("inBody"), e.insertionMode.processStartTag(t, n, r);
        }, t.afterAfterBody.endTagOther = function (t) {
          e.parseError("unexpected-end-tag", {
            name: t
          }), e.setInsertionMode("inBody"), e.insertionMode.processEndTag(t);
        }, t.afterAfterBody.processCharacters = function (n) {
          if (!p(n.characters)) return e.parseError("unexpected-char-after-body"), e.setInsertionMode("inBody"), e.insertionMode.processCharacters(n);
          t.inBody.processCharacters(n);
        }, t.afterBody = Object.create(t.base), t.afterBody.end_tag_handlers = {
          html: "endTagHtml",
          "-default": "endTagOther"
          ...
          e.parseError("unexpected-end-tag-after-body", {
            name: t
          }), e.setInsertionMode("inBody"), e.insertionMode.processEndTag(t);
        }, t.afterFrameset = Object.create(t.base), t.afterFrameset.start_tag_handlers = {
          html: "startTagHtml",
        ...
        }, t.beforeHead = Object.create(t.base), t.beforeHead.start_tag_handlers = {
          html: "startTagHtml",
          head: "startTagHead",
          "-default": "startTagOther"
          ...
          e.parseError("end-tag-after-implied-root", {
            name: t
          });
          ...
          ["title", "style", "script"].indexOf(t) != -1 && (e.parseError("expected-named-closing-tag-but-got-eof", {
            name: t
          }), e.popElement()), this.anythingElse(), e.insertionMode.processEOF();
          ...
          e.openElements.item(e.openElements.length - 1).localName == "head" ? e.openElements.pop() : e.parseError("unexpected-end-tag", {
            name: "head"
        ...
        }, t.afterHead = Object.create(t.base), t.afterHead.start_tag_handlers = {
          html: "startTagHtml",
          head: "startTagHead",
          body: "startTagBody",
          ...
          e.parseError("unexpected-start-tag-out-of-my-head", {
            name: n
          }), e.openElements.push(e.head), t.inHead.processStartTag(n, r, i), e.openElements.remove(e.head);
        ...
        }, t.inBody = Object.create(t.base), t.inBody.start_tag_handlers = {
          html: "startTagHtml",
          ...
          e.parseError("unexpected-start-tag", {
            name: "body"
          }), e.openElements.length == 1 || e.openElements.item(1).localName != "body" ? r.ok(e.context) : (e.framesetOk = !1, e.addAttributesToElement(e.openElements.bodyElement, n));
        }, t.inBody.startTagFrameset = function (t, n) {
          e.parseError("unexpected-start-tag", {
            name: "frameset"
          });
          if (e.openElements.length == 1 || e.openElements.item(1).localName != "body") r.ok(e.context);else if (e.framesetOk) {
            e.detachFromParent(e.openElements.bodyElement);

            while (e.openElements.length > 1) {
              e.openElements.pop();
            }
          ...
          e.form ? e.parseError("unexpected-start-tag", {
            name: t
          }) : (e.openElements.inButtonScope("p") && this.endTagP("p"), e.insertElement(t, n), e.form = e.currentStackItem());
        }, t.inBody.startTagRpRt = function (t, n) {
          e.openElements.inScope("ruby") && (e.generateImpliedEndTags(), e.currentStackItem().localName != "ruby" && e.parseError("unexpected-start-tag", {
            name: t
          })), e.insertElement(t, n);
          ...
          e.openElements.inButtonScope("p") && this.endTagP("p"), e.currentStackItem().isNumberedHeader() && (e.parseError("unexpected-start-tag", {
            name: t
          }), e.popElement()), e.insertElement(t, n);
        }, t.inBody.startTagA = function (t, n) {
          var r = e.elementInActiveFormattingElements("a");
          r && (e.parseError("unexpected-start-tag-implies-end-tag", {
            startName: "a",
            endName: "a"
          }), e.adoptionAgencyEndTag("a"), e.openElements.contains(r) && e.openElements.remove(r), e.removeElementFromActiveFormattingElements(r)), e.reconstructActiveFormattingElements(), e.insertFormattingElement(t, n);
          ...
          e.reconstructActiveFormattingElements(), e.openElements.inScope("nobr") && (e.parseError("unexpected-start-tag-implies-end-tag", {
            startName: "nobr",
            endName: "nobr"
          }), this.processEndTag("nobr"), e.reconstructActiveFormattingElements()), e.insertFormattingElement(t, n);
        }, t.inBody.startTagButton = function (t, n) {
          e.openElements.inScope("button") ? (e.parseError("unexpected-start-tag-implies-end-tag", {
            startName: "button",
            endName: "button"
          }), this.processEndTag("button"), e.insertionMode.processStartTag(t, n)) : (e.framesetOk = !1, e.reconstructActiveFormattingElements(), e.insertElement(t, n));
          ...
          e.openElements.inScope(t) ? (e.generateImpliedEndTags(), e.currentStackItem().localName != t && e.parseError("end-tag-too-early", {
            name: t
          }), e.openElements.popUntilPopped(t), e.clearActiveFormattingElements()) : e.parseError("unexpected-end-tag", {
            name: t
          });
          ...
          i.push({
            nodeName: "name",
            nodeValue: "isindex"
          }), this.processStartTag("form", r), this.processStartTag("hr"), this.processStartTag("label"), this.processCharacters(new m(s)), this.processStartTag("input", i), this.processEndTag("label"), this.processStartTag("hr"), this.processEndTag("form");
          ...
          e.parseError("unexpected-start-tag-ignored", {
            name: t
          });
          ...
          e.parseError("unexpected-end-tag-treated-as", {
            originalName: "br",
            newName: "br element"
          }), e.reconstructActiveFormattingElements(), e.insertElement(t, []), e.popElement();
          ...
          for (var r = e.openElements.length - 1; r > 0; r--) {
            ...
            if (n.localName == t) {
              e.generateImpliedEndTags(t), e.currentStackItem().localName != t && e.parseError("unexpected-end-tag", {
                name: t
          ...
          e.openElements.inButtonScope("p") ? (e.generateImpliedEndTags("p"), e.currentStackItem().localName != "p" && e.parseError("unexpected-implied-end-tag", {
            name: "p"
          }), e.openElements.popUntilPopped(t)) : (e.parseError("unexpected-end-tag", {
            name: "p"
          }), this.startTagCloseP("p", []), this.endTagP("p"));
          ...
          e.currentStackItem().localName != "body" && e.parseError("expected-one-end-tag-but-got-another", {
          ...
          e.currentStackItem().localName != "body" && e.parseError("expected-one-end-tag-but-got-another", {
            expectedName: e.currentStackItem().localName,
            gotName: t
          }), e.setInsertionMode("afterBody"), e.insertionMode.processEndTag(t);
          ...
          var n = e.form;
          e.form = null, !n || !e.openElements.inScope(t) ? e.parseError("unexpected-end-tag", {
            name: t
          }) : (e.generateImpliedEndTags(), e.currentStackItem() != n && e.parseError("end-tag-too-early-ignored", {
            name: "form"
          }), e.openElements.remove(n));
        }, t.inBody.endTagListItem = function (t) {
          e.openElements.inListItemScope(t) ? (e.generateImpliedEndTags(t), e.currentStackItem().localName != t && e.parseError("end-tag-too-early", {
            name: t
          }), e.openElements.popUntilPopped(t)) : e.parseError("unexpected-end-tag", {
            name: t
          });
          ...
          e.generateImpliedEndTags(), e.currentStackItem().localName != t && e.parseError("end-tag-too-early", {
            name: t
          }), e.openElements.remove_openElements_until(function (e) {
        ...
        }, t.inCaption = Object.create(t.base), t.inCaption.start_tag_handlers = {
          html: "startTagHtml",
          ...
          e.openElements.inTableScope("caption") ? (e.generateImpliedEndTags(), e.currentStackItem().localName != "caption" && e.parseError("expected-one-end-tag-but-got-another", {
            gotName: "caption",
            expectedName: e.currentStackItem().localName
          }), e.openElements.popUntilPopped("caption"), e.clearActiveFormattingElements(), e.setInsertionMode("inTable")) : (r.ok(e.context), e.parseError("unexpected-end-tag", {
            name: t
          }));
        ...
        }, t.inCell = Object.create(t.base), t.inCell.start_tag_handlers = {
          html: "startTagHtml",
          ...
          e.openElements.inTableScope("td") || e.openElements.inTableScope("th") ? (this.closeCell(), e.insertionMode.processStartTag(t, n, r)) : e.parseError("unexpected-start-tag", {
            name: t
          });
        }, t.inCell.startTagOther = function (e, n, r) {
          t.inBody.processStartTag(e, n, r);
        }, t.inCell.endTagTableCell = function (t) {
          e.openElements.inTableScope(t) ? (e.generateImpliedEndTags(t), e.currentStackItem().localName != t.toLowerCase() ? (e.parseError("unexpected-cell-end-tag", {
            name: t
          }), e.openElements.popUntilPopped(t)) : e.popElement(), e.clearActiveFormattingElements(), e.setInsertionMode("inRow")) : e.parseError("unexpected-end-tag", {
            name: t
          });
          ...
          e.openElements.inTableScope(t) ? (this.closeCell(), e.insertionMode.processEndTag(t)) : e.parseError("unexpected-end-tag", {
            name: t
          });
        ...
        }, t.inColumnGroup = Object.create(t.base), t.inColumnGroup.start_tag_handlers = {
          html: "startTagHtml",
          col: "startTagCol",
          "-default": "startTagOther"
          ...
          this.ignoreEndTagColgroup() ? (r.ok(e.context), e.parseError("unexpected-end-tag", {
            name: t
          })) : (e.popElement(), e.setInsertionMode("inTable"));
        }, t.inColumnGroup.endTagCol = function (t) {
          e.parseError("no-end-tag", {
            name: "col"
          });
          ...
          if (["b", "big", "blockquote", "body", "br", "center", "code", "dd", "div", "dl", "dt", "em", "embed", "h1", "h2", "h3", "h4", "h5", "h6", "head", "hr", "i", "img", "li", "listing", "menu", "meta", "nobr", "ol", "p", "pre", "ruby", "s", "small", "span", "strong", "strike", "sub", "sup", "table", "tt", "u", "ul", "var"].indexOf(t) != -1 || t == "font" && n.some(function (e) {
            ...
            while (e.currentStackItem().isForeign() && !e.currentStackItem().isHtmlIntegrationPoint() && !e.currentStackItem().isMathMLTextIntegrationPoint()) {
              e.openElements.pop();
            }
          ...
          n.localName.toLowerCase() != t && e.parseError("unexpected-end-tag", {
            name: t
          });
        ...
        }, t.inHeadNoscript = Object.create(t.base), t.inHeadNoscript.start_tag_handlers = {
          html: "startTagHtml",
          ...
          e.parseError("unexpected-start-tag-in-frameset", {
            name: t
          }), this.anythingElse(), e.insertionMode.processStartTag(t, n);
        }, t.inHeadNoscript.endTagBr = function (t, n) {
          e.parseError("unexpected-end-tag-in-frameset", {
            name: t
          }), this.anythingElse(), e.insertionMode.processEndTag(t, n);
        ...
        }, t.inTable = Object.create(t.base), t.inTable.start_tag_handlers = {
          html: "startTagHtml",
          ...
          if (e.currentStackItem().isFosterParenting()) {
            var r = e.insertionModeName;
            e.setInsertionMode("inTableText"), e.originalInsertionMode = r, e.insertionMode.processCharacters(n);
          ...
          e.parseError("unexpected-start-tag-implies-end-tag", {
            startName: "table",
            endName: "table"
          }), e.insertionMode.processEndTag("table"), e.context || e.insertionMode.processStartTag(t, n);
          ...
          e.parseError("unexpected-start-tag-implies-table-voodoo", {
            name: n
          }), e.redirectAttachToFosterParent = !0, t.inBody.processStartTag(n, r, i), e.redirectAttachToFosterParent = !1;
        }, t.inTable.endTagTable = function (t) {
          e.openElements.inTableScope(t) ? (e.generateImpliedEndTags(), e.currentStackItem().localName != t && e.parseError("end-tag-too-early-named", {
            gotName: "table",
            expectedName: e.currentStackItem().localName
          }), e.openElements.popUntilPopped("table"), e.resetInsertionMode()) : (r.ok(e.context), e.parseError("unexpected-end-tag", {
            name: t
          }));
          ...
          e.parseError("unexpected-end-tag-implies-table-voodoo", {
            name: n
          }), e.redirectAttachToFosterParent = !0, t.inBody.processEndTag(n), e.redirectAttachToFosterParent = !1;
        }, t.inTableText = Object.create(t.base), t.inTableText.flushCharacters = function () {
          var t = e.pendingTableCharacters.join("");
          p(t) ? e.insertText(t) : (e.redirectAttachToFosterParent = !0, e.reconstructActiveFormattingElements(), e.insertText(t), e.framesetOk = !1, e.redirectAttachToFosterParent = !1), e.pendingTableCharacters = [];
        ...
        }, t.inTableBody = Object.create(t.base), t.inTableBody.start_tag_handlers = {
          html: "startTagHtml",
          tr: "startTagTr",
          ...
          e.parseError("unexpected-cell-in-table-body", {
            name: t
          }), this.startTagTr("tr", []), e.insertionMode.processStartTag(t, n);
        }, t.inTableBody.startTagTableOther = function (t, n) {
          e.openElements.inTableScope("tbody") || e.openElements.inTableScope("thead") || e.openElements.inTableScope("tfoot") ? (e.openElements.popUntilTableBodyScopeMarker(), this.endTagTableRowGroup(e.currentStackItem().localName), e.insertionMode.processStartTag(t, n)) : e.parseError("unexpected-start-tag", {
            name: t
          });
        }, t.inTableBody.startTagOther = function (e, n) {
          t.inTable.processStartTag(e, n);
        }, t.inTableBody.endTagTableRowGroup = function (t) {
          e.openElements.inTableScope(t) ? (e.openElements.popUntilTableBodyScopeMarker(), e.popElement(), e.setInsertionMode("inTable")) : e.parseError("unexpected-end-tag-in-table-body", {
            name: t
          });
        }, t.inTableBody.endTagTable = function (t) {
          e.openElements.inTableScope("tbody") || e.openElements.inTableScope("thead") || e.openElements.inTableScope("tfoot") ? (e.openElements.popUntilTableBodyScopeMarker(), this.endTagTableRowGroup(e.currentStackItem().localName), e.insertionMode.processEndTag(t)) : e.parseError("unexpected-end-tag", {
            name: t
          });
        ...
        }, t.inSelect = Object.create(t.base), t.inSelect.start_tag_handlers = {
          html: "startTagHtml",
          ...
          e.currentStackItem().localName == "option" && e.openElements.item(e.openElements.length - 2).localName == "optgroup" && e.popElement(), e.currentStackItem().localName == "optgroup" ? e.popElement() : e.parseError("unexpected-end-tag-in-select", {
            name: "optgroup"
          });
          ...
          e.openElements.inTableScope("select") ? (e.openElements.popUntilPopped("select"), e.resetInsertionMode()) : e.parseError("unexpected-end-tag", {
            name: t
          });
          ...
          e.parseError("unexpected-start-tag-in-select", {
            name: t
          });
        ...
        }, t.inSelectInTable = Object.create(t.base), t.inSelectInTable.start_tag_handlers = {
          ...
          e.parseError("unexpected-table-element-start-tag-in-select-in-table", {
            name: t
          }), this.endTagOther("select"), e.insertionMode.processStartTag(t, n);
        }, t.inSelectInTable.startTagOther = function (e, n, r) {
          t.inSelect.processStartTag(e, n, r);
        }, t.inSelectInTable.endTagTable = function (t) {
          e.parseError("unexpected-table-element-end-tag-in-select-in-table", {
            name: t
        ...
        }, t.inRow = Object.create(t.base), t.inRow.start_tag_handlers = {
          html: "startTagHtml",
          td: "startTagTableCell",
          th: "startTagTableCell",
          caption: "startTagTableOther",
          ...
          this.ignoreEndTagTr() ? (r.ok(e.context), e.parseError("unexpected-end-tag", {
            name: t
          ...
          e.openElements.inTableScope(t) ? (this.endTagTr("tr"), e.insertionMode.processEndTag(t)) : e.parseError("unexpected-end-tag", {
            name: t
          });
        ...
        }, t.afterAfterFrameset = Object.create(t.base), t.afterAfterFrameset.start_tag_handlers = {
          html: "startTagHtml",
          noframes: "startTagNoFrames",
          "-default": "startTagOther"
        }, t.afterAfterFrameset.processEOF = function () {}, t.afterAfterFrameset.processComment = function (t) {
          e.insertComment(t, e.document);
          ...
          e.parseError("expected-eof-but-got-start-tag", {
            name: t
          });
        }, t.afterAfterFrameset.processEndTag = function (t, n) {
          e.parseError("expected-eof-but-got-end-tag", {
            name: t
          });
        }, t.text = Object.create(t.base), t.text.start_tag_handlers = {
          "-default": "startTagOther"
          ...
          }), e.openElements.pop(), e.setInsertionMode(e.originalInsertionMode), e.insertionMode.processEOF();
          ...
          r.ok(n.localName == "script"), e.setInsertionMode(e.originalInsertionMode);
      ...
      m.prototype.skipAtMostOneLeadingNewline = function () {
        ...
        while (s++ < t) {
          ...
          if (!r || this.openElements.contains(r) && !this.openElements.inScope(r.localName)) return this.parseError("adoption-agency-1.1", {
            name: e
          }), !1;
          if (!this.openElements.contains(r)) return this.parseError("adoption-agency-1.2", {
            name: e
          }), this.removeElementFromActiveFormattingElements(r), !0;
          this.openElements.inScope(r.localName) || this.parseError("adoption-agency-4.4", {
            name: e
          }), r != this.currentStackItem() && this.parseError("adoption-agency-1.3", {
            name: e
          });
          var o = this.openElements.furthestBlockForFormattingElement(r.node);
          if (!o) return this.openElements.remove_openElements_until(i), this.removeElementFromActiveFormattingElements(r), !0;
          ...
          while (d++ < n) {
            ...
            if (c == r) break;
            h == o && (l = this.activeFormattingElements.indexOf(c) + 1);
            var v = this.createElement(c.namespaceURI, c.localName, c.attributes),
                m = new f(c.namespaceURI, c.localName, c.attributes, v);
            this.activeFormattingElements[this.activeFormattingElements.indexOf(c)] = m, this.openElements.elements[this.openElements.elements.indexOf(c)] = m, c = m, this.detachFromParent(h.node), this.attachNode(h.node, c.node), h = c;
          }

          this.detachFromParent(h.node), a.isFosterParenting() ? this.insertIntoFosterParent(h.node) : this.attachNode(h.node, a.node);
          var v = this.createElement("http://www.w3.org/1999/xhtml", r.localName, r.attributes),
              g = new f(r.namespaceURI, r.localName, r.attributes, v);
          this.reparentChildren(o.node, v), this.attachNode(v, o.node), this.removeElementFromActiveFormattingElements(r), this.activeFormattingElements.splice(Math.min(l, this.activeFormattingElements.length), 0, g), this.openElements.remove(r), this.openElements.elements.splice(this.openElements.elements.indexOf(o) + 1, 0, g);
        }
        ...
        this.tokenizer = e, this.compatMode = "no quirks", this.originalInsertionMode = "initial", this.framesetOk = !0, this.openElements = new a(), this.activeFormattingElements = [], this.start();
        ...
        if (this.context) {
          switch (this.context) {
            ...
            case "noscript":
              this.scriptingEnabled && this.tokenizer.setState(u.RAWTEXT);
              break;
          ...
          this.insertHtmlElement(), this.context === "head" ? this.insertHeadElement() : this.insertBodyElement(), this.resetInsertionMode();
        ...
        var t = this.openElements.top || null,
            n;
        !t || !t.isForeign() || t.isMathMLTextIntegrationPoint() && (e.type == "StartTag" && !(e.name in {
          mglyph: 0,
          malignmark: 0
        }) || e.type === "Characters") || t.namespaceURI == "http://www.w3.org/1998/Math/MathML" && t.localName == "annotation-xml" && e.type == "StartTag" && e.name == "svg" || t.isHtmlIntegrationPoint() && e.type in {
          StartTag: 0,
          Characters: 0
        } || e.type == "EOF" ? n = this.insertionMode : n = this.insertionModes.inForeignContent;
        ...
        return this.attachNode(t, this.document), this.openElements.pushHtmlElement(new f("http://www.w3.org/1999/xhtml", "html", e, t)), t;
      }, g.prototype.insertHeadElement = function (e) {
        var t = this.createElement("http://www.w3.org/1999/xhtml", "head", e);
        return this.head = new f("http://www.w3.org/1999/xhtml", "head", e, t), this.attachNode(t, this.openElements.top.node), this.openElements.pushHeadElement(this.head), t;
      }, g.prototype.insertBodyElement = function (e) {
        var t = this.createElement("http://www.w3.org/1999/xhtml", "body", e);
        return this.attachNode(t, this.openElements.top.node), this.openElements.pushBodyElement(new f("http://www.w3.org/1999/xhtml", "body", e, t)), t;
        ...
        this.shouldFosterParent() ? this.insertIntoFosterParent(i) : this.attachNode(i, this.openElements.top.node), r || this.openElements.push(new f(n, e, t, i));
        ...
        for (var n = this.openElements.length - 1; n >= 0; n--) {
          t = this.openElements.item(n), n === 0 && (r.ok(this.context), e = !0, t = new f("http://www.w3.org/1999/xhtml", this.context, [], null));
          ...
          if (t.namespaceURI === "http://www.w3.org/1999/xhtml") {
            ...
            if (t.localName === "head") return this.setInsertionMode("inHead");
    ...
    9: [function (e, t, n) {
      ...
      o.prototype.parse = function (e, t) {
        t && this._treeBuilder.setFragmentContext(t), this._tokenizer.tokenize(e);
        var n = this._treeBuilder.document;
    ...
    10: [function (e, t, n) {
      ...
      r.inherits(s, i), s.prototype.start = function (e) {
    ...
    13: [function (e, t, n) {
      ...
      function d(e, t) {
        ...
        if (p(e)) return p(t) ? (e = i.call(e), t = i.call(t), h(e, t)) : !1;
      ...
      function m(e, t, n, i) {
        ...
        i = (n && n.name ? " (" + n.name + ")." : ".") + (i ? " " + i : "."), e && !s && l(s, n, "Missing expected exception" + i), !e && v(s, n) && l(s, n, "Got unwanted exception" + i);
    ...
    14: [function (e, t, n) {
      t.exports = function (t) {
        return t && _typeof(t) == "object" && typeof t.copy == "function" && typeof t.fill == "function" && typeof t.readUInt8 == "function";
      };
    }, {}],
    15: [function (e, t, n) {
      (function (t, r) {
        function u(e, t) {
          ...
          return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), y(t) ? r.showHidden = t : t && n._extend(r, t), T(r.showHidden) && (r.showHidden = !1), T(r.depth) && (r.depth = 2), T(r.colors) && (r.colors = !1), T(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = a), c(r, e, r.depth);
        }
        ...
        function c(e, t, r) {
          ...
          if (L(t) && (o.indexOf("message") >= 0 || o.indexOf("description") >= 0)) return p(t);
          ...
          if (o.length === 0) {
            ...
            if (N(t)) return e.stylize(RegExp.prototype.toString.call(t), "regexp");
          ...
          N(t) && (f = " " + RegExp.prototype.toString.call(t)), k(t) && (f = " " + Date.prototype.toUTCString.call(t)), L(t) && (f = " " + p(t));

          if (o.length !== 0 || !!y && t.length != 0) {
            if (r < 0) return N(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special");
            e.seen.push(t);
            var E;
            return y ? E = d(e, t, r, u, o) : E = o.map(function (n) {
        ...
        function v(e, t, n, r, i, s) {
          ...
          a = Object.getOwnPropertyDescriptor(t, i) || {
            value: t[i]
          }, a.get ? a.set ? u = e.stylize("[Getter/Setter]", "special") : u = e.stylize("[Getter]", "special") : a.set && (u = e.stylize("[Setter]", "special")), H(r, i) || (o = "[" + i + "]"), u || (e.seen.indexOf(a.value) < 0 ? (b(n) ? u = c(e, a.value, null) : u = c(e, a.value, n - 1), u.indexOf("\n") > -1 && (s ? u = u.split("\n").map(function (e) {
            return "  " + e;
          }).join("\n").substr(2) : u = "\n" + u.split("\n").map(function (e) {
            return "   " + e;
        ...
        function O(e) {
          return e === null || typeof e == "boolean" || typeof e == "number" || typeof e == "string" || _typeof(e) == "symbol" || typeof e == "undefined";
        }
        ...
        n.debuglog = function (e) {
          ...
          date: "magenta",
          regexp: "red"
        }, n.isArray = g, n.isBoolean = y, n.isNull = b, n.isNullOrUndefined = w, n.isNumber = E, n.isString = S, n.isSymbol = x, n.isUndefined = T, n.isRegExp = N, n.isObject = C, n.isDate = k, n.isError = L, n.isFunction = A, n.isPrimitive = O, n.isBuffer = e("./support/isBuffer");
    ...
    16: [function (e, t, n) {
      ...
      t.exports = r, r.EventEmitter = r, r.prototype._events = undefined, r.prototype._maxListeners = undefined, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function (e) {
        ...
        if (o(this._events[e]) && !this._events[e].warned) {
          var n;
          u(this._maxListeners) ? n = r.defaultMaxListeners : n = this._maxListeners, n && n > 0 && this._events[e].length > n && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), console.trace());
        }
        ...
        n = this._events[e];
        if (i(n)) this.removeListener(e, n);else while (n.length) {
  ...
  r.inherits(a, s), function () {
    this.setOptions = function (e) {
      ...
      }, t.parse(e, this.context), this.sender.emit("error", n);
    };
  }.call(a.prototype);
});