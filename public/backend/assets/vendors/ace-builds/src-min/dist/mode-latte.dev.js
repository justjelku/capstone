...
define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
...
}), define("ace/mode/latte_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  r.inherits(o, s), t.LatteHighlightRules = o;
}), define("ace/mode/latte", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/latte_highlight_rules", "ace/mode/matching_brace_outdent"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./html").Mode,
      s = e("./latte_highlight_rules").LatteHighlightRules,
      o = e("./matching_brace_outdent").MatchingBraceOutdent,
      u = function u() {
  ...
  r.inherits(u, i), function () {
    this.blockComment = {
      ...
      if (e == "start") {
        var i = t.match(/^.*\{(?:if|else|elseif|ifset|elseifset|ifchanged|switch|case|foreach|iterateWhile|for|while|first|last|sep|try|capture|spaceless|snippet|block|define|embed|snippetArea)\b[^{]*$/);
        i && (r += n);
      }
      ...
      return /^\s+\{\/$/.test(t + n);
    }, this.autoOutdent = function (e, t, n) {}, this.$id = "ace/mode/latte";
