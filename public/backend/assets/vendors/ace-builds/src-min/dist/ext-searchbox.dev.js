...
define("ace/ext/searchbox", ["require", "exports", "module", "ace/lib/dom", "ace/lib/lang", "ace/lib/event", "ace/keyboard/hash_handler", "ace/lib/keys"], function (e, t, n) {
  ...
  (function () {
    this.setEditor = function (e) {
      ...
      "Ctrl-f|Command-f": function CtrlFCommandF(e) {
      ...
      "Ctrl-H|Command-Option-F": function CtrlHCommandOptionF(e) {
        if (e.editor.getReadOnly()) return;
        e.replaceOption.checked = !0, e.$syncOptions(), e.replaceInput.focus();
      },
      "Ctrl-G|Command-G": function CtrlGCommandG(e) {
        e.findNext();
      },
      "Ctrl-Shift-G|Command-Shift-G": function CtrlShiftGCommandShiftG(e) {
        e.findPrev();
      },
      esc: function esc(e) {
        setTimeout(function () {
      ...
      "Alt-Return": function AltReturn(e) {
      ...
      r.setCssClass(this.searchBox, "ace_nomatch", s), this.editor._emit("findSearchBox", {
        match: !s
      ...
      r.setCssClass(this.searchBox, "ace_nomatch", t), this.editor._emit("findSearchBox", {
        match: !t
