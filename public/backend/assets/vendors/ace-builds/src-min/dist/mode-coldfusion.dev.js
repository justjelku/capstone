...
define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
...
}), define("ace/mode/coldfusion_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript_highlight_rules", "ace/mode/html_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
    ...
    this.embedRules({
      ...
      token: "comment.start",
      push: "cfmlComment"
    }], ["comment", "start", "tag_whitespace", "cdata"].concat(e)), this.$rules.cfTag = [{
      include: "attributes"
    }, {
      token: "meta.tag.punctuation.tag-close.xml",
      regex: "/?>",
    ...
    }, this), this.embedTagRules(new i({
      jsx: !1
    }).getRules(), "cfjs-", "cfscript"), this.normalizeRules();
  };

  r.inherits(o, s), t.ColdfusionHighlightRules = o;
}), define("ace/mode/coldfusion", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/html", "ace/mode/coldfusion_highlight_rules"], function (e, t, n) {
  "use strict";
