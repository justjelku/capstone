...
define("ace/mode/asciidoc_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/folding/asciidoc", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range"], function (e, t, n) {
  "use strict";
  ...
  r.inherits(o, i), function () {
    this.foldingStartMarker = /^(?:\|={10,}|[\.\/=\-~^+]{4,}\s*$|={1,5} )/, this.singleLineHeadingRe = /^={1,5}(?=\s+\S)/, this.getFoldWidget = function (e, t, n) {
      ...
      if (l(n) == h) {
        ...
        a = g ? n - 1 : n - 2;
        if (a > u) while (a > u && (!l(a) || f.value[0] == "[")) {
          a--;
        }
        ...
        if (b == "dissallowDelimitedBlock") {
          while (n-- > 0) {
            if (e.bgTokenizer.getState(n).lastIndexOf("Block") == -1) break;
          }
          ...
          while (++n < o) {
            if (e.bgTokenizer.getState(n) == "dissallowDelimitedBlock") break;
          }
...
}), define("ace/mode/asciidoc", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/asciidoc_highlight_rules", "ace/mode/folding/asciidoc"], function (e, t, n) {
  "use strict";
