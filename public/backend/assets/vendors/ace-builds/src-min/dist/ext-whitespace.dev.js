...
define("ace/ext/whitespace", ["require", "exports", "module", "ace/lib/lang"], function (e, t, n) {
  ...
  t.$detectIndentation = function (e, t) {
    ...
    for (var u = 0; u < o; u++) {
      ...
      if (a[0] == "	") i++, s = -Number.MAX_VALUE;else {
    ...
    for (var u = 1; u < 12; u++) {
      var v = c(u);
      u == 1 ? (d = v, v = n[1] ? .9 : .8, n.length || (v = 0)) : v /= d, r[u] && (v += r[u] / h), v > p.score && (p = {
        score: v,
        length: u
      });
    }
    ...
    var n = e.getDocument(),
        ...
        s = [],
        o = -1;
    t && t.keepCursorPosition && (e.selection.rangeCount ? e.selection.rangeList.ranges.forEach(function (e, t, n) {
      var r = n[t + 1];
      if (r && r.cursor.row == e.cursor.row) return;
      s.push(e.cursor);
    }) : s.push(e.selection.getCursor()), o = 0);
    var u = s[o] && s[o].row;

    for (var a = 0, f = r.length; a < f; a++) {
      var l = r[a],
          c = l.search(/\s+$/);
      a == u && (c < s[o].column && c > i && (c = s[o].column), o++, u = s[o] ? s[o].row : -1), c > i && n.removeInLine(a, c, l.length);
    }
    ...
    for (var c = 0, h = a.length; c < h; c++) {
      ...
      if (d) {
        ...
        y += l[g] || (l[g] = r.stringRepeat(" ", g)), y != d && (u.removeInLine(c, 0, d.length), u.insertInLine({
          row: c,
          column: 0
        }, y));
      }
    ...
    return e ? typeof e == "string" ? t.$parseStringArg(e) : typeof e.text == "string" ? t.$parseStringArg(e.text) : e : {};
  }, t.commands = [{
