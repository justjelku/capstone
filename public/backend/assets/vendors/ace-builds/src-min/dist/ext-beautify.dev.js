...
define("ace/ext/beautify", ["require", "exports", "module", "ace/token_iterator"], function (e, t, n) {
  "use strict";
  ...
  t.singletonTags = ["area", "base", "br", "col", "command", "embed", "hr", "html", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"], t.blockTags = ["article", "aside", "blockquote", "body", "div", "dl", "fieldset", "footer", "form", "head", "header", "html", "nav", "ol", "p", "script", "section", "style", "table", "tbody", "tfoot", "thead", "ul"], t.formatOptions = {
    lineBreaksAfterCommasInCurlyBlock: !0
    ...
    var n = new r(e, 0, 0),
      ...
      0: 0
        ...
        B = !1,
        j = function j() {
      l && l.value && l.type !== "string.regexp" && (l.value = l.value.replace(/^\s*/, ""));
    },
        F = function F() {
      var e = d.length - 1;
    ...
    while (s !== null) {
      ...
      if (typeof s != "undefined") {
        ...
        if (v) {
          ...
          if (i(s, "tag-close") && (D || a.indexOf(m) !== -1) || i(s, "doctype") && v === ">") D && l && l.value === "</" ? C = -1 : C = 1;
