...
!function (e) {
  ...
  function g(e, t, n, r, i) {
    ...
    for (;;) {
      ...
      switch (g) {
        case "=":
          if (m === u) s = e.slice(t, v), m = f;else {
            if (m !== a) throw new Error("attribute equal must after attrName");
            m = f;
          }
          break;
        ...
        case '"':
          if (m === f) {
            ...
            if (!(v > 0)) throw new Error("attribute value no end '" + g + "' match");
  ...
  function y(e, t, n) {
    ...
    while (o--) {
      var u = e[o],
          ...
          f = u.value,
          l = a.indexOf(":");
      if (l > 0) var c = u.prefix = a.slice(0, l),
          h = a.slice(l + 1),
          p = c === "xmlns" && h;else h = a, c = null, p = a === "xmlns" && "";
  ...
  function b(e, t, n, r, i) {
    if (/^(?:script|textarea)$/i.test(n)) {
      var s = e.indexOf("</" + n + ">", t),
          o = e.substring(t + 1, s);
      if (/[&<]/.test(o)) return /^script$/i.test(n) ? (i.characters(o, 0, o.length), s) : (o = o.replace(/&#?\w+;/g, r), i.characters(o, 0, o.length), s);
    }
    ...
    switch (i) {
      ...
      default:
        if (e.substr(t + 3, 6) == "CDATA[") {
          var s = e.indexOf("]]>", t + 9);
          return s > t ? (n.startCDATA(), n.characters(e, t + 9, s - t - 9), n.endCDATA(), s + 3) : (r.error("Unclosed CDATA"), -1);
        }
  ...
  var r = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
      i = new RegExp("[\\-\\.0-9" + r.source.slice(1, -1) + "\xB7\u0300-\u036F\\ux203F-\u2040]"),
      s = new RegExp("^" + r.source + i.source + "*(?::" + r.source + i.source + "*)?$"),
      o = 0,
      u = 1,
      a = 2,
      f = 3,
  ...
  }, N({}, N.prototype) instanceof N || (N = function N(e, t) {
    function n() {}
  ...
  function i(e, t) {
    ...
    i instanceof t || (n.prototype = t.prototype, n = new n(), r(i, n), e.prototype = i = n), i.constructor != e && (typeof e != "function" && console.error("unknown Class:" + e), i.constructor = e);
  }

  function B(e, t) {
    if (t instanceof Error) var n = t;else n = this, Error.call(this, w[e]), this.message = w[e], Error.captureStackTrace && Error.captureStackTrace(this, B);
    ...
    switch (e.nodeType) {
      case u:
        ...
        if (i || h && !/^(?:meta|link|img|br|hr|input|button)$/i.test(o)) {
          t.push(">");
          if (h && /^script$/i.test(o)) i && t.push(i.data);else while (i) {
      ...
      case m:
        ...
        if (b) t.push(' PUBLIC "', b), w && w != "." && t.push('" "', w), t.push('">');else if (w && w != ".") t.push(' SYSTEM "', w, '">');else {
  ...
  var s = "http://www.w3.org/1999/xhtml",
      ...
      k = b.NO_MODIFICATION_ALLOWED_ERR = (w[7] = "No modification allowed", 7),
  ...
  B.prototype = Error.prototype, r(b, B), j.prototype = {
    ...
    getElementById: function getElementById(e) {
      ...
      return $(this.documentElement, function (n) {
        if (n.nodeType == 1 && n.getAttribute("id") == e) return t = n, !0;
      }), t;
    },
  ...
  try {
    Object.defineProperty && (Object.defineProperty(F.prototype, "length", {
      get: function get() {
  ...
  function o(e, t, n) {
    function s(t) {
      var s = e[t];
      if (!s) if (i) s = e.length == 2 ? function (n) {
        e(t, n);
      } : e;else {
        var o = arguments.length;

        while (--o) {
          if (s = e[arguments[o]]) break;
        }
      }
  ...
  r.inherits(u, s), function () {
    this.setOptions = function (e) {
      ...
      t.options.errorHandler = {
        fatalError: function fatalError(e, t, r) {
          n.push({
            row: r.lineNumber,
        ...
        warning: function warning(e, t, r) {
          n.push({
            row: r.lineNumber,
            column: r.columnNumber,
            text: t,
