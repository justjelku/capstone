...
define("ace/mode/matlab_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text_highlight_rules").TextHighlightRules,
      s = function s() {
    var e = "break|case|catch|classdef|continue|else|elseif|end|for|function|global|if|otherwise|parfor|persistent|return|spmd|switch|try|while",
        t = "true|false|inf|Inf|nan|NaN|eps|pi|ans|nargin|nargout|varargin|varargout",
        ...
        r = "cell|struct|char|double|single|logical|u?int(?:8|16|32|64)|sparse",
  ...
  r.inherits(s, i), t.MatlabHighlightRules = s;
}), define("ace/mode/matlab", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/matlab_highlight_rules"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./matlab_highlight_rules").MatlabHighlightRules,
      o = function o() {
