...
define("ace/mode/csound_preprocessor_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  r.inherits(s, i), function () {
    this.pushRule = function (e) {
      if (Array.isArray(e.next)) for (var t = 0; t < e.next.length; t++) {
        e.next[t] = this.embeddedRulePrefix + e.next[t];
      }
      return {
        regex: e.regex,
        onMatch: function onMatch(t, n, r, i) {
          r.length === 0 && r.push(n);
          if (Array.isArray(e.next)) for (var s = 0; s < e.next.length; s++) {
            r.push(e.next[s]);
          } else r.push(e.next);
...
}), define("ace/mode/csound_score_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/csound_preprocessor_highlight_rules"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./csound_preprocessor_highlight_rules").CsoundPreprocessorHighlightRules,
      s = function s(e) {
    i.call(this, e), this.quotedStringContents.push({
...
}), define("ace/mode/lua_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/csound_orchestra_highlight_rules", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/mode/csound_preprocessor_highlight_rules", "ace/mode/csound_score_highlight_rules", "ace/mode/lua_highlight_rules", "ace/mode/python_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/lang"),
    ...
    i.splice(1, 0, {
      ...
      onMatch: function onMatch(e, r, i, s) {
...
}), define("ace/mode/csound_document_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/csound_orchestra_highlight_rules", "ace/mode/csound_score_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./csound_orchestra_highlight_rules").CsoundOrchestraHighlightRules,
...
}), define("ace/mode/csound_document", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/csound_document_highlight_rules"], function (e, t, n) {
  "use strict";
