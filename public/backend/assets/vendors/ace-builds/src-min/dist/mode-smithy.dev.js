...
define("ace/mode/smithy_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  s.metaData = {
    ...
    foldingStopMarker: "\\s*(\\}|\\])"
  }, r.inherits(s, i), t.SmithyHighlightRules = s;
...
}), define("ace/mode/smithy", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/smithy_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./smithy_highlight_rules").SmithyHighlightRules,
  ...
  r.inherits(f, i), function () {
    this.lineCommentStart = "//", this.$quotes = {
      '"': '"'
