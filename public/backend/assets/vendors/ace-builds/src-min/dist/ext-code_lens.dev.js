...
define("ace/ext/code_lens", ["require", "exports", "module", "ace/line_widgets", "ace/lib/event", "ace/lib/lang", "ace/lib/dom", "ace/editor", "ace/config"], function (e, t, n) {
  "use strict";
  ...
  function a(e, t) {
    ...
    for (var p = 0; p < f.length; p++) {
      ...
      var g = a[h];
      g || (g = a[h] = o.buildDom(["div", {
        "class": "ace_codeLens"
      }], t.container)), g.style.height = l.lineHeight + "px", h++;

      for (var y = 0; y < m.length; y++) {
        var b = g.childNodes[2 * y];
        b || (y != 0 && g.appendChild(o.createTextNode("\xA0|\xA0")), b = o.buildDom(["a"], g)), b.textContent = m[y].title, b.lensCommand = m[y];
      }
  ...
  t.setLenses = function (e, t) {
    ...
    return f(e), t && t.forEach(function (t) {
      var r = t.start.row,
          i = t.start.column,
