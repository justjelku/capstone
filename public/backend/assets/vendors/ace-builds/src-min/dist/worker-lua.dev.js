...
!function (e) {
  ...
  (function (e, n, r) {
    ...
    function u(e, t) {
      return t = t || 0, e < 128 ? String.fromCharCode(e) : e < 2048 ? String.fromCharCode(t | 192 | e >> 6, t | 128 | e & 63) : e < 65536 ? String.fromCharCode(t | 224 | e >> 12, t | 128 | e >> 6 & 63, t | 128 | e & 63) : e < 1114112 ? String.fromCharCode(t | 240 | e >> 18, t | 128 | e >> 12 & 63, t | 128 | e >> 6 & 63, t | 128 | e & 63) : null;
    }
    ...
    function f(e) {
      return function (t) {
        var n = e.exec(t);
        if (!n) return t;
        O(null, w.invalidCodeUnit, a(n[0].charCodeAt(0), 4).toUpperCase());
      };
    }
    ...
    function A(e) {
      return Object.create ? Object.create(e, {
        line: {
          writable: !0,
          value: e.line
        },
    ...
    function O(e) {
      var t = k.apply(null, x.call(arguments, 1)),
          n,
          r;
      throw e === null || typeof e.line == "undefined" ? (r = P - R + 1, n = A(new SyntaxError(k("[%1:%2] %3", q, r, t))), n.index = P, n.line = q, n.column = r) : (r = e.range[0] - e.lineStart, n = A(new SyntaxError(k("[%1:%2] %3", e.line, r, t))), n.line = e.line, n.index = e.range[0], n.column = r), n;
    }
    ...
    function D(e) {
      ...
      if ("undefined" != typeof e.type) {
        ...
        switch (e.type) {
          ...
          case y:
            return O(e, w.unexpected, "symbol", "nil", t);

          case c:
            return O(e, w.unexpectedEOF);
        }
    ...
    function U() {
      ...
      while (45 === t.charCodeAt(P) && 45 === t.charCodeAt(P + 1)) {
        rt(), W();
      }
      ...
      switch (e) {
        ...
        case 46:
          if (lt(n)) return Q();
          if (46 === n) return 46 === t.charCodeAt(P + 2) ? $() : V("..");
          return V(".");
        ...
        case 62:
          if (i.bitwiseOperators && 62 === n) return V(">>");
          if (61 === n) return V(">=");
          return V(">");

        case 60:
          if (i.bitwiseOperators && 60 === n) return V("<<");
          if (61 === n) return V("<=");
          return V("<");

        case 126:
          if (61 === n) return V("~=");
          if (!i.bitwiseOperators) break;
          return V("~");

        case 58:
          if (i.labels && 58 === n) return V("::");
          return V(":");

        case 91:
          if (91 === n || 61 === n) return K();
          return V("[");

        case 47:
          if (i.integerDivision && 47 === n) return V("//");
          return V("/");
    ...
    function z() {
      var e = t.charCodeAt(P),
          n = t.charCodeAt(P + 1);
      return ft(e) ? (10 === e && 13 === n && ++P, 13 === e && 10 === n && ++P, ++q, R = ++P, !0) : !1;
    }

    function W() {
      while (P < r) {
        var e = t.charCodeAt(P);
        if (at(e)) ++P;else if (!z()) break;
      }
    }
    ...
    function X() {
      ...
      while (pt(t.charCodeAt(++P))) {
        ;
      }

      return e = s.fixup(t.slice(I, P)), dt(e) ? n = p : "true" === e || "false" === e ? (n = g, e = "true" === e) : "nil" === e ? (n = y, e = null) : n = d, {
        type: n,
        value: e,
        line: q,
        lineStart: R,
    ...
    function J() {
      var e = t.charCodeAt(P++),
          ...
          i = R,
          o = P,
          u = s.discardStrings ? null : "",
          a;

      for (;;) {
        a = t.charCodeAt(P++);
        if (e === a) break;
        if (P > r || ft(a)) u += t.slice(o, P - 1), O(null, w.unfinishedString, t.slice(I, P - 1));
      ...
      return s.discardStrings || (u += s.encodeByte(null), u += s.fixup(t.slice(o, P - 1))), {
        type: h,
        value: u,
        line: n,
        lineStart: i,
    ...
    function K() {
      var e = q,
          t = R,
          n = it(!1);
      return !1 === n && O(H, w.expected, "[", M(H)), {
        type: h,
        value: s.discardStrings ? null : s.fixup(n),
        line: e,
        lineStart: t,
        lastLine: q,
        lastLineStart: R,
    ...
    function Q() {
      var e = t.charAt(P),
          n = t.charAt(P + 1),
          r = "0" === e && "xX".indexOf(n || null) >= 0 ? Z() : et(),
          i = G(),
          s = Y();
      return s && (i || r.hasFractionPart) && O(null, w.malformedNumber, t.slice(I, P)), {
        type: v,
        value: r.value,
        line: q,
        lineStart: R,
    ...
    function G() {
      if (!i.imaginaryNumbers) return;
      return "iI".indexOf(t.charAt(P) || null) >= 0 ? (++P, !0) : !1;
    }

    function Y() {
      if (!i.integerSuffixes) return;

      if ("uU".indexOf(t.charAt(P) || null) >= 0) {
        ++P;

        if ("lL".indexOf(t.charAt(P) || null) >= 0) {
          ++P;
          if ("lL".indexOf(t.charAt(P) || null) >= 0) return ++P, "ULL";
          O(null, w.malformedNumber, t.slice(I, P));
        } else O(null, w.malformedNumber, t.slice(I, P));
      } else if ("lL".indexOf(t.charAt(P) || null) >= 0) {
        ++P;
        if ("lL".indexOf(t.charAt(P) || null) >= 0) return ++P, "LL";
        O(null, w.malformedNumber, t.slice(I, P));
      }
    }
    ...
    function Z() {
      var e = 0,
          ...
          o,
          u;
      u = P += 2, ct(t.charCodeAt(P)) || O(null, w.malformedNumber, t.slice(I, P));

      while (ct(t.charCodeAt(P))) {
        ++P;
      }

      i = parseInt(t.slice(u, P), 16);
      var a = !1;
      ...
      if ("pP".indexOf(t.charAt(P) || null) >= 0) {
    ...
    function et() {
      ...
      if ("eE".indexOf(t.charAt(P) || null) >= 0) {
    ...
    function tt() {
      var e = P++;
      t.charAt(P++) !== "{" && O(null, w.braceExpected, "{", "\\" + t.slice(e, P)), ct(t.charCodeAt(P)) || O(null, w.hexadecimalDigitExpected, "\\" + t.slice(e, P));

      while (t.charCodeAt(P) === 48) {
        ++P;
      }
      ...
      while (ct(t.charCodeAt(P))) {
        ++P, P - n > 6 && O(null, w.tooLargeCodepoint, "\\" + t.slice(e, P));
      }

      var r = t.charAt(P++);
      r !== "}" && (r === '"' || r === "'" ? O(null, w.braceExpected, "}", "\\" + t.slice(e, P--)) : O(null, w.hexadecimalDigitExpected, "\\" + t.slice(e, P)));
      var i = parseInt(t.slice(n, P - 1) || "0", 16),
          o = "\\" + t.slice(e, P);
      return i > 1114111 && O(null, w.tooLargeCodepoint, o), s.encodeUTF8(i, o);
    }
    ...
    function nt() {
      ...
      switch (t.charAt(P)) {
        ...
        case "z":
          if (i.skipWhitespaceEscape) return ++P, W(), "";
          break;

        case "x":
          if (i.hexEscapes) {
            if (ct(t.charCodeAt(P + 1)) && ct(t.charCodeAt(P + 2))) return P += 3, s.encodeByte(parseInt(t.slice(e + 1, P), 16), "\\" + t.slice(e, P));
    ...
    function rt() {
      ...
      var e = t.charAt(P),
          ...
          u = R,
          a = q;
      "[" === e && (i = it(!0), !1 === i ? i = e : s = !0);

      if (!s) {
        while (P < r) {
          if (ft(t.charCodeAt(P))) break;
          ++P;
        }
      ...
      if (n.comments) {
        ...
        }), n.ranges && (f.range = [I, P]), n.onCreateNode && n.onCreateNode(f), F.push(f);
      }
    }
    ...
    function it(e) {
      ...
      if ("[" !== t.charAt(P + n)) return !1;
      P += n + 1, ft(t.charCodeAt(P)) && z(), u = P;
      ...
      while (P < r) {
        ...
        if (s) return i += t.slice(u, P - 1), P += n + 1, i;
      }
    ...
    function ot(e) {
      return e === H.value ? (st(), !0) : !1;
    }

    function ut(e) {
      e === H.value ? st() : O(H, w.expected, e, M(H));
    }
    ...
    function ht(e) {
      return e >= 65 && e <= 90 || e >= 97 && e <= 122 || 95 === e ? !0 : i.extendedIdentifiers && e >= 128 ? !0 : !1;
    }

    function pt(e) {
      return e >= 65 && e <= 90 || e >= 97 && e <= 122 || 95 === e || e >= 48 && e <= 57 ? !0 : i.extendedIdentifiers && e >= 128 ? !0 : !1;
    }
    ...
    function dt(e) {
      switch (e.length) {
        ...
        case 4:
          if ("else" === e || "then" === e) return !0;
          if (i.labels && !i.contextualGoto) return "goto" === e;
          return !1;
    ...
    function vt(e) {
      return m === e.type ? "#-~".indexOf(e.value) >= 0 : p === e.type ? "not" === e.value : !1;
    }
    ...
    function wt() {
      var e = gt[yt++].slice();
      gt.push(e), n.onCreateScope && n.onCreateScope();
    }

    function Et() {
      var e = gt.pop();
      --yt, n.onDestroyScope && n.onDestroyScope();
    }

    function St(e) {
      n.onLocalDeclaration && n.onLocalDeclaration(e);
      if (-1 !== N(gt[yt], e)) return;
      gt[yt].push(e);
    }
    ...
    function Tt(e, t) {
      !t && -1 === C(bt, "name", e.name) && bt.push(e), e.isLocal = t;
    }
    ...
    function Ht() {
      ...
      var t = Bt(e);
      return e.popScope(), n.scope && Et(), c !== H.type && D(H), kt && !t.length && (B = H), S(E.chunk(t));
    }
    ...
    function jt(e) {
      Ot();
      if (m === H.type && ot("::")) return Ft(e);

      if (i.emptyStatement && ot(";")) {
        kt && Ct.pop();
        return;
      }

      e.raiseDeferredErrors();
      if (p === H.type) switch (H.value) {
        case "local":
          return st(), $t(e);
        ...
        case "break":
          return st(), e.isInLoop() || O(H, w.noLoopToBreak, H.value), It();
    ...
    function Ft(e) {
      var t = H,
          r = Kt();
      return n.scope && (St("::" + t.value + "::"), Tt(r, !0)), ut("::"), e.addLabel(t.value, t), S(E.labelStatement(r));
    }

    function It() {
      return S(E.breakStatement());
    }
    ...
    function qt(e) {
      var t = H.value,
          n = B,
          r = Kt();
      return e.addGoto(t, n), S(E.gotoStatement(r));
    }

    function Rt(e) {
      n.scope && wt(), e.pushScope();
      var t = Bt(e);
      return e.popScope(), n.scope && Et(), ut("end"), S(E.doStatement(t));
    }

    function Ut(e) {
      var t = en(e);
      ut("do"), n.scope && wt(), e.pushScope(!0);
      var r = Bt(e);
      return e.popScope(), n.scope && Et(), ut("end"), S(E.whileStatement(t, r));
    }

    function zt(e) {
      n.scope && wt(), e.pushScope(!0);
      var t = Bt(e);
      ut("until"), e.raiseDeferredErrors();
      var r = en(e);
      return e.popScope(), n.scope && Et(), S(E.repeatStatement(r, t));
    }
    ...
    function Xt(e) {
      var t = [],
          ...
          i,
          s;
      kt && (s = Ct[Ct.length - 1], Ct.push(s)), r = en(e), ut("then"), n.scope && wt(), e.pushScope(), i = Bt(e), e.popScope(), n.scope && Et(), t.push(S(E.ifClause(r, i))), kt && (s = Lt());

      while (ot("elseif")) {
        Mt(s), r = en(e), ut("then"), n.scope && wt(), e.pushScope(), i = Bt(e), e.popScope(), n.scope && Et(), t.push(S(E.elseifClause(r, i))), kt && (s = Lt());
      }

      return ot("else") && (kt && (s = new At(B), Ct.push(s)), n.scope && wt(), e.pushScope(), i = Bt(e), e.popScope(), n.scope && Et(), t.push(S(E.elseClause(i)))), ut("end"), S(E.ifStatement(t));
    }
    ...
    function Vt(e) {
      ...
      return ut("do"), e.pushScope(!0), r = Bt(e), e.popScope(), ut("end"), n.scope && Et(), S(E.forGenericStatement(u, a, r));
    }
    ...
    function $t(e) {
      ...
      if (d === H.type) {
        ...
        if (n.scope) for (var u = 0, a = i.length; u < a; ++u) {
          xt(i[u]);
        }
        return S(E.localStatement(i, s));
      }

      if (ot("function")) return t = Kt(), e.addLocal(t.name, r), n.scope && (xt(t), wt()), Qt(t, !0);
    ...
    function Jt(e) {
      ...
      do {
        kt && (r = Lt());
        if (d === H.type) u = H.value, o = Kt(), n.scope && Tt(o, Nt(u)), s = !0;else {
          if ("(" !== H.value) return D(H);
          st(), o = en(e), ut(")"), s = !1;
        }
      ...
      if (a.length === 1 && s === null) return Mt(r), S(E.callStatement(a[0]));
      if (!s) return D(H);
      ut("=");
      var l = [];
      ...
      return Mt(i), S(E.assignmentStatement(a, l));
    }

    function Kt() {
      Ot();
      var e = H.value;
      return d !== H.type && _("<name>", H), st(), S(E.identifier(e));
    }
    ...
    function Qt(e, t) {
      ...
      if (!ot(")")) for (;;) {
        if (d === H.type) {
          ...
          if (ot(",")) continue;
        } else b === H.type ? (r.allowVararg = !0, i.push(un(r))) : _("<name> or '...'", H);

        ut(")");
        break;
      }
      var o = Bt(r);
      return r.popScope(), ut("end"), n.scope && Et(), t = t || !1, S(E.functionStatement(e, i, t, o));
    }

    function Gt() {
      var e, t, r;
      kt && (r = Lt()), e = Kt(), n.scope && (Tt(e, Nt(e.name)), wt());

      while (ot(".")) {
        Mt(r), t = Kt(), e = S(E.memberExpression(e, ".", t));
      }

      return ot(":") && (Mt(r), t = Kt(), e = S(E.memberExpression(e, ":", t)), n.scope && St("self")), e;
    }
    ...
    function Yt(e) {
      ...
      for (;;) {
        Ot();
        if (m === H.type && ot("[")) n = en(e), ut("]"), ut("="), r = en(e), t.push(S(E.tableKey(n, r)));else if (d === H.type) "=" === j.value ? (n = Kt(), st(), r = en(e), t.push(S(E.tableKeyString(n, r)))) : (r = en(e), t.push(S(E.tableValue(r))));else {
          if (null == (r = Zt(e))) {
            Ct.pop();
            break;
          }
    ...
    function rn(e, t, n) {
      var r, i;
      if (m === H.type) switch (H.value) {
        case "[":
          return Mt(t), st(), r = en(n), ut("]"), S(E.indexExpression(e, r));

        case ".":
          return Mt(t), st(), i = Kt(), S(E.memberExpression(e, ".", i));

        case ":":
          return Mt(t), st(), i = Kt(), e = S(E.memberExpression(e, ":", i)), Mt(t), on(e, n);

        case "(":
        case "{":
          return Mt(t), on(e, n);
      } else if (h === H.type) return Mt(t), on(e, n);
      return null;
    }
    ...
    function sn(e) {
      var t, r, i;
      kt && (i = Lt());
      if (d === H.type) r = H.value, t = Kt(), n.scope && Tt(t, Nt(r));else {
        if (!ot("(")) return null;
        t = en(e), ut(")");
      }
    ...
    function on(e, t) {
      ...
      } else if (h === H.type) return S(E.stringCallExpression(e, un(t)));

      _("function arguments", H);
    }
    ...
    function un(e) {
      var r = h | v | g | y | b,
          ...
          s = H.type,
          o;
      kt && (o = Lt()), s === b && !e.allowVararg && O(H, w.cannotUseVararg, H.value);
      ...
      if (p === s && "function" === i) return Mt(o), st(), n.scope && wt(), Qt(null);
      if (ot("{")) return Mt(o), Yt(e);
    }

    function fn(u, a) {
      "undefined" == typeof a && "object" == _typeof(u) && (a = u, u = undefined), a || (a = {}), t = u || "", n = L({}, o, a), P = 0, q = 1, R = 0, r = t.length, gt = [[]], yt = 0, bt = [], Ct = [];
      if (!Object.prototype.hasOwnProperty.call(an, n.luaVersion)) throw new Error(k("Lua version '%1' not supported", n.luaVersion));
      i = L({}, an[n.luaVersion]), n.extendedIdentifiers !== void 0 && (i.extendedIdentifiers = !!n.extendedIdentifiers);
      if (!Object.prototype.hasOwnProperty.call(l, n.encodingMode)) throw new Error(k("Encoding mode '%1' not supported", n.encodingMode));
      return s = l[n.encodingMode], n.comments && (F = []), n.wait ? e : cn();
    }
    ...
    function cn(e) {
      "undefined" != typeof e && ln(e), t && t.substr(0, 2) === "#!" && (t = t.replace(/^.*/, function (e) {
        return e.replace(/./g, " ");
      })), r = t.length, kt = n.locations || n.ranges, j = U();
      var i = Ht();
      n.comments && (i.comments = F), n.scope && (i.globals = bt);
      if (Ct.length > 0) throw new Error("Location tracking failed. This is most likely a bug in luaparse");
      return i;
    }
    ...
    var t,
      ...
      "pseudo-latin1": {
        fixup: f(/[^\x00-\xff]/),
        encodeByte: function encodeByte(e) {
          return e === null ? "" : String.fromCharCode(e);
        },
        encodeUTF8: function encodeUTF8(e) {
          return u(e);
        }
      },
      "x-user-defined": {
        fixup: f(/[^\x00-\x7f\uf780-\uf7ff]/),
        encodeByte: function encodeByte(e) {
          return e === null ? "" : e >= 128 ? String.fromCharCode(e | 63232) : String.fromCharCode(e);
        },
        encodeUTF8: function encodeUTF8(e) {
          return u(e, 63232);
        }
    ...
    var w = e.errors = {
      ...
      invalidCodeUnit: "code unit U+%1 is not allowed in the current encoding mode"
        ...
        E = e.ast = {
      labelStatement: function labelStatement(e) {
        return {
          type: "LabelStatement",
          label: e
        };
      ...
      gotoStatement: function gotoStatement(e) {
        return {
          type: "GotoStatement",
          label: e
        };
      },
      returnStatement: function returnStatement(e) {
        return {
          type: "ReturnStatement",
          arguments: e
        };
      },
      ifStatement: function ifStatement(e) {
        return {
          type: "IfStatement",
          clauses: e
        };
      },
      ifClause: function ifClause(e, t) {
        return {
          type: "IfClause",
          condition: e,
          body: t
      ...
      elseifClause: function elseifClause(e, t) {
        return {
          type: "ElseifClause",
          condition: e,
          body: t
      ...
      elseClause: function elseClause(e) {
        return {
          type: "ElseClause",
          body: e
        };
      },
      whileStatement: function whileStatement(e, t) {
        return {
          type: "WhileStatement",
          condition: e,
          body: t
      ...
      doStatement: function doStatement(e) {
        return {
          type: "DoStatement",
          body: e
        };
      },
      repeatStatement: function repeatStatement(e, t) {
        return {
      ...
      localStatement: function localStatement(e, t) {
        return {
          type: "LocalStatement",
          variables: e,
          init: t
      ...
      assignmentStatement: function assignmentStatement(e, t) {
        return {
      ...
      callStatement: function callStatement(e) {
        return {
          type: "CallStatement",
          expression: e
        };
      },
      functionStatement: function functionStatement(e, t, n, r) {
        return {
      ...
      forNumericStatement: function forNumericStatement(e, t, n, r, i) {
        return {
      ...
      forGenericStatement: function forGenericStatement(e, t, n) {
        return {
      ...
      literal: function literal(e, t, n) {
        return e = e === h ? "StringLiteral" : e === v ? "NumericLiteral" : e === g ? "BooleanLiteral" : e === y ? "NilLiteral" : "VarargLiteral", {
          type: e,
          value: t,
          raw: n
        };
      },
      tableKey: function tableKey(e, t) {
        return {
          type: "TableKey",
          key: e,
          value: t
      ...
      tableKeyString: function tableKeyString(e, t) {
        return {
          type: "TableKeyString",
          key: e,
          value: t
      ...
      tableValue: function tableValue(e) {
        return {
          type: "TableValue",
          value: e
        };
      },
      tableConstructorExpression: function tableConstructorExpression(e) {
        return {
          type: "TableConstructorExpression",
          fields: e
        };
      },
      binaryExpression: function binaryExpression(e, t, n) {
      ...
      memberExpression: function memberExpression(e, t, n) {
        return {
      ...
      indexExpression: function indexExpression(e, t) {
        return {
      ...
      tableCallExpression: function tableCallExpression(e, t) {
        return {
      ...
      stringCallExpression: function stringCallExpression(e, t) {
        return {
    ...
    Array.prototype.indexOf && (N = function N(e, t) {
      return e.indexOf(t);
    });
    ...
    var gt,
        ...
        Ct = [],
        kt;
    At.prototype.complete = function () {
      n.locations && (this.loc.end.line = B.lastLine || B.line, this.loc.end.column = B.range[1] - (B.lastLineStart || B.lineStart)), n.ranges && (this.range[1] = B.range[1]);
    }, At.prototype.bless = function (e) {
      if (this.loc) {
        var t = this.loc;
        e.loc = {
          start: {
    ...
    }, _t.prototype.isInLoop = function () {
      var e = this.scopes.length;
      ...
      return !1;
    }, _t.prototype.pushScope = function (e) {
      var t = {
        labels: {},
        locals: [],
        deferredGotos: [],
      ...
      this.scopes.push(t);
    }, _t.prototype.popScope = function () {
      ...
      this.scopes.pop();
    }, _t.prototype.addGoto = function (e, t) {
      var n = [];

      for (var r = 0; r < this.scopes.length; ++r) {
        var i = this.scopes[r];
        n.push(i.locals.length);
        if (Object.prototype.hasOwnProperty.call(i.labels, e)) return;
      }
    ...
    }, _t.prototype.addLabel = function (e, t) {
      var n = this.currentScope();
      if (Object.prototype.hasOwnProperty.call(n.labels, e)) O(t, w.labelAlreadyDefined, e, n.labels[e].line);else {
        var r = [];
      ...
      n.labels[e] = {
        localCount: n.locals.length,
        line: t.line
      };
    }, _t.prototype.addLocal = function (e, t) {
      this.currentScope().locals.push({
        name: e,
        token: t
      });
    }, _t.prototype.currentScope = function () {
      return this.scopes[this.scopes.length - 1];
    }, _t.prototype.raiseDeferredErrors = function () {
    ...
    }, Dt.prototype.isInLoop = function () {
      return !!this.loopLevels.length;
    }, Dt.prototype.pushScope = function (e) {
      ++this.level, e && this.loopLevels.push(this.level);
    }, Dt.prototype.popScope = function () {
      var e = this.loopLevels,
          t = e.length;
      t && e[t - 1] === this.level && e.pop(), --this.level;
    }, Dt.prototype.addGoto = Dt.prototype.addLabel = function () {
      throw new Error("This should never happen");
    }, Dt.prototype.addLocal = Dt.prototype.raiseDeferredErrors = function () {}, e.parse = fn;
    var an = {
      5.1: {},
      5.2: {
        labels: !0,
  ...
  r.inherits(o, i), function () {
    this.onUpdate = function () {
      ...
      try {
        ...
        n instanceof s.SyntaxError && t.push({
          row: n.line - 1,
          column: n.column,
          text: n.message,
          type: "error"
