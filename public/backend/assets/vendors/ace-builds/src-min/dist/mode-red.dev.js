...
define("ace/mode/red_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/red", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/red_highlight_rules", "ace/mode/folding/cstyle", "ace/mode/matching_brace_outdent", "ace/range"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
      ...
      a = e("../range").Range,
      f = function f() {
    this.HighlightRules = s, this.foldingRules = new o(), this.$outdent = new u(), this.$behaviour = this.$defaultBehaviour;
  };
