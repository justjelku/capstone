...
define("ace/mode/ion_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
    ...
    var e = "TRUE|FALSE",
        t = e,
        n = "NULL.NULL|NULL.BOOL|NULL.INT|NULL.FLOAT|NULL.DECIMAL|NULL.TIMESTAMP|NULL.STRING|NULL.SYMBOL|NULL.BLOB|NULL.CLOB|NULL.STRUCT|NULL.LIST|NULL.SEXP|NULL",
        r = n,
        i = this.createKeywordMapper({
      "constant.language.bool.ion": t,
      "constant.language.null.ion": r
    }, "constant.other.symbol.identifier.ion", !0),
        s = {
      token: i,
      regex: "\\b\\w+(?:\\.\\w+)?\\b"
    };
    ...
    }, this.$rules.keywords = [s], this.normalizeRules();
  };

  r.inherits(s, i), t.IonHighlightRules = s;
}), define("ace/mode/partiql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/ion_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
    ...
    }, "variable.language.identifier.partiql", !0),
        v = {
      token: d,
      regex: "\\b\\w+\\b"
    };
    this.$rules = {
      ...
      string: [{
        token: ["punctuation.definition.string.begin.partiql", "string.quoted.single.partiql", "punctuation.definition.string.end.partiql"],
        regex: "(['])((?:(?:\\\\.)|(?:[^'\\\\]))*?)(['])"
      }],
      collection_value: [{
        include: "array_value"
    ...
    }, this.$rules.keywords = [v], this.$rules["embed-ion"] = [{
...
}), define("ace/mode/partiql", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/partiql_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";
