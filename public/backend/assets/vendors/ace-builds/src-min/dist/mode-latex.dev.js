...
define("ace/mode/latex_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    this.foldingStartMarker = /^\s*\\(begin)|\s*\\(part|chapter|(?:sub)*(?:section|paragraph))\b|{\s*$/, this.foldingStopMarker = /^\s*\\(end)\b|^\s*}/, this.getFoldWidgetRange = function (e, t, n) {
      ...
      var i = {
        ...
        "\\end": -1
          ...
          u = new o(e, t, n),
          a = u.getCurrentToken();
      if (!a || a.type != "storage.type" && a.type != "constant.character.escape") return;
      ...
      var f = a.value,
        ...
        return l === -1 && (u.stepBackward(), t && u.stepBackward()), t;
      },
          h = [c()],
      ...
      while (a = u.step()) {
        if (!a || a.type != "storage.type" && a.type != "constant.character.escape") continue;
        var v = i[a.value];
        if (!v) continue;
        var m = c();
        if (v === l) h.unshift(m);else if (h.shift() !== m || !h.length) break;
      }
      ...
      return l === -1 ? new s(t, e.getLine(t).length, d, p) : new s(d, p, t, u.getCurrentTokenColumn());
  ...
  r.inherits(a, i), function () {
    this.type = "text", this.lineCommentStart = "%", this.$id = "ace/mode/latex", this.getMatching = function (e, t, n) {
      t == undefined && (t = e.selection.lead), _typeof(t) == "object" && (n = t.column, t = t.row);
      var r = e.getTokenAt(t, n);
      if (!r) return;
      if (r.value == "\\begin" || r.value == "\\end") return this.foldingRules.latexBlock(e, t, n, !0);
    };
