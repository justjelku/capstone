...
!function (e) {
...
}), define("ace/mode/css/csslint", [], function (e, t, n) {
  var r = function () {
    function s(e, t, n, r) {
      "use strict";
    ...
    var e = e || {},
      ...
      return e = function () {
        function t(n, r, i) {
          ...
          for (var o = "function" == typeof e && e, u = 0; u < i.length; u++) {
            s(i[u]);
          }
        ...
        3: [function (e, t, n) {
          ...
          function s(e, t) {
            this.match = function (t) {
              var n;
              return t.mark(), n = e(t), n ? t.drop() : t.restore(), n;
            }, this.toString = typeof t == "function" ? t : function () {
              return t;
            };
          }

          t.exports = s;
          var r = e("../util/StringReader"),
          ...
          s.prec = {
            ...
            t = new r(e), n = function n(e) {
              var n = t.readMatch(e);
              if (n === null) throw new i("Expected " + e, t.getLine(), t.getCol());
              return n;
            }, o = function o() {
              var e = [u()];

              while (t.readMatch(" | ") !== null) {
                e.push(u());
              }

              return e.length === 1 ? e[0] : s.alt.apply(s, e);
            }, u = function u() {
              var e = [a()];
              ...
              return e.length === 1 ? e[0] : s.oror.apply(s, e);
            }, a = function a() {
              var e = [f()];
              ...
              return e.length === 1 ? e[0] : s.andand.apply(s, e);
            }, f = function f() {
              var e = [l()];
              ...
              return e.length === 1 ? e[0] : s.seq.apply(s, e);
            }, l = function l() {
              var e = c();
              if (t.readMatch("?") !== null) return e.question();
              if (t.readMatch("*") !== null) return e.star();
              if (t.readMatch("+") !== null) return e.plus();
              if (t.readMatch("#") !== null) return e.hash();

              if (t.readMatch(/^\{\s*/) !== null) {
                var r = n(/^\d+/);
                n(/^\s*,\s*/);
                var i = n(/^\d+/);
            ...
            return e instanceof s ? e : s.parse(e);
          }, s.fromType = function (t) {
            var n = e("./ValidationTypes");
            return new s(function (e) {
              return e.hasNext() && n.isType(e, t);
            }, t);
          }, s.seq = function () {
            var e = Array.prototype.slice.call(arguments).map(s.cast);
            return e.length === 1 ? e[0] : new s(function (t) {
              var n,
                  r = !0;
            ...
            var n = Array.prototype.slice.call(arguments, 1).reduce(function (t, n) {
              ...
              } else t.push(s.cast(n));

              return t;
            }, []);
            t === !0 && (t = n.map(function () {
              return !0;
            }));
            var r = new s(function (e) {
              var r = [],
                  ...
                  s = 0,
                  o = function o(e) {
                return s === 0 ? (i = Math.max(e, i), e === n.length) : e === i;
              },
                  u = function u(i) {
                for (var s = 0; s < n.length; s++) {
                  ...
                  if (n[s].match(e)) {
                    r[s] = !0;
                    if (u(i + (t === !1 || t[s] ? 1 : 0))) return e.drop(), !0;
                    e.restore(), r[s] = !1;
                  } else e.drop();
                }
              ...
              var r = t === !1 ? s.prec.OROR : s.prec.ANDAND,
                  i = n.map(function (e, n) {
                return t !== !1 && !t[n] ? e.toString(s.prec.MOD) + "?" : e.toString(r);
              }).join(t === !1 ? " || " : " && ");
              return e > r && (i = "[ " + i + " ]"), i;
            });
            ...
            return e.unshift(!0), s.many.apply(s, e);
          }, s.oror = function () {
            var e = Array.prototype.slice.call(arguments);
            return e.unshift(!1), s.many.apply(s, e);
          }, s.prototype = {
            constructor: s,
            ...
            andand: function andand(e) {
              return s.many(!0, this, e);
            },
            oror: function oror(e) {
              return s.many(!1, this, e);
            },
            star: function star() {
            ...
            hash: function hash() {
              return this.braces(1, Infinity, "#", s.cast(","));
            },
            braces: function braces(e, t, n, r) {
              var i = this,
                  o = r ? r.then(this) : this;
              return n || (n = "{" + e + "," + t + "}"), new s(function (n) {
                var s = !0,
                    u;
                ...
                return i.toString(s.prec.MOD) + n;
              });
            }
          };
        }, {
        ...
        4: [function (e, t, n) {
          ...
          function s(e, t) {
            r.call(this, "(" + e + (t !== null ? ":" + t : "") + ")", e.startLine, e.startCol, i.MEDIA_FEATURE_TYPE), this.name = e, this.value = t;
          }
        ...
        5: [function (e, t, n) {
          ...
          function s(e, t, n, s, o) {
            r.call(this, (e ? e + " " : "") + (t ? t : "") + (t && n.length > 0 ? " and " : "") + n.join(" and "), s, o, i.MEDIA_QUERY_TYPE), this.modifier = e, this.mediaType = t, this.features = n;
          }
        ...
        6: [function (e, t, n) {
          ...
          var r = e("../util/EventTarget"),
              ...
              m = e("./Tokens"),
              g = e("./Validation");
          y.DEFAULT_TYPE = 0, y.COMBINATOR_TYPE = 1, y.MEDIA_FEATURE_TYPE = 2, y.MEDIA_QUERY_TYPE = 3, y.PROPERTY_NAME_TYPE = 4, y.PROPERTY_VALUE_TYPE = 5, y.PROPERTY_VALUE_PART_TYPE = 6, y.SELECTOR_TYPE = 7, y.SELECTOR_PART_TYPE = 8, y.SELECTOR_SUB_PART_TYPE = 9, y.prototype = function () {
            var e = new r(),
                t,
                n = {
              __proto__: null,
                ...
                while (r > m.EOF) {
                  try {
                    switch (r) {
                      ...
                      case m.UNKNOWN_SYM:
                        e.get();
                        if (!!this.options.strict) throw new i("Unknown @ rule.", e.LT(0).startLine, e.LT(0).startCol);
                        this.fire({
                          type: "error",
                          error: null,
                      ...
                      default:
                        if (!this._ruleset()) switch (r) {
                          case m.CHARSET_SYM:
                            throw n = e.LT(1), this._charset(!1), new i("@charset not allowed here.", n.startLine, n.startCol);

                          case m.IMPORT_SYM:
                            throw n = e.LT(1), this._import(!1), new i("@import not allowed here.", n.startLine, n.startCol);

                          case m.NAMESPACE_SYM:
                            throw n = e.LT(1), this._namespace(!1), new i("@namespace not allowed here.", n.startLine, n.startCol);
                    ...
                    if (!(s instanceof i && !this.options.strict)) throw s;
                    this.fire({
                      type: "error",
                      error: s,
                      message: s.message,
              ...
              _charset: function _charset(e) {
                var t = this._tokenStream,
                    ...
                    i,
                    s;
                t.match(m.CHARSET_SYM) && (i = t.token().startLine, s = t.token().startCol, this._readWhitespace(), t.mustMatch(m.STRING), r = t.token(), n = r.value, this._readWhitespace(), t.mustMatch(m.SEMICOLON), e !== !1 && this.fire({
                  type: "charset",
                  charset: n,
                  line: i,
                  col: s
              ...
              _import: function _import(e) {
                var t = this._tokenStream,
                    ...
                    r,
                    i = [];
                t.mustMatch(m.IMPORT_SYM), r = t.token(), this._readWhitespace(), t.mustMatch([m.STRING, m.URI]), n = t.token().value.replace(/^(?:url\()?["']?([^"']+?)["']?\)?$/, "$1"), this._readWhitespace(), i = this._media_query_list(), t.mustMatch(m.SEMICOLON), this._readWhitespace(), e !== !1 && this.fire({
                  type: "import",
                  uri: n,
                  media: i,
                  line: r.startLine,
              ...
              _namespace: function _namespace(e) {
                var t = this._tokenStream,
                    ...
                    i,
                    s;
                t.mustMatch(m.NAMESPACE_SYM), n = t.token().startLine, r = t.token().startCol, this._readWhitespace(), t.match(m.IDENT) && (i = t.token().value, this._readWhitespace()), t.mustMatch([m.STRING, m.URI]), s = t.token().value.replace(/(?:url\()?["']([^"']+)["']\)?/, "$1"), this._readWhitespace(), t.mustMatch(m.SEMICOLON), this._readWhitespace(), e !== !1 && this.fire({
                  type: "namespace",
                  prefix: i,
                  uri: s,
                  line: n,
              ...
              _supports: function _supports(e) {
                var t = this._tokenStream,
                    n,
                    r;

                if (t.match(m.SUPPORTS_SYM)) {
                  n = t.token().startLine, r = t.token().startCol, this._readWhitespace(), this._supports_condition(), this._readWhitespace(), t.mustMatch(m.LBRACE), this._readWhitespace(), e !== !1 && this.fire({
                    type: "startsupports",
                    line: n,
                    col: r
                  });
                  ...
                  t.mustMatch(m.RBRACE), this._readWhitespace(), this.fire({
                    type: "endsupports",
                    line: n,
                    col: r
                  });
              ...
              _supports_condition: function _supports_condition() {
                var e = this._tokenStream,
                    t;
                if (e.match(m.IDENT)) t = e.token().value.toLowerCase(), t === "not" ? (e.mustMatch(m.S), this._supports_condition_in_parens()) : e.unget();else {
                  this._supports_condition_in_parens(), this._readWhitespace();

                  while (e.peek() === m.IDENT) {
                    t = e.LT(1).value.toLowerCase();
                    if (t === "and" || t === "or") e.mustMatch(m.IDENT), this._readWhitespace(), this._supports_condition_in_parens(), this._readWhitespace();
                  }
                }
              },
              _supports_condition_in_parens: function _supports_condition_in_parens() {
                var e = this._tokenStream,
                    t;
                e.match(m.LPAREN) ? (this._readWhitespace(), e.match(m.IDENT) ? (t = e.token().value.toLowerCase(), t === "not" ? (this._readWhitespace(), this._supports_condition(), this._readWhitespace(), e.mustMatch(m.RPAREN)) : (e.unget(), this._supports_declaration_condition(!1))) : (this._supports_condition(), this._readWhitespace(), e.mustMatch(m.RPAREN))) : this._supports_declaration_condition();
              },
              _supports_declaration_condition: function _supports_declaration_condition(e) {
                var t = this._tokenStream;
                e !== !1 && t.mustMatch(m.LPAREN), this._readWhitespace(), this._declaration(), t.mustMatch(m.RPAREN);
              },
              _media: function _media() {
                var e = this._tokenStream,
                    ...
                    n,
                    r;
                e.mustMatch(m.MEDIA_SYM), t = e.token().startLine, n = e.token().startCol, this._readWhitespace(), r = this._media_query_list(), e.mustMatch(m.LBRACE), this._readWhitespace(), this.fire({
                  type: "startmedia",
                  media: r,
                  line: t,
                  col: n
                ...
                for (;;) {
                  if (e.peek() === m.PAGE_SYM) this._page();else if (e.peek() === m.FONT_FACE_SYM) this._font_face();else if (e.peek() === m.VIEWPORT_SYM) this._viewport();else if (e.peek() === m.DOCUMENT_SYM) this._document();else if (e.peek() === m.SUPPORTS_SYM) this._supports();else if (e.peek() === m.MEDIA_SYM) this._media();else if (!this._ruleset()) break;
                }

                e.mustMatch(m.RBRACE), this._readWhitespace(), this.fire({
                  type: "endmedia",
                  media: r,
                  line: t,
                  col: n
              ...
              _media_query_list: function _media_query_list() {
                var e = this._tokenStream,
                    t = [];
                this._readWhitespace(), (e.peek() === m.IDENT || e.peek() === m.LPAREN) && t.push(this._media_query());
              ...
              _media_query: function _media_query() {
                var e = this._tokenStream,
                    ...
                    r = null,
                    i = [];
                e.match(m.IDENT) && (n = e.token().value.toLowerCase(), n !== "only" && n !== "not" ? (e.unget(), n = null) : r = e.token()), this._readWhitespace(), e.peek() === m.IDENT ? (t = this._media_type(), r === null && (r = e.token())) : e.peek() === m.LPAREN && (r === null && (r = e.LT(1)), i.push(this._media_expression()));
                if (t === null && i.length === 0) return null;

                this._readWhitespace();

                while (e.match(m.IDENT)) {
                  e.token().value.toLowerCase() !== "and" && this._unexpectedToken(e.token()), this._readWhitespace(), i.push(this._media_expression());
                }

                return new a(n, t, i, r.startLine, r.startCol);
              },
              ...
              _media_expression: function _media_expression() {
                var e = this._tokenStream,
                    ...
                    n,
                    r = null;
                return e.mustMatch(m.LPAREN), this._readWhitespace(), t = this._media_feature(), this._readWhitespace(), e.match(m.COLON) && (this._readWhitespace(), n = e.LT(1), r = this._expression()), e.mustMatch(m.RPAREN), this._readWhitespace(), new u(t, r ? new s(r, n.startLine, n.startCol) : null);
              },
              _media_feature: function _media_feature() {
                var e = this._tokenStream;
                return this._readWhitespace(), e.mustMatch(m.IDENT), s.fromToken(e.token());
              },
              _page: function _page() {
                var e = this._tokenStream,
                    ...
                    r = null,
                    i = null;
                e.mustMatch(m.PAGE_SYM), t = e.token().startLine, n = e.token().startCol, this._readWhitespace(), e.match(m.IDENT) && (r = e.token().value, r.toLowerCase() === "auto" && this._unexpectedToken(e.token())), e.peek() === m.COLON && (i = this._pseudo_page()), this._readWhitespace(), this.fire({
                  type: "startpage",
                  id: r,
                  pseudo: i,
                  line: t,
              ...
              _margin_sym: function _margin_sym() {
                var e = this._tokenStream;
                return e.match([m.TOPLEFTCORNER_SYM, m.TOPLEFT_SYM, m.TOPCENTER_SYM, m.TOPRIGHT_SYM, m.TOPRIGHTCORNER_SYM, m.BOTTOMLEFTCORNER_SYM, m.BOTTOMLEFT_SYM, m.BOTTOMCENTER_SYM, m.BOTTOMRIGHT_SYM, m.BOTTOMRIGHTCORNER_SYM, m.LEFTTOP_SYM, m.LEFTMIDDLE_SYM, m.LEFTBOTTOM_SYM, m.RIGHTTOP_SYM, m.RIGHTMIDDLE_SYM, m.RIGHTBOTTOM_SYM]) ? s.fromToken(e.token()) : null;
              },
              _pseudo_page: function _pseudo_page() {
                var e = this._tokenStream;
                return e.mustMatch(m.COLON), e.mustMatch(m.IDENT), e.token().value;
              },
              _font_face: function _font_face() {
                var e = this._tokenStream,
                    t,
                    n;
                e.mustMatch(m.FONT_FACE_SYM), t = e.token().startLine, n = e.token().startCol, this._readWhitespace(), this.fire({
                  type: "startfontface",
                  line: t,
                  col: n
                }), this._readDeclarations(!0), this.fire({
              ...
              _viewport: function _viewport() {
                var e = this._tokenStream,
                    t,
                    n;
                e.mustMatch(m.VIEWPORT_SYM), t = e.token().startLine, n = e.token().startCol, this._readWhitespace(), this.fire({
                  type: "startviewport",
                  line: t,
                  col: n
                }), this._readDeclarations(!0), this.fire({
              ...
              _document: function _document() {
                var e = this._tokenStream,
                    ...
                    n = [],
                    r = "";
                e.mustMatch(m.DOCUMENT_SYM), t = e.token(), /^@-([^-]+)-/.test(t.value) && (r = RegExp.$1), this._readWhitespace(), n.push(this._document_function());

                while (e.match(m.COMMA)) {
                  this._readWhitespace(), n.push(this._document_function());
                }

                e.mustMatch(m.LBRACE), this._readWhitespace(), this.fire({
                  type: "startdocument",
                  functions: n,
                  prefix: r,
                  line: t.startLine,
                ...
                e.mustMatch(m.RBRACE), t = e.token(), this._readWhitespace(), this.fire({
                  type: "enddocument",
                  functions: n,
                  prefix: r,
                  line: t.startLine,
              ...
              _document_function: function _document_function() {
                var e = this._tokenStream,
                    t;
                return e.match(m.URI) ? (t = e.token().value, this._readWhitespace()) : t = this._function(), t;
              },
              _operator: function _operator(e) {
                var t = this._tokenStream,
                    n = null;
                if (t.match([m.SLASH, m.COMMA]) || e && t.match([m.PLUS, m.STAR, m.MINUS])) n = t.token(), this._readWhitespace();
                return n ? c.fromToken(n) : null;
              },
              _combinator: function _combinator() {
                var e = this._tokenStream,
                    t = null,
                    n;
                return e.match([m.PLUS, m.GREATER, m.TILDE]) && (n = e.token(), t = new o(n.value, n.startLine, n.startCol), this._readWhitespace()), t;
              },
              _unary_operator: function _unary_operator() {
                var e = this._tokenStream;
                return e.match([m.MINUS, m.PLUS]) ? e.token().value : null;
              },
              _property: function _property() {
                var e = this._tokenStream,
                    ...
                    s,
                    o;
                e.peek() === m.STAR && this.options.starHack && (e.get(), i = e.token(), n = i.value, s = i.startLine, o = i.startCol), e.peek() === m.MINUS && (e.get(), i = e.token(), r = i.value, s = i.startLine, o = i.startCol);
                if (e.match(m.IDENT)) i = e.token(), r += i.value, r.charAt(0) === "_" && this.options.underscoreHack && (n = "_", r = r.substring(1)), t = new f(r, n, s || i.startLine, o || i.startCol), this._readWhitespace();else {
                  var u = e.peek();
                  u !== m.EOF && u !== m.RBRACE && this._unexpectedToken(e.LT(1));
                }
                return t;
              },
                ...
                try {
                  ...
                  if (r instanceof i && !this.options.strict) {
                    this.fire({
                      ...
                      line: r.line,
                      col: r.col
                    }), t = e.advance([m.RBRACE]);
                    if (t !== m.RBRACE) throw r;
                    return !0;
                  }
              ...
              _selector: function _selector() {
                ...
                return new h(t, t[0].line, t[0].col);
              },
              _simple_selector_sequence: function _simple_selector_sequence() {
                var e = this._tokenStream,
                    ...
                    r = "",
                    i = [function () {
                  return e.match(m.HASH) ? new d(e.token().value, "id", e.token().startLine, e.token().startCol) : null;
                    ...
                    a,
                    f;
                a = e.LT(1).startLine, f = e.LT(1).startCol, t = this._type_selector(), t || (t = this._universal()), t !== null && (r += t);
              ...
              _class: function _class() {
                var e = this._tokenStream,
                    t;
                return e.match(m.DOT) ? (e.mustMatch(m.IDENT), t = e.token(), new d("." + t.value, "class", t.startLine, t.startCol - 1)) : null;
              },
              _element_name: function _element_name() {
                var e = this._tokenStream,
                    t;
                return e.match(m.IDENT) ? (t = e.token(), new d(t.value, "elementName", t.startLine, t.startCol)) : null;
              },
              _namespace_prefix: function _namespace_prefix() {
                var e = this._tokenStream,
                    t = "";
                if (e.LA(1) === m.PIPE || e.LA(2) === m.PIPE) e.match([m.IDENT, m.STAR]) && (t += e.token().value), e.mustMatch(m.PIPE), t += "|";
                return t.length ? t : null;
              },
              _universal: function _universal() {
                var e = this._tokenStream,
                    t = "",
                    n;
                return n = this._namespace_prefix(), n && (t += n), e.match(m.STAR) && (t += "*"), t.length ? t : null;
              },
              _attrib: function _attrib() {
                var e = this._tokenStream,
                    ...
                    n,
                    r;
                return e.match(m.LBRACKET) ? (r = e.token(), t = r.value, t += this._readWhitespace(), n = this._namespace_prefix(), n && (t += n), e.mustMatch(m.IDENT), t += e.token().value, t += this._readWhitespace(), e.match([m.PREFIXMATCH, m.SUFFIXMATCH, m.SUBSTRINGMATCH, m.EQUALS, m.INCLUDES, m.DASHMATCH]) && (t += e.token().value, t += this._readWhitespace(), e.mustMatch([m.IDENT, m.STRING]), t += e.token().value, t += this._readWhitespace()), e.mustMatch(m.RBRACKET), new d(t + "]", "attribute", r.startLine, r.startCol)) : null;
              },
              ...
              _functional_pseudo: function _functional_pseudo() {
                var e = this._tokenStream,
                    t = null;
                return e.match(m.FUNCTION) && (t = e.token().value, t += this._readWhitespace(), t += this._expression(), e.mustMatch(m.RPAREN), t += ")"), t;
              },
              _expression: function _expression() {
                var e = this._tokenStream,
                    t = "";

                while (e.match([m.PLUS, m.MINUS, m.DIMENSION, m.NUMBER, m.STRING, m.IDENT, m.LENGTH, m.FREQ, m.ANGLE, m.TIME, m.RESOLUTION, m.SLASH])) {
              ...
              _negation: function _negation() {
                var e = this._tokenStream,
                    ...
                    i,
                    s = null;
                return e.match(m.NOT) && (r = e.token().value, t = e.token().startLine, n = e.token().startCol, r += this._readWhitespace(), i = this._negation_arg(), r += i, r += this._readWhitespace(), e.match(m.RPAREN), r += e.token().value, s = new d(r, "not", t, n), s.args.push(i)), s;
              },
              _negation_arg: function _negation_arg() {
                var e = this._tokenStream,
                  ...
                  return e.match(m.HASH) ? new d(e.token().value, "id", e.token().startLine, e.token().startCol) : null;
                    ...
                    o,
                    u;
                s = e.LT(1).startLine, o = e.LT(1).startCol;

                while (r < i && n === null) {
                  n = t[r].call(this), r++;
                }

                return n === null && this._unexpectedToken(e.LT(1)), n.type === "elementName" ? u = new p(n, [], n.toString(), s, o) : u = new p(null, [n], n.toString(), s, o), u;
              },
              _declaration: function _declaration() {
                ...
                if (t !== null) {
                  ...
                  if (this.options.starHack && t.hack === "*" || this.options.underscoreHack && t.hack === "_") s = t.text;
              ...
              _expr: function _expr(e) {
                ...
                return t.length > 0 ? new l(t, t[0].line, t[0].col) : null;
              },
              _term: function _term(e) {
                var t = this._tokenStream,
                    n = null,
                    r = null,
                    i = null,
              ...
              _function: function _function() {
                ...
                if (e.match(m.FUNCTION)) {
                  t = e.token().value, this._readWhitespace(), n = this._expr(!0), t += n;
                  if (this.options.ieFilters && e.peek() === m.EQUALS) do {
              ...
              _ie_function: function _ie_function() {
                ...
                if (e.match([m.IE_FUNCTION, m.FUNCTION])) {
                  t = e.token().value;
              ...
              _hexcolor: function _hexcolor() {
                ...
                if (e.match(m.HASH)) {
                  t = e.token(), n = t.value;
                  if (!/#[a-f0-9]{3,6}/i.test(n)) throw new i("Expected a hex color but found '" + n + "' at line " + t.startLine + ", col " + t.startCol + ".", t.startLine, t.startCol);
              ...
              _keyframes: function _keyframes() {
                var e = this._tokenStream,
                    ...
                    r,
                    i = "";
                e.mustMatch(m.KEYFRAMES_SYM), t = e.token(), /^@-([^-]+)-/.test(t.value) && (i = RegExp.$1), this._readWhitespace(), r = this._keyframe_name(), this._readWhitespace(), e.mustMatch(m.LBRACE), this.fire({
                  type: "startkeyframes",
                  name: r,
                  prefix: i,
                  line: t.startLine,
                ...
                while (n === m.IDENT || n === m.PERCENTAGE) {
                ...
                this.fire({
                  ...
                  line: t.startLine,
                  col: t.startCol
                }), this._readWhitespace(), e.mustMatch(m.RBRACE), this._readWhitespace();
              },
              _keyframe_name: function _keyframe_name() {
                var e = this._tokenStream;
                return e.mustMatch([m.IDENT, m.STRING]), s.fromToken(e.token());
              },
              ...
              _key: function _key() {
                var e = this._tokenStream,
                    t;
                if (e.match(m.PERCENTAGE)) return s.fromToken(e.token());

                if (e.match(m.IDENT)) {
                  t = e.token();
                  if (/from|to/i.test(t.value)) return s.fromToken(t);
                  e.unget();
                }
              ...
              _skipCruft: function _skipCruft() {
                while (this._tokenStream.match([m.S, m.CDO, m.CDC])) {
                  ;
                }
              },
              _readDeclarations: function _readDeclarations(e, t) {
                var n = this._tokenStream,
                    r;
                this._readWhitespace(), e && n.mustMatch(m.LBRACE), this._readWhitespace();

                try {
                  for (;;) {
                    if (!(n.match(m.SEMICOLON) || t && this._margin())) {
                      if (!this._declaration()) break;
                      if (!n.match(m.SEMICOLON)) break;
                    }
                  ...
                  this.fire({
                    ...
                    line: s.line,
                    col: s.col
                  }), r = n.advance([m.SEMICOLON, m.RBRACE]);
                  if (r === m.SEMICOLON) this._readDeclarations(!1, t);else if (r !== m.EOF && r !== m.RBRACE) throw s;
                }
              },
              ...
              parsePropertyValue: function parsePropertyValue(e) {
                this._tokenStream = new v(e, m), this._readWhitespace();
              ...
              parseStyleAttribute: function parseStyleAttribute(e) {
                e += "}", this._tokenStream = new v(e, m), this._readDeclarations();
              }
            };
        ...
        8: [function (e, t, n) {
          ...
          function s(e, t, n, s) {
            r.call(this, e, n, s, i.PROPERTY_NAME_TYPE), this.hack = t;
          }

          t.exports = s;
          var r = e("../util/SyntaxUnit"),
              i = e("./Parser");
          s.prototype = new r(), s.prototype.constructor = s, s.prototype.toString = function () {
        ...
        10: [function (e, t, n) {
          ...
          t.exports = r, r.prototype.count = function () {
        ...
        11: [function (e, t, n) {
          ...
          function u(e, t, n, o) {
            var a = o || {};
            r.call(this, e, t, n, s.PROPERTY_VALUE_PART_TYPE), this.type = "unknown";
            var f;
            ...
            } else /^([+-]?[\d.]+)%$/i.test(e) ? (this.type = "percentage", this.value = Number(RegExp.$1)) : /^([+-]?\d+)$/i.test(e) ? (this.type = "integer", this.value = Number(RegExp.$1)) : /^([+-]?[\d.]+)$/i.test(e) ? (this.type = "number", this.value = Number(RegExp.$1)) : /^#([a-f0-9]{3,6})/i.test(e) ? (this.type = "color", f = RegExp.$1, f.length === 3 ? (this.red = parseInt(f.charAt(0) + f.charAt(0), 16), this.green = parseInt(f.charAt(1) + f.charAt(1), 16), this.blue = parseInt(f.charAt(2) + f.charAt(2), 16)) : (this.red = parseInt(f.substring(0, 2), 16), this.green = parseInt(f.substring(2, 4), 16), this.blue = parseInt(f.substring(4, 6), 16))) : /^rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i.test(e) ? (this.type = "color", this.red = Number(RegExp.$1), this.green = Number(RegExp.$2), this.blue = Number(RegExp.$3)) : /^rgb\(\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(e) ? (this.type = "color", this.red = Number(RegExp.$1) * 255 / 100, this.green = Number(RegExp.$2) * 255 / 100, this.blue = Number(RegExp.$3) * 255 / 100) : /^rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\s*\)/i.test(e) ? (this.type = "color", this.red = Number(RegExp.$1), this.green = Number(RegExp.$2), this.blue = Number(RegExp.$3), this.alpha = Number(RegExp.$4)) : /^rgba\(\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(\d+)%\s*,\s*([\d.]+)\s*\)/i.test(e) ? (this.type = "color", this.red = Number(RegExp.$1) * 255 / 100, this.green = Number(RegExp.$2) * 255 / 100, this.blue = Number(RegExp.$3) * 255 / 100, this.alpha = Number(RegExp.$4)) : /^hsl\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(e) ? (this.type = "color", this.hue = Number(RegExp.$1), this.saturation = Number(RegExp.$2) / 100, this.lightness = Number(RegExp.$3) / 100) : /^hsla\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*,\s*([\d.]+)\s*\)/i.test(e) ? (this.type = "color", this.hue = Number(RegExp.$1), this.saturation = Number(RegExp.$2) / 100, this.lightness = Number(RegExp.$3) / 100, this.alpha = Number(RegExp.$4)) : /^url\(("([^\\"]|\.)*")\)/i.test(e) ? (this.type = "uri", this.uri = u.parseString(RegExp.$1)) : /^([^(]+)\(/i.test(e) ? (this.type = "function", this.name = RegExp.$1, this.value = e) : /^"([^\n\r\f\\"]|\\\r\n|\\[^\r0-9a-f]|\\[0-9a-f]{1,6}(\r\n|[ \n\r\t\f])?)*"/i.test(e) ? (this.type = "string", this.value = u.parseString(e)) : /^'([^\n\r\f\\']|\\\r\n|\\[^\r0-9a-f]|\\[0-9a-f]{1,6}(\r\n|[ \n\r\t\f])?)*'/i.test(e) ? (this.type = "string", this.value = u.parseString(e)) : i[e.toLowerCase()] ? (this.type = "color", f = i[e.toLowerCase()].substring(1), this.red = parseInt(f.substring(0, 2), 16), this.green = parseInt(f.substring(2, 4), 16), this.blue = parseInt(f.substring(4, 6), 16)) : /^[,/]$/.test(e) ? (this.type = "operator", this.value = e) : /^-?[a-z_\u00A0-\uFFFF][a-z0-9\-_\u00A0-\uFFFF]*$/i.test(e) && (this.type = "identifier", this.value = e);
          ...
          var r = e("../util/SyntaxUnit"),
              ...
              s = e("./Parser"),
              o = e("./Tokens");
          u.prototype = new r(), u.prototype.constructor = u, u.parseString = function (e) {
            e = e.slice(1, -1);

            var t = function t(e, _t) {
              if (/^(\n|\r\n|\r|\f)$/.test(_t)) return "";
              var n = /^[0-9a-f]{1,6}/i.exec(_t);
            ...
            return e.replace(/\\(\r\n|[^\r0-9a-f]|[0-9a-f]{1,6}(\r\n|[ \n\r\t\f])?)/ig, t);
          }, u.serializeString = function (e) {
            var t = function t(e, _t2) {
              if (_t2 === '"') return "\\" + _t2;
              var n = String.codePointAt ? String.codePointAt(0) : String.charCodeAt(0);
              return "\\" + n.toString(16) + " ";
            };

            return '"' + e.replace(/["\r\n\f]/g, t) + '"';
          }, u.fromToken = function (e) {
            var t = new u(e.value, e.startLine, e.startCol, {
              ident: e.type === o.IDENT
            });
            return t;
          };
        }, {
        ...
        12: [function (e, t, n) {
          ...
          r.ELEMENT = 1, r.CLASS = 2, r.isElement = function (e) {
            return e.indexOf("::") === 0 || r[e.toLowerCase()] === r.ELEMENT;
          };
        }, {}],
        13: [function (e, t, n) {
          "use strict";
          ...
          function o(e, t, n) {
            r.call(this, e.join(" "), t, n, i.SELECTOR_TYPE), this.parts = e, this.specificity = s.calculate(this);
          }
        ...
        14: [function (e, t, n) {
          ...
          function s(e, t, n, s, o) {
            r.call(this, n, s, o, i.SELECTOR_PART_TYPE), this.elementName = e, this.modifiers = t;
          }
        ...
        15: [function (e, t, n) {
          ...
          function s(e, t, n, s) {
            r.call(this, e, n, s, i.SELECTOR_SUB_PART_TYPE), this.type = t, this.args = [];
          }
        ...
        16: [function (e, t, n) {
          ...
          s.prototype = {
          ...
          }, s.calculate = function (e) {
            function l(e) {
              var t,
                  n,
                  i,
                  s,
                  o = e.elementName ? e.elementName.text : "",
                  h;
              o && o.charAt(o.length - 1) !== "*" && f++;

              for (t = 0, i = e.modifiers.length; t < i; t++) {
                h = e.modifiers[t];
            ...
            for (t = 0, n = e.parts.length; t < n; t++) {
              o = e.parts[t], o instanceof i && l(o);
            }

            return new s(0, u, a, f);
          };
        }, {
          "./Pseudos": 12,
          "./SelectorPart": 14
        ...
        17: [function (e, t, n) {
          ...
          function h(e) {
            return e != null && f.test(e);
          }

          function p(e) {
            return e != null && a.test(e);
          }
          ...
          function v(e) {
            return e != null && (d(e) || /[0-9\-\\]/.test(e));
          }

          function m(e) {
            return e != null && (d(e) || /-\\/.test(e));
          }
          ...
          function y(e) {
            return typeof e == "string" && (e[0] === "-" && d(e[1]) || d(e[0]));
          }

          function b(e) {
            return typeof e == "string" && (c(e[0]) || e[0] === "." && c(e[1]));
          }
          ...
          w.prototype = g(new r(), {
            _getToken: function _getToken() {
              ...
              while (e) {
                switch (e) {
                  ...
                  default:
                    n = this._getDefaultToken(e, r, i);
                }

                break;
              }

              return !n && e === null && (n = this.createToken(s.EOF, null, r, i)), n;
            },
            _getDefaultToken: function _getDefaultToken(e, t, n) {
              var r = this._reader,
                  i = null;
              return c(e) ? i = this.numberToken(e, t, n) : h(e) ? i = this.whitespaceToken(e, t, n) : y(e + r.peekCount(1)) ? i = this.identOrFunctionToken(e, t, n) : i = this.charToken(e, t, n), i;
            },
            ...
            atRuleToken: function atRuleToken(e, t, n) {
              var r = e,
                  ...
                  o = s.CHAR,
                  u;
              i.mark(), u = this.readName(), r = e + u, o = s.type(r.toLowerCase());
              if (o === s.CHAR || o === s.UNKNOWN) r.length > 1 ? o = s.UNKNOWN_SYM : (o = s.CHAR, r = e, i.reset());
              return this.createToken(o, r, t, n);
            },
            charToken: function charToken(e, t, n) {
              var r = s.type(e),
                  i = {};
              return r === -1 ? r = s.CHAR : i.endChar = s[r].endChar, this.createToken(r, e, t, n, i);
            },
            commentToken: function commentToken(e, t, n) {
              var r = this.readComment(e);
              return this.createToken(s.COMMENT, r, t, n);
            },
            comparisonToken: function comparisonToken(e, t, n) {
              var r = this._reader,
                  i = e + r.read(),
                  o = s.type(i) || s.CHAR;
              return this.createToken(o, i, t, n);
            },
            hashToken: function hashToken(e, t, n) {
              var r = this.readName(e);
              return this.createToken(s.HASH, r, t, n);
            },
            htmlCommentStartToken: function htmlCommentStartToken(e, t, n) {
              var r = this._reader,
                  i = e;
              return r.mark(), i += r.readCount(3), i === "<!--" ? this.createToken(s.CDO, i, t, n) : (r.reset(), this.charToken(e, t, n));
            },
            htmlCommentEndToken: function htmlCommentEndToken(e, t, n) {
              var r = this._reader,
                  i = e;
              return r.mark(), i += r.readCount(2), i === "-->" ? this.createToken(s.CDC, i, t, n) : (r.reset(), this.charToken(e, t, n));
            },
            identOrFunctionToken: function identOrFunctionToken(e, t, n) {
              var r = this._reader,
                  i = this.readName(e),
                  o = s.IDENT,
                  u = ["url(", "url-prefix(", "domain("],
                  a;
              return r.peek() === "(" ? (i += r.read(), u.indexOf(i.toLowerCase()) > -1 ? (r.mark(), a = this.readURI(i), a === null ? (r.reset(), o = s.FUNCTION) : (o = s.URI, i = a)) : o = s.FUNCTION) : r.peek() === ":" && i.toLowerCase() === "progid" && (i += r.readTo("("), o = s.IE_FUNCTION), this.createToken(o, i, t, n);
            },
            ...
            notToken: function notToken(e, t, n) {
              var r = this._reader,
                  i = e;
              return r.mark(), i += r.readCount(4), i.toLowerCase() === ":not(" ? this.createToken(s.NOT, i, t, n) : (r.reset(), this.charToken(e, t, n));
            },
            numberToken: function numberToken(e, t, n) {
              var r = this._reader,
                  ...
                  u = s.NUMBER,
                  a = r.peek();
              return m(a) ? (o = this.readName(r.read()), i += o, /^em$|^ex$|^px$|^gd$|^rem$|^vw$|^vh$|^fr$|^vmax$|^vmin$|^ch$|^cm$|^mm$|^in$|^pt$|^pc$/i.test(o) ? u = s.LENGTH : /^deg|^rad$|^grad$|^turn$/i.test(o) ? u = s.ANGLE : /^ms$|^s$/i.test(o) ? u = s.TIME : /^hz$|^khz$/i.test(o) ? u = s.FREQ : /^dpi$|^dpcm$/i.test(o) ? u = s.RESOLUTION : u = s.DIMENSION) : a === "%" && (i += r.read(), u = s.PERCENTAGE), this.createToken(u, i, t, n);
            },
            stringToken: function stringToken(e, t, n) {
              ...
              return a === null && (u = s.INVALID), this.createToken(u, i, t, n);
            },
            unicodeRangeToken: function unicodeRangeToken(e, t, n) {
              var r = this._reader,
                  ...
                  o,
                  u = s.CHAR;
              return r.peek() === "+" && (r.mark(), i += r.read(), i += this.readUnicodeRangePart(!0), i.length === 2 ? r.reset() : (u = s.UNICODE_RANGE, i.indexOf("?") === -1 && r.peek() === "-" && (r.mark(), o = r.read(), o += this.readUnicodeRangePart(!1), o.length === 1 ? r.reset() : i += o))), this.createToken(u, i, t, n);
            },
            whitespaceToken: function whitespaceToken(e, t, n) {
              var r = e + this.readWhitespace();
              return this.createToken(s.S, r, t, n);
            },
            ...
            readString: function readString() {
              ...
              return e.type === s.INVALID ? null : e.value;
            },
            readURI: function readURI(e) {
              ...
              s === "'" || s === '"' ? (r = this.readString(), r !== null && (r = i.parseString(r))) : r = this.readUnquotedURL(), s = t.peek();

              while (s && h(s)) {
                t.read(), s = t.peek();
              }

              return r === null || s !== ")" ? n = null : n += i.serializeString(r) + t.read(), n;
            },
            readUnquotedURL: function readUnquotedURL(e) {
              var t = this._reader,
                  n = e || "",
                  r;

              for (r = t.peek(); r; r = t.peek()) {
                if (u.test(r) || /^[-!#$%&*-[\]-~]$/.test(r)) n += r, t.read();else {
                  if (r !== "\\") break;
            ...
            readEscape: function readEscape(e, t) {
              var n = this._reader,
                  r = e || "",
                  i = 0,
                  s = n.peek();
              ...
              if (r.length === 1) {
                if (!/^[^\r\n\f0-9a-f]$/.test(s)) throw new Error("Bad escape sequence.");
                n.read();
                if (t) return s;
              } else s === "\r" ? (n.read(), n.peek() === "\n" && (s += n.read())) : /^[ \t\n\f]$/.test(s) ? n.read() : s = "";
        ...
        18: [function (e, t, n) {
          ...
          (function () {
            ...
            for (var n = 0, i = r.length; n < i; n++) {
              ...
              if (r[n].text) if (r[n].text instanceof Array) for (var s = 0; s < r[n].text.length; s++) {
                t[r[n].text[s]] = n;
              } else t[r[n].text] = n;
            }
        ...
        19: [function (e, t, n) {
          ...
          var r = e("./Matcher"),
            ...
            validate: function validate(e, t) {
              ...
              if (!a) {
                if (n.indexOf("-") !== 0) throw new o("Unknown property '" + e + "'.", e.line, e.col);
              } else if (typeof a != "number") {
                if (s.isAny(r, "inherit | initial | unset")) {
                  if (r.hasNext()) throw f = r.next(), new o("Expected end of value but found '" + f + "'.", f.line, f.col);
                  return;
                }
            ...
            singleProperty: function singleProperty(e, t) {
              var n = !1,
                  i = t.value,
                  u;
              n = r.parse(e).match(t);
              if (!n) throw t.hasNext() && !t.isFirst() ? (u = t.peek(), new o("Expected end of value but found '" + u + "'.", u.line, u.col)) : new o("Expected (" + s.describe(e) + ") but found '" + i + "'.", i.line, i.col);
              if (t.hasNext()) throw u = t.next(), new o("Expected end of value but found '" + u + "'.", u.line, u.col);
            }
          };
        }, {
          "./Matcher": 3,
        ...
        21: [function (e, t, n) {
          ...
          s(r, {
            isLiteral: function isLiteral(e, t) {
              ...
              for (i = 0, s = r.length; i < s && !o; i++) {
                r[i].charAt(0) === "<" ? o = this.simple[r[i]](e) : r[i].slice(-2) === "()" ? o = e.type === "function" && e.name === r[i].slice(0, -2) : n === r[i].toLowerCase() && (o = !0);
              }
            ...
            describe: function describe(e) {
              return this.complex[e] instanceof i ? this.complex[e].toString(0) : e;
            },
            ...
            isType: function isType(e, t) {
              var n = e.peek(),
                  r = !1;
              return t.charAt(0) !== "<" ? (r = this.isLiteral(n, t), r && e.next()) : this.simple[t] ? (r = this.simple[t](n), r && e.next()) : this.complex[t] instanceof i ? r = this.complex[t].match(e) : r = this.complex[t](e), r;
            },
            simple: {
              __proto__: null,
              "<absolute-size>": "xx-small | x-small | small | medium | large | x-large | xx-large",
              "<animateable-feature>": "scroll-position | contents | <animateable-feature-name>",
              "<animateable-feature-name>": function animateableFeatureName(e) {
              ...
              "<color>": function color(e) {
                return e.type === "color" || String(e) === "transparent" || String(e) === "currentColor";
              },
              "<color-svg>": function colorSvg(e) {
                return e.type === "color";
              },
              "<content>": "content()",
              ...
              "<feature-tag-value>": function featureTagValue(e) {
                return e.type === "function" && /^[A-Z0-9]{4}$/i.test(e);
              },
              ...
              "<glyph-angle>": function glyphAngle(e) {
                return e.type === "angle" && e.units === "deg";
              },
              ...
              "<ident>": function ident(e) {
                return e.type === "identifier" || e.wasIdent;
              },
              "<ident-not-generic-family>": function identNotGenericFamily(e) {
              ...
              "<length>": function length(e) {
                return e.type === "function" && /^(?:-(?:ms|moz|o|webkit)-)?calc/i.test(e) ? !0 : e.type === "length" || e.type === "number" || e.type === "integer" || String(e) === "0";
              },
              ...
              "<miterlimit>": function miterlimit(e) {
                return this["<number>"](e) && e.value >= 1;
              },
              "<nonnegative-length-or-percentage>": function nonnegativeLengthOrPercentage(e) {
                return (this["<length>"](e) || this["<percentage>"](e)) && (String(e) === "0" || e.type === "function" || e.value >= 0);
              },
              "<nonnegative-number-or-percentage>": function nonnegativeNumberOrPercentage(e) {
                return (this["<number>"](e) || this["<percentage>"](e)) && (String(e) === "0" || e.type === "function" || e.value >= 0);
              },
              "<number>": function number(e) {
                return e.type === "number" || this["<integer>"](e);
              },
              "<opacity-value>": function opacityValue(e) {
                return this["<number>"](e) && e.value >= 0 && e.value <= 1;
              },
              "<padding-width>": "<nonnegative-length-or-percentage>",
              "<percentage>": function percentage(e) {
                return e.type === "percentage" || String(e) === "0";
              },
              "<relative-size>": "smaller | larger",
              "<shape>": "rect() | inset-rect()",
              "<shape-box>": "<box> | margin-box",
              "<single-animation-direction>": "normal | reverse | alternate | alternate-reverse",
              "<single-animation-name>": function singleAnimationName(e) {
            ...
            complex: {
              ...
              "<border-image-slice>": i.many([!0], i.cast("<nonnegative-number-or-percentage>"), i.cast("<nonnegative-number-or-percentage>"), i.cast("<nonnegative-number-or-percentage>"), i.cast("<nonnegative-number-or-percentage>"), "fill"),
              "<border-radius>": "<nonnegative-length-or-percentage>{1,4} [ / <nonnegative-length-or-percentage>{1,4} ]?",
              "<box-shadow>": "none | <shadow>#",
              "<clip-path>": "<basic-shape> || <geometry-box>",
              "<dasharray>": i.cast("<nonnegative-length-or-percentage>").braces(1, Infinity, "#", i.cast(",").question()),
              ...
              "<shadow>": i.many([!0], i.cast("<length>").braces(2, 4), "inset", "<color>"),
          ...
          }), Object.keys(r.simple).forEach(function (e) {
            var t = r.simple[e];
            typeof t == "string" && (r.simple[e] = function (e) {
              return r.isLiteral(e, t);
            });
          }), Object.keys(r.complex).forEach(function (e) {
            var t = r.complex[e];
            typeof t == "string" && (r.complex[e] = i.parse(t));
          }), r.complex["<font-variant>"] = i.oror({
        ...
        24: [function (e, t, n) {
          ...
          t.exports = r, r.prototype = {
            ...
            peekCount: function peekCount(e) {
              return e = typeof e == "undefined" ? 1 : Math.max(e, 0), this._input.substring(this._cursor, this._cursor + e);
            },
            ...
            readMatch: function readMatch(e) {
              ...
              return typeof e == "string" ? t.slice(0, e.length) === e && (n = this.readCount(e.length)) : e instanceof RegExp && e.test(t) && (n = this.readCount(RegExp.lastMatch.length)), n;
            },
        ...
        26: [function (e, t, n) {
          ...
          t.exports = r, r.fromToken = function (e) {
        ...
        27: [function (e, t, n) {
          ...
          s.createTokenData = function (e) {
            ...
            mustMatch: function mustMatch(e) {
              var t;
              e instanceof Array || (e = [e]);
              if (!this.match.apply(this, arguments)) throw t = this.LT(1), new i("Expected " + this._tokenData[e[0]].name + " at line " + t.startLine + ", col " + t.startCol + ".", t.startLine, t.startCol);
            },
            ...
            get: function get(e) {
              ...
              if (this._lt.length && this._ltIndex >= 0 && this._ltIndex < this._lt.length) {
                ...
                if ((typeof i.channel == "undefined" || e === i.channel) && this._ltIndex <= this._lt.length) return this._ltIndexCache.push(n), this._token.type;
              }
      ...
      function s(n, o, u, a, f) {
        function d(n, u) {
          if (n === null) return null;
          if (u === 0) return n;
          var v, m;
          if (_typeof(n) != "object") return n;
          if (e(n, t)) v = new t();else if (e(n, r)) v = new r();else if (e(n, i)) v = new i(function (e, t) {
            n.then(function (t) {
              e(d(t, u - 1));
            }, function (e) {
              t(d(e, u - 1));
            });
          });else if (s.__isArray(n)) v = [];else if (s.__isRegExp(n)) v = new RegExp(n.source, l(n)), n.lastIndex && (v.lastIndex = n.lastIndex);else if (s.__isDate(n)) v = new Date(n.getTime());else {
            if (p && Buffer.isBuffer(n)) return Buffer.allocUnsafe ? v = Buffer.allocUnsafe(n.length) : v = new Buffer(n.length), n.copy(v), v;
          ...
          e(n, t) && n.forEach(function (e, t) {
            var n = d(t, u - 1),
                r = d(e, u - 1);
            v.set(n, r);
          }), e(n, r) && n.forEach(function (e) {
            var t = d(e, u - 1);
            v.add(t);
          });
          ...
          if (Object.getOwnPropertySymbols) {
            ...
            for (var y = 0; y < w.length; y++) {
              ...
              if (S && !S.enumerable && !f) continue;
              v[E] = d(n[E], u - 1), S.enumerable || Object.defineProperty(v, E, {
                enumerable: !1
              });
            }
          }
          ...
          if (f) {
            ...
            for (var y = 0; y < x.length; y++) {
              ...
              if (S && S.enumerable) continue;
              v[T] = d(n[T], u - 1), Object.defineProperty(v, T, {
                enumerable: !1
              });
            }
          }
        ...
        _typeof(o) == "object" && (u = o.depth, a = o.prototype, f = o.includeNonEnumerable, o = o.circular);
        var c = [],
            h = [],
            p = typeof Buffer != "undefined";
        return typeof o == "undefined" && (o = !0), typeof u == "undefined" && (u = Infinity), d(n, u);
      }
      ...
      function u(e) {
        return _typeof(e) == "object" && o(e) === "[object Date]";
      }

      function a(e) {
        return _typeof(e) == "object" && o(e) === "[object Array]";
      }

      function f(e) {
        return _typeof(e) == "object" && o(e) === "[object RegExp]";
      }
      ...
      }, s.__objToStr = o, s.__isDate = u, s.__isArray = a, s.__isRegExp = f, s.__getRegExpFlags = l, s;
    }();

    _typeof(e) == "object" && e.exports && (e.exports = r);
    ...
    var i = function () {
      ...
      function a(e, t) {
        ...
        return i && (n = {
          ...
          1: 1,
          0: 0
        }, i.toLowerCase().split(",").forEach(function (e) {
          var r = e.split(":"),
              i = r[0] || "",
              s = r[1] || "";
          t[i.trim()] = n[s.trim()];
      ...
      var e = [],
          t = [],
          o = /\/\*\s*csslint([^\*]*)\*\//,
          u = new n.util.EventTarget();
      return u.version = "1.0.5", u.addRule = function (t) {
        e.push(t), e[t.id] = t;
      }, u.clearRules = function () {
        e = [];
      }, u.getRules = function () {
        return [].concat(e).sort(function (e, t) {
          return e.id > t.id ? 1 : 0;
        });
      }, u.getRuleset = function () {
        var t = {},
            n = 0,
            r = e.length;
        ...
        return t;
      }, u.addFormatter = function (e) {
        t[e.id] = e;
      }, u.getFormatter = function (e) {
        return t[e];
      }, u.format = function (e, t, n, r) {
        var i = u.getFormatter(n),
            s = null;
        return i && (s = i.startFormat(), s += i.formatResults(e, t, r || {}), s += i.endFormat()), s;
      }, u.hasFormat = function (e) {
        return t.hasOwnProperty(e);
      }, u.verify = function (t, f) {
        var l = 0,
            c,
            h,
            p = {},
        ...
        h = t.replace(/\n\r?/g, "$split$").split("$split$"), i.Util.forEach(h, function (e, t) {
          var n = e && e.match(/\/\*[ \t]*csslint[ \t]+allow:[ \t]*([^\*]*)\*\//i),
              r = n && n[1],
              i = {};
          r && (r.toLowerCase().split(",").forEach(function (e) {
            i[e.trim()] = !0;
        ...
        i.Util.forEach(h, function (e, t) {
          g === null && e.match(/\/\*[ \t]*csslint[ \t]+ignore:start[ \t]*\*\//i) && (g = t), e.match(/\/\*[ \t]*csslint[ \t]+ignore:end[ \t]*\*\//i) && (y = t), g !== null && y !== null && (d.push([g, y]), g = y = null);
        }), g !== null && d.push([g, h.length]), f || (f = u.getRuleset()), o.test(t) && (f = r(f), f = a(t, f)), c = new s(h, f, p, d), f.errors = 2;

        for (l in f) {
          f.hasOwnProperty(l) && f[l] && e[l] && e[l].init(m, c);
        }
    ...
    return s.prototype = {
      ...
      report: function report(e, t, n, r) {
        ...
        if (this.allow.hasOwnProperty(t) && this.allow[t].hasOwnProperty(r.id)) return;
        if (this.isIgnored(t)) return;
        this.messages.push({
      ...
      isIgnored: function isIgnored(e) {
        "use strict";

        var t = !1;
        return i.Util.forEach(this.ignore, function (n) {
          n[0] <= e && e <= n[1] && (t = !0);
        }), t;
      }
    }, i._Reporter = s, i.Util = {
      ...
      init: function init(e, t) {
        ...
        var n = this,
          ...
          "padding-top": 1
            ...
            s,
            o = !1;
        e.addListener("startrule", u), e.addListener("startfontface", u), e.addListener("startpage", u), e.addListener("startpagemargin", u), e.addListener("startkeyframerule", u), e.addListener("startviewport", u), e.addListener("property", function (e) {
          var t = e.property.text.toLowerCase();
          i[t] || r[t] ? !/^0\S*$/.test(e.value) && (t !== "border" || e.value.toString() !== "none") && (s[t] = {
            line: e.property.line,
            col: e.property.col,
            value: e.value
          }) : /^(width|height)/i.test(t) && /^(length|percentage)/.test(e.value.parts[0].type) ? s[t] = 1 : t === "box-sizing" && (o = !0);
        }), e.addListener("endrule", a), e.addListener("endfontface", a), e.addListener("endpage", a), e.addListener("endpagemargin", a), e.addListener("endkeyframerule", a), e.addListener("endviewport", a);
      }
    }), i.addRule({
      ...
      init: function init(e, t) {
        ...
        e.addListener("startrule", function () {
          ...
          var t = e.property;
          i.Util.indexOf(p, t.text) > -1 && (!c || typeof c != "string" || t.text.indexOf("-" + c + "-") !== 0) && s.push(t);
          ...
          for (o = 0, u = s.length; o < u; o++) {
            ...
            for (f in r) {
              r.hasOwnProperty(f) && (l = r[f], i.Util.indexOf(l, a.text) > -1 && (e[f] || (e[f] = {
                full: l.slice(0),
                actual: [],
                actualNodes: []
              }), i.Util.indexOf(e[f].actual, a.text) === -1 && (e[f].actual.push(a.text), e[f].actualNodes.push(a))));
            }
          }
      ...
      init: function init(e, t) {
        ...
        var n = this,
          ...
          "vertical-align": 1
            ...
            i;
        e.addListener("startrule", o), e.addListener("startfontface", o), e.addListener("startkeyframerule", o), e.addListener("startpagemargin", o), e.addListener("startpage", o), e.addListener("startviewport", o), e.addListener("property", function (e) {
          var t = e.property.text.toLowerCase();
          r[t] && (i[t] = {
            value: e.value.text,
            line: e.property.line,
        ...
        }), e.addListener("endrule", u), e.addListener("endfontface", u), e.addListener("endkeyframerule", u), e.addListener("endpagemargin", u), e.addListener("endpage", u), e.addListener("endviewport", u);
      }
    }), i.addRule({
      ...
      init: function init(e, t) {
        ...
        var n = this,
            r = 0;
        e.addListener("property", function (e) {
          t.isIgnored(e.property.line) || e.property.text.toLowerCase() === "float" && e.value.text.toLowerCase() !== "none" && r++;
      ...
      init: function init(e, t) {
        ...
        var n = this,
            r = 0;
        e.addListener("property", function (e) {
          t.isIgnored(e.property.line) || e.property.toString() === "font-size" && r++;
        }), e.addListener("endstylesheet", function () {
      ...
      init: function init(e, t) {
        ...
        var n = this,
            r = 31,
            i = 0;
        e.addListener("startpage", s), e.addListener("import", function () {
          i++;
        }), e.addListener("endstylesheet", function () {
          i > r && t.rollupError("Too many @import rules (" + i + "). IE6-9 supports up to 31 import per stylesheet.", n);
        });
      }
    }), i.addRule({
      id: "import",
      ...
      init: function init(e, t) {
        ...
        var n = this,
            r = 0;
        e.addListener("property", function (e) {
          t.isIgnored(e.line) || e.important === !0 && (r++, t.report("Use of !important", e.line, e.col, n));
        }), e.addListener("endstylesheet", function () {
      ...
      init: function init(e, t) {
        ...
        var n = this,
          ...
          var i = r.join(","),
              s = r.sort().join(",");
          i !== s && t.report("Rule doesn't have all its properties in alphabetical order.", e.line, e.col, n);
        };
      ...
      init: function init(e, t) {
        ...
        for (r in a) {
          if (a.hasOwnProperty(r)) for (i = 0, s = a[r].length; i < s; i++) {
            o[a[r][i]] = r;
          }
        }
        ...
        e.addListener("startrule", function (r) {
          ...
          for (f = 0; f < i.length; f++) {
            ...
            if (u.type === e.SELECTOR_PART_TYPE) {
              ...
              if (!s) for (l = 0; l < u.modifiers.length; l++) {
      ...
      i.addFormatter({
        ...
        formatResults: function formatResults(t, n) {
          var r = t.messages,
              s = [],
              o = function o(e) {
          ...
          return r.length > 0 && (s.push('<file name="' + n + '">'), i.Util.forEach(r, function (t) {
      ...
      formatResults: function formatResults(e, t, n) {
        ...
        return r.length === 0 ? n.quiet ? "" : t + ": Lint Free!" : (i.Util.forEach(r, function (e) {
          e.rollup ? s += t + ": " + o(e.type) + " - " + e.message + " (" + e.rule.id + ")\n" : s += t + ": line " + e.line + ", col " + e.col + ", " + o(e.type) + " - " + e.message + " (" + e.rule.id + ")\n";
        }), s);
      }
    }), i.addFormatter({
      id: "csslint-xml",
      ...
      formatResults: function formatResults(e, t) {
        "use strict";
        ...
        return n.length > 0 && (r.push('<file name="' + t + '">'), i.Util.forEach(n, function (e) {
          e.rollup ? r.push('<issue severity="' + e.type + '" reason="' + s(e.message) + '" evidence="' + s(e.evidence) + '"/>') : r.push('<issue line="' + e.line + '" char="' + e.col + '" severity="' + e.type + '"' + ' reason="' + s(e.message) + '" evidence="' + s(e.evidence) + '"/>');
        }), r.push("</file>")), r.join("");
      }
    }), i.addFormatter({
      id: "json",
      ...
      formatResults: function formatResults(e, t, n) {
        ...
        return (e.messages.length > 0 || !n.quiet) && this.json.push({
          filename: t,
          messages: e.messages,
          stats: e.stats
        }), "";
      ...
      formatResults: function formatResults(e, t) {
        ...
        return n.length > 0 && (r.push('<file name="' + t + '">'), i.Util.forEach(n, function (e) {
          if (e.rollup) r.push('<issue severity="' + e.type + '" reason="' + s(e.message) + '" evidence="' + s(e.evidence) + '"/>');else {
            var t = "";
      ...
      formatResults: function formatResults(e, t, n) {
        ...
        var o = t.lastIndexOf("/"),
            u = t;
        return o === -1 && (o = t.lastIndexOf("\\")), o > -1 && (u = t.substring(o + 1)), i.Util.forEach(r, function (e, t) {
  ...
  var r = e("../lib/oop"),
    ...
    s.call(this, e), this.setTimeout(400), this.ruleset = null, this.setDisabledRules("ids|order-alphabetical"), this.setInfoRules("adjoining-classes|zero-units|gradients|box-model|import|outline-none|vendor-prefix");
  };
