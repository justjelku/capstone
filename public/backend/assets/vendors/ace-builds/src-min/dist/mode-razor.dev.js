...
define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
...
}), define("ace/mode/razor_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/doc_comment_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/csharp_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
    ...
    this.$rules.start.unshift({
      regex: "[\\[({]",
      onMatch: function onMatch(e, n, r) {
    ...
    this.$rules[t] = i.deepCopy(this.$rules.start), this.$rules[t].unshift({
      regex: "[\\])}]",
      onMatch: function onMatch(t, r, i) {
        var s = i[1];
...
}), define("ace/mode/razor_completions", ["require", "exports", "module", "ace/token_iterator"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/razor", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/razor_highlight_rules", "ace/mode/razor_completions", "ace/mode/html_completions"], function (e, t, n) {
  "use strict";
