...
define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
...
}), define("ace/mode/sjs_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript_highlight_rules", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
    ...
    this.$rules.string_interp = [s({
      ...
      token: "identifier",
      regex: "\\w*"
    })], this.$rules.bstring_interp_single_call = [r({
      token: "paren.lparen",
      regex: "\\(",
      next: "bstring_interp_single_call"
    }), s({
...
}), define("ace/mode/sjs", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/sjs_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";
