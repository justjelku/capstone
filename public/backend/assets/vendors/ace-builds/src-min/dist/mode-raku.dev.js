...
define("ace/mode/raku_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  var r = e("../lib/oop"),
    ...
    var e = "my|our|class|role|grammar|is|does|sub|method|submethod|try|default|when|if|elsif|else|unless|with|orwith|without|for|given|proceed|succeed|loop|while|until|repeat|module|use|need|import|require|unit|constant|enum|multi|return|has|token|rule|make|made|proto|state|augment|but|anon|supersede|let|subset|gather|returns|return-rw|temp|BEGIN|CHECK|INIT|END|CLOSE|ENTER|LEAVE|KEEP|UNDO|PRE|POST|FIRST|NEXT|LAST|CATCH|CONTROL|QUIT|DOC",
        ...
        r = "pi|Inf|tau|time",
        i = "eq|ne|gt|lt|le|ge|div|gcd|lcm|leg|cmp|ff|fff|x|before|after|Z|X|and|or|andthen|notandthen|orelse|xor",
    ...
    this.$rules = {
      ...
      qqinterpolation: [u, a, f, l, c, h, p, d, v, m, g, y, w, {
        token: "rparen",
        regex: "}",
        next: "qqstring"
      }],
      ...
      qqheredocinterpolation: [u, a, f, l, c, h, p, d, v, m, g, y, w, {
        token: "rparen",
        regex: "}",
        next: "qqheredoc"
      }]
  ...
  r.inherits(s, i), t.RakuHighlightRules = s;
...
}), define("ace/mode/raku", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/raku_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./raku_highlight_rules").RakuHighlightRules,
