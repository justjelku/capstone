...
}), define("ace/ext/options", ["require", "exports", "module", "ace/ext/menu_tools/overlay_page", "ace/lib/dom", "ace/lib/oop", "ace/config", "ace/lib/event_emitter", "ace/ext/modelist", "ace/ext/themelist"], function (e, t, n) {
  "use strict";
  ...
  (function () {
    i.implement(this, o), this.add = function (e) {
      ...
      this.container.innerHTML = "", u(["table", {
        role: "presentation",
        id: "controls"
      }, this.renderOptionGroup(h.Main), ["tr", null, ["td", {
        colspan: 2
      }, ["table", {
        role: "presentation",
        id: "more-controls"
      }, this.renderOptionGroup(h.More)]]], ["tr", null, ["td", {
        colspan: 2
      }, "version " + s.version]]], this.container);
      ...
      if (t.type == "buttonBar") r = ["div", {
        ...
        return ["button", {
          ...
          onclick: function onclick() {
            ...
            for (var i = 0; i < r.length; i++) {
              r[i].removeAttribute("ace_selected_button"), r[i].setAttribute("aria-pressed", !1);
            }
...
}), define("ace/ext/settings_menu", ["require", "exports", "module", "ace/ext/options", "ace/ext/menu_tools/overlay_page", "ace/editor"], function (e, t, n) {
  "use strict";
