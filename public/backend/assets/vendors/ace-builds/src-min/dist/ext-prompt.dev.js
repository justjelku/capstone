...
define("ace/ext/menu_tools/get_editor_keyboard_shortcuts", ["require", "exports", "module", "ace/lib/keys"], function (e, t, n) {
...
}), define("ace/snippets", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/range_list", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/clipboard", "ace/editor"], function (e, t, n) {
  "use strict";
  ...
  var r = e("./lib/dom"),
    ...
    BLOCK_COMMENT_START: function BLOCK_COMMENT_START(e) {
      var t = e.session.$mode || {};
      return t.blockComment && t.blockComment.start || "";
    },
    BLOCK_COMMENT_END: function BLOCK_COMMENT_END(e) {
      var t = e.session.$mode || {};
      return t.blockComment && t.blockComment.end || "";
    },
    LINE_COMMENT: function LINE_COMMENT(e) {
      var t = e.session.$mode || {};
      return t.lineCommentStart || "";
    },
    CURRENT_YEAR: p.bind(null, {
      year: "numeric"
    }),
    CURRENT_YEAR_SHORT: p.bind(null, {
      year: "2-digit"
    }),
    CURRENT_MONTH: p.bind(null, {
      month: "numeric"
    }),
    CURRENT_MONTH_NAME: p.bind(null, {
      month: "long"
    }),
    CURRENT_MONTH_NAME_SHORT: p.bind(null, {
      month: "short"
    }),
    CURRENT_DATE: p.bind(null, {
      day: "2-digit"
    }),
    CURRENT_DAY_NAME: p.bind(null, {
      weekday: "long"
    }),
    CURRENT_DAY_NAME_SHORT: p.bind(null, {
      weekday: "short"
    }),
    CURRENT_HOUR: p.bind(null, {
      hour: "2-digit",
      hour12: !1
    }),
    CURRENT_MINUTE: p.bind(null, {
      minute: "2-digit"
    }),
    CURRENT_SECOND: p.bind(null, {
      second: "2-digit"
    })
  };
  ...
  (function () {
    i.implement(this, s), this.getTokenizer = function () {
      ...
      return d.$tokenizer = new l({
        start: [{
          ...
          regex: /\$\{[\dA-Z_a-z]+/,
          onMatch: function onMatch(t, n, r) {
            var i = e(t.substr(1));
    ...
    }, this.variables = h, this.tmStrFormat = function (e, t, n) {
      if (!t.fmt) return e;
      var r = t.flag || "",
          i = t.guard;
      i = new RegExp(i, r.replace(/[^gim]/g, ""));
      var s = typeof t.fmt == "string" ? this.tokenizeTmSnippet(t.fmt, "formatString") : t.fmt,
          o = this,
      ...
      for (var l = 0; l < o.length; l++) {
        ...
        a[h] = c;
        var m = p.value;
        typeof m != "string" ? m = f(m) : c.fmt && (m = this.tmStrFormat(m, c, e)), o.splice.apply(o, [l + 1, Math.max(0, d - l)].concat(m, c)), p.indexOf(c) === -1 && p.push(c);
      }
      ...
      if (t === "html" || t === "php") {
        ...
        _typeof(r) == "object" && (r = r[0]), r.substring && (r.substring(0, 3) == "js-" ? t = "javascript" : r.substring(0, 4) == "css-" ? t = "css" : r.substring(0, 4) == "php-" && (t = "php"));
      }
      ...
      function u(e, t, n) {
        return e = s(e), t = s(t), n ? (e = t + e, e && e[e.length - 1] != "$" && (e += "$")) : (e += t, e && e[0] != "^" && (e = "^" + e)), new RegExp(e);
      }
      ...
      function a(e) {
        ...
        n[t].push(e), e.prefix && (e.tabTrigger = e.prefix), !e.content && e.body && (e.content = Array.isArray(e.body) ? e.body.join("\n") : e.body), e.tabTrigger && !e.trigger && (!e.guard && /^\w/.test(e.tabTrigger) && (e.guard = "\\b"), e.trigger = o.escapeRegExp(e.tabTrigger));
  ...
  var v = function v(e) {
    ...
    e.tabstopManager = this, this.$onChange = this.onChange.bind(this), this.$onChangeSelection = o.delayedCall(this.onChangeSelection.bind(this)).schedule, this.$onChangeSession = this.onChangeSession.bind(this), this.$onAfterExec = this.onAfterExec.bind(this), this.attach(e);
  };
  ...
  (function () {
    this.attach = function (e) {
      ...
      e.forEach(function (e, n) {
        ...
        for (var s = 0; s < e.length; s++) {
          ...
          m(c.start, t), m(c.end, t), c.original = l, c.tabstop = i, f.push(c), i != e ? i.unshift(c) : i[s] = c, l.fmtString || i.firstNonLinked && r ? (c.linked = !0, i.hasLinkedRanges = !0) : i.firstNonLinked || (i.firstNonLinked = c);
        }

        i.firstNonLinked || (i.hasLinkedRanges = !1), i === e && (o.push(i), this.$openTabstops[n] = i), this.addTabstopMarkers(i), i.rangeList = i.rangeList || new a(), i.rangeList.$bias = 0, i.rangeList.addList(i);
    ...
    }, this.keyboardHandler = new f(), this.keyboardHandler.bindKeys({
      Tab: function Tab(e) {
  ...
  r.importCssString(".ace_snippet-marker {    -moz-box-sizing: border-box;    box-sizing: border-box;    background: rgba(194, 193, 208, 0.09);    border: 1px dotted rgba(211, 208, 235, 0.62);    position: absolute;}", "snippets.css", !1), t.snippetManager = new d();
...
}), define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/lang", "ace/lib/dom", "ace/snippets", "ace/config"], function (e, t, n) {
  "use strict";
  ...
  (function () {
    this.$init = function () {
      ...
      if (e.completer && e.completer.insertMatch) e.completer.insertMatch(this.editor, e);else {
        ...
        if (n.filterText) {
          ...
          for (var i = 0, s; s = r[i]; i++) {
            s.start.column -= n.filterText.length, this.editor.session.remove(s);
          }
        }
      ...
      "Ctrl-Up|Ctrl-Home": function CtrlUpCtrlHome(e) {
        e.completer.goTo("start");
      },
      "Ctrl-Down|Ctrl-End": function CtrlDownCtrlEnd(e) {
      ...
      "Shift-Return": function ShiftReturn(e) {
      ...
      var i = this.gatherCompletionsId,
        ...
        var n = t.prefix,
            r = t.matches;
        this.completions = new c(r), this.exactMatch && (this.completions.exactMatch = !0), this.completions.setFilter(n);
        var i = this.completions.filtered;
        if (!i.length) return s(t);
        if (i.length == 1 && i[0].value == n && !i[0].snippet) return s(t);
        if (this.autoInsert && i.length == 1 && t.finished) return this.insertMatch(i[0]);
        this.openPopup(this.editor, n, e);
      }.bind(this),
          u = !0,
          a = null;

      this.gatherCompletions(this.editor, function (e, t) {
        var n = t.prefix,
            r = t && t.matches;
        if (!r || !r.length) return s(t);
        if (n.indexOf(t.prefix) !== 0 || i != this.gatherCompletionsId) return;
      ...
      }), !r && typeof n != "string" && (r = n), typeof r == "string" && (r = {
        docText: r
      });
  ...
  r.importCssString(i, "settings_menu.css", !1), n.exports.overlayPage = function (t, n, r) {
    function o(e) {
      e.keyCode === 27 && u();
    }
    ...
    return i.style.cssText = "margin: 0; padding: 0; position: fixed; top:0; bottom:0; left:0; right:0;z-index: 9990; " + (t ? "background-color: rgba(0, 0, 0, 0.3);" : ""), i.addEventListener("click", function (e) {
      ...
      e.stopPropagation();
    }), i.appendChild(n), document.body.appendChild(i), t && t.blur(), {
      close: u,
      setIgnoreFocusOut: a
    };
  };
...
}), define("ace/ext/prompt", ["require", "exports", "module", "ace/range", "ace/lib/dom", "ace/ext/menu_tools/get_editor_keyboard_shortcuts", "ace/autocomplete", "ace/autocomplete/popup", "ace/autocomplete/popup", "ace/undomanager", "ace/tokenizer", "ace/ext/menu_tools/overlay_page", "ace/ext/modelist"], function (e, t, n) {
  "use strict";
  ...
  function d(e, t, n, r) {
    function b() {
      ...
      t && !t.error && (E(), n.onAccept && n.onAccept({
        value: e,
        item: t
      }, o));
    }
    ...
    if (_typeof(t) == "object") return d(e, "", t, n);
    ...
    var h = i.buildDom(["div", {
      "class": "ace_prompt_container" + (n.hasDescription ? " input-box-with-description" : "")
    }]),
        v = c(e, h, E);
    ...
    }), o.resize(!0), m && m.resize(!0), o.focus(), p = {
      close: E,
      name: n.name,
      editor: e
    };
  ...
  d.gotoLine = function (e, t) {
    ...
    d(e, ":" + n(e.selection.toJSON()), {
      ...
      getCompletions: function getCompletions(t) {
        var n = t.getValue(),
            r = n.replace(/^:/, "").split(":"),
    ...
    s = s.map(function (e) {
      ...
      addToHistory: function addToHistory(e) {
        var t = this.history();
      ...
      getPrefix: function getPrefix(e) {
        var t = e.getCursorPosition(),
            n = e.getValue();
        return n.substring(0, t.column);
      },
      getCompletions: function getCompletions(e) {
        function t(e, t) {
  ...
  }, i.importCssString(".ace_prompt_container {    max-width: 600px;    width: 100%;    margin: 20px auto;    padding: 3px;    background: white;    border-radius: 2px;    box-shadow: 0px 2px 3px 0px #555;}", "promtp.css", !1), t.prompt = d;
});
