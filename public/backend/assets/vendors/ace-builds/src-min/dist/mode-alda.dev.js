...
define("ace/mode/alda_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  s.metaData = {
    ...
    fileTypes: ["alda"],
    name: "Alda"
  }, r.inherits(s, i), t.AldaHighlightRules = s;
...
}), define("ace/mode/alda", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/alda_highlight_rules", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./alda_highlight_rules").AldaHighlightRules,
