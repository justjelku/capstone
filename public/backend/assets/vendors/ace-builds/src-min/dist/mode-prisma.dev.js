...
define("ace/mode/prisma_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  }, r.inherits(s, i), t.PrismaHighlightRules = s;
...
}), define("ace/mode/prisma", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/prisma_highlight_rules", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./prisma_highlight_rules").PrismaHighlightRules,
  ...
  r.inherits(u, i), function () {
    this.lineCommentStart = "//", this.$id = "ace/mode/prisma";
