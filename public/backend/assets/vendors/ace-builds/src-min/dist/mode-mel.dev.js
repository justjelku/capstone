...
define("ace/mode/mel_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
    ...
    this.$rules = {
      start: [{
        ...
        regex: '"',
        push: [{
          token: "constant.character.escape.mel",
          regex: "\\\\."
        }, {
  ...
  r.inherits(s, i), t.MELHighlightRules = s;
...
}), define("ace/mode/mel", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mel_highlight_rules", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./mel_highlight_rules").MELHighlightRules,
      o = e("./behaviour/cstyle").CstyleBehaviour,
      u = e("./folding/cstyle").FoldMode,
      a = function a() {
    this.HighlightRules = s, this.$behaviour = new o(), this.foldingRules = new u();
  };
