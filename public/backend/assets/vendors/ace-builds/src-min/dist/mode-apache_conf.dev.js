...
define("ace/mode/apache_conf_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  }, r.inherits(s, i), t.ApacheConfHighlightRules = s;
...
}), define("ace/mode/apache_conf", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/apache_conf_highlight_rules", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";

  var r = e("../lib/oop"),
      i = e("./text").Mode,
      s = e("./apache_conf_highlight_rules").ApacheConfHighlightRules,
  ...
  r.inherits(u, i), function () {
    this.lineCommentStart = "#", this.$id = "ace/mode/apache_conf";
