...
define("ace/mode/slim_highlight_rules", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
    ...
    this.$rules = {
      start: [{
        ...
        next: [{
          ...
          token: "string",
          regex: /.+/,
          onMatch: function onMatch(e, t, n, i) {
            var s = n[2][0],
                o = n[2][1],
                u = n[1];
...
}), define("ace/mode/css_completions", ["require", "exports", "module"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/css", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/css_highlight_rules", "ace/mode/matching_brace_outdent", "ace/worker/worker_client", "ace/mode/css_completions", "ace/mode/behaviour/css", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/markdown_highlight_rules", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules", "ace/mode/html_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/folding/markdown", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range"], function (e, t, n) {
  "use strict";
  ...
  r.inherits(o, i), function () {
    this.foldingStartMarker = /^(?:[=-]+\s*$|#{1,6} |`{3})/, this.getFoldWidget = function (e, t, n) {
      ...
      if (l(n)) {
        ...
        if (a > u) while (a > u && /^\s*$/.test(e.getLine(a))) {
          a--;
        }
...
}), define("ace/mode/sh", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sh_highlight_rules", "ace/range", "ace/mode/folding/cstyle", "ace/mode/behaviour/cstyle"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/markdown", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/javascript", "ace/mode/xml", "ace/mode/html", "ace/mode/markdown_highlight_rules", "ace/mode/folding/markdown", "ace/mode/javascript", "ace/mode/html", "ace/mode/sh", "ace/mode/sh", "ace/mode/xml", "ace/mode/css"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/coffee", ["require", "exports", "module", "ace/mode/coffee_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/coffee", "ace/range", "ace/mode/text", "ace/worker/worker_client", "ace/lib/oop"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/scss_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules", "ace/mode/css_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/scss", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/scss_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/folding/cstyle", "ace/mode/css_completions"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/sass_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/scss_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/sass", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sass_highlight_rules", "ace/mode/folding/coffee"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/less_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/css_highlight_rules"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/less", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/less_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/css_completions", "ace/mode/folding/cstyle"], function (e, t, n) {
  "use strict";
...
}), define("ace/mode/ruby_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  "use strict";
  ...
  var o = t.constantNumericHex = {
    ...
    var e = "abort|Array|assert|assert_equal|assert_not_equal|assert_same|assert_not_same|assert_nil|assert_not_nil|assert_match|assert_no_match|assert_in_delta|assert_throws|assert_raise|assert_nothing_raised|assert_instance_of|assert_kind_of|assert_respond_to|assert_operator|assert_send|assert_difference|assert_no_difference|assert_recognizes|assert_generates|assert_response|assert_redirected_to|assert_template|assert_select|assert_select_email|assert_select_rjs|assert_select_encoded|css_select|at_exit|attr|attr_writer|attr_reader|attr_accessor|attr_accessible|autoload|binding|block_given?|callcc|caller|catch|chomp|chomp!|chop|chop!|defined?|delete_via_redirect|eval|exec|exit|exit!|fail|Float|flunk|follow_redirect!|fork|form_for|form_tag|format|gets|global_variables|gsub|gsub!|get_via_redirect|host!|https?|https!|include|Integer|lambda|link_to|link_to_unless_current|link_to_function|link_to_remote|load|local_variables|loop|open|open_session|p|print|printf|proc|putc|puts|post_via_redirect|put_via_redirect|raise|rand|raw|readline|readlines|redirect?|request_via_redirect|require|scan|select|set_trace_func|sleep|split|sprintf|srand|String|stylesheet_link_tag|syscall|system|sub|sub!|test|throw|trace_var|trap|untrace_var|atan2|cos|exp|frexp|ldexp|log|log10|sin|sqrt|tan|render|javascript_include_tag|csrf_meta_tag|label_tag|text_field_tag|submit_tag|check_box_tag|content_tag|radio_button_tag|text_area_tag|password_field_tag|hidden_field_tag|fields_for|select_tag|options_for_select|options_from_collection_for_select|collection_select|time_zone_select|select_date|select_time|select_datetime|date_select|time_select|datetime_select|select_year|select_month|select_day|select_hour|select_minute|select_second|file_field_tag|file_field|respond_to|skip_before_filter|around_filter|after_filter|verify|protect_from_forgery|rescue_from|helper_method|redirect_to|before_filter|send_data|send_file|validates_presence_of|validates_uniqueness_of|validates_length_of|validates_format_of|validates_acceptance_of|validates_associated|validates_exclusion_of|validates_inclusion_of|validates_numericality_of|validates_with|validates_each|authenticate_or_request_with_http_basic|authenticate_or_request_with_http_digest|filter_parameter_logging|match|get|post|resources|redirect|scope|assert_routing|translate|localize|extract_locale_from_tld|caches_page|expire_page|caches_action|expire_action|cache|expire_fragment|expire_cache_for|observe|cache_sweeper|has_many|has_one|belongs_to|has_and_belongs_to_many|p|warn|refine|using|module_function|extend|alias_method|private_class_method|remove_method|undef_method",
        t = "alias|and|BEGIN|begin|break|case|class|def|defined|do|else|elsif|END|end|ensure|__FILE__|finally|for|gem|if|in|__LINE__|module|next|not|or|private|protected|public|redo|rescue|retry|return|super|then|undef|unless|until|when|while|yield|__ENCODING__|prepend",
        n = "true|TRUE|false|FALSE|nil|NIL|ARGF|ARGV|DATA|ENV|RUBY_PLATFORM|RUBY_RELEASE_DATE|RUBY_VERSION|STDERR|STDIN|STDOUT|TOPLEVEL_BINDING|RUBY_PATCHLEVEL|RUBY_REVISION|RUBY_COPYRIGHT|RUBY_ENGINE|RUBY_ENGINE_VERSION|RUBY_DESCRIPTION",
      ...
      "invalid.deprecated": "debugger"
        ...
        d = "\\\\(?:n(?:[1-7][0-7]{0,2}|0)|[nsrtvfbae'\"\\\\]|c(?:\\\\M-)?.|M-(?:\\\\C-|\\\\c)?.|C-(?:\\\\M-)?.|[0-7]{3}|x[\\da-fA-F]{2}|u[\\da-fA-F]{4}|u{[\\da-fA-F]{1,6}(?:\\s[\\da-fA-F]{1,6})*})",
        v = {
      "(": ")",
      "[": "]",
      "{": "}",
    ...
    this.$rules = {
      start: [{
        ...
        onMatch: function onMatch(e, t, n) {
          n.length && (n = []);
          var r = e[e.length - 1];
          return n.unshift(r, t), this.next = "qStateWithoutInterpolation", this.token;
        }
      }, {
        token: "string.start",
        regex: /%[QWX]?([(\[<{^|%])/,
        onMatch: function onMatch(e, t, n) {
          n.length && (n = []);
          var r = e[e.length - 1];
          return n.unshift(r, t), this.next = "qStateWithInterpolation", this.token;
        }
      }, {
        token: "constant.other.symbol.ruby",
        regex: /%[si]([(\[<{^|%])/,
        onMatch: function onMatch(e, t, n) {
          n.length && (n = []);
          var r = e[e.length - 1];
          return n.unshift(r, t), this.next = "sStateWithoutInterpolation", this.token;
        }
      }, {
        token: "constant.other.symbol.ruby",
        regex: /%[SI]([(\[<{^|%])/,
        onMatch: function onMatch(e, t, n) {
          n.length && (n = []);
          var r = e[e.length - 1];
          return n.unshift(r, t), this.next = "sStateWithInterpolation", this.token;
        }
      }, {
        token: "string.regexp",
        regex: /%[r]([(\[<{^|%])/,
        ...
        stateName: "heredoc",
        onMatch: function onMatch(e, t, n) {
          var r = e[2] == "-" || e[2] == "~" ? "indentedHeredoc" : "heredoc",
              i = e.split(this.splitRegex);
          return n.push(r, i[3]), [{
            type: "constant",
            value: i[1]
        ...
        regex: "[\\])}]",
        onMatch: function onMatch(e, t, n) {
          return this.next = "", e == "}" && n.length > 1 && n[1] != "start" && (n.shift(), this.next = n.shift()), this.token;
        }
      }, {
        token: "text",
        regex: "\\s+"
      ...
      qStateWithInterpolation: [{
        ...
        regex: /[(\[<{]/,
        onMatch: function onMatch(e, t, n) {
          return n.length && e === n[0] ? (n.unshift(e, t), this.token) : "string";
        }
      }, {
        token: "constant.language.escape",
        regex: d
        ...
        regex: /[)\]>}^|%]/,
        onMatch: function onMatch(e, t, n) {
          return n.length && e === v[n[0]] ? (n.shift(), this.next = n.shift(), this.token) : (this.next = "", "string");
        }
      }, {
        defaultToken: "string"
      }],
      ...
      sStateWithoutInterpolation: [{
        ...
        regex: /[(\[<{]/,
        onMatch: function onMatch(e, t, n) {
          return n.length && e === n[0] ? (n.unshift(e, t), this.token) : "constant.other.symbol.ruby";
        }
      }, {
        token: "constant.other.symbol.ruby",
        regex: /[)\]>}^|%]/,
        onMatch: function onMatch(e, t, n) {
          return n.length && e === v[n[0]] ? (n.shift(), this.next = n.shift(), this.token) : (this.next = "", "constant.other.symbol.ruby");
        }
      }, {
      ...
      rState: [{
        ...
        regex: /[(\[<{]/,
        onMatch: function onMatch(e, t, n) {
          return n.length && e === n[0] ? (n.unshift(e, t), this.token) : "constant.language.escape";
        }
      }, {
        token: "paren.start",
        regex: /#{/,
        ...
        regex: /[)\]>}^|%][imxouesn]*/,
        onMatch: function onMatch(e, t, n) {
          return n.length && e[0] === v[n[0]] ? (n.shift(), this.next = n.shift(), this.token) : (this.next = "", "constant.language.escape");
        }
      }, {
        include: "regex"
      }, {
...
}), define("ace/mode/folding/ruby", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range", "ace/token_iterator"], function (e, t, n) {
  "use strict";
  ...
  r.inherits(u, i), function () {
    this.indentKeywords = {
      ...
      "=begin": 1,
      "=end": -1
    }, this.foldingStartMarker = /(?:\s|^)(def|do|while|class|unless|module|if|for|until|begin|else|elsif|case|rescue|ensure|when)\b|({\s*$)|(=begin)/, this.foldingStopMarker = /(=end(?=$|\s.*$))|(^\s*})|\b(end)\b/, this.getFoldWidget = function (e, t, n) {
      var r = e.getLine(n),
      ...
      if (i && !s) {
        ...
        if (o[1]) {
          if (o[1] == "if" || o[1] == "else" || o[1] == "while" || o[1] == "until" || o[1] == "unless") {
            if (o[1] == "else" && /^\s*else\s*$/.test(r) === !1) return;
            if (/^\s*(?:if|else|while|until|unless)\s*/.test(r) === !1) return;
          }

          if (o[1] == "when" && /\sthen\s/.test(r) === !0) return;
          if (e.getTokenAt(n, o.index + 2).type === "keyword") return "start";
        } else {
          if (!o[3]) return "start";
          if (e.getTokenAt(n, o.index + 1).type === "comment.multiline") return "start";
        }
      }
      ...
      if (o[3] === "end") {
        ...
        if (!o[1]) return "end";
        if (e.getTokenAt(n, o.index + 1).type === "comment.multiline") return "end";
      }
    }, this.getFoldWidgetRange = function (e, t, n) {
      var r = e.doc.getLine(n),
          i = this.foldingStartMarker.exec(r);
      if (i) return i[1] || i[3] ? this.rubyBlock(e, n, i.index + 2) : this.openingBracketBlock(e, "{", n, i.index);
      var i = this.foldingStopMarker.exec(r);
      if (i) return i[3] === "end" && e.getTokenAt(n, i.index + 1).type === "keyword" ? this.rubyBlock(e, n, i.index + 1) : i[1] === "=end" && e.getTokenAt(n, i.index + 1).type === "comment.multiline" ? this.rubyBlock(e, n, i.index + 1) : this.closingBracketBlock(e, "}", n, i.index + i[0].length);
    }, this.rubyBlock = function (e, t, n, r) {
      var i = new o(e, t, n),
          u = i.getCurrentToken();
      if (!u || u.type != "keyword" && u.type != "comment.multiline") return;
      var a = u.value,
          f = e.getLine(t);
      ...
      var p = c === -1 ? e.getLine(t - 1).length : e.getLine(t).length,
          d = t,
          v = [];
      v.push(i.getCurrentTokenRange()), i.step = c === -1 ? i.stepBackward : i.stepForward;
      if (u.type == "comment.multiline") while (u = i.step()) {
        ...
        switch (u.value) {
          case "do":
            for (var y = i.$tokenIndex - 1; y >= 0; y--) {
              ...
              if (b && (b.value == "while" || b.value == "until" || b.value == "for")) {
                g = 0;
                break;
              }
            }
        ...
        if (g > 0) h.unshift(u.value);else if (g <= 0 && m === !1) {
          h.shift();

          if (!h.length) {
            if ((a == "while" || a == "until" || a == "for") && u.value != "do") break;
      ...
      if (c === -1) {
        if (u.type === "comment.multiline") var w = 6;else var w = e.getLine(t).length;
...
}), define("ace/mode/ruby", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ruby_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/ruby"], function (e, t, n) {
  "use strict";
  ...
  var r = e("../lib/oop"),
      ...
      l = function l() {
    this.HighlightRules = s, this.$outdent = new o(), this.$behaviour = new a(), this.foldingRules = new f(), this.indentKeywords = this.foldingRules.indentKeywords;
  };
    ...
    this.lineCommentStart = "#", this.getNextLineIndent = function (e, t, n) {
      ...
      if (e == "start") {
        var o = t.match(/^.*[\{\(\[]\s*$/),
            ...
            a = t.match(/.*do(\s*|\s+\|.*\|\s*)$/),
            f = t.match(/^\s*(if|else|when|elsif|unless|while|for|begin|rescue|ensure)\s*/);
        if (o || u || a || f) r += n;
      }

      return r;
    }, this.checkOutdent = function (e, t, n) {
      return /^\s+(end|else|rescue|ensure)$/.test(t + n) || this.$outdent.checkOutdent(t, n);
    }, this.autoOutdent = function (e, t, n) {
      var r = t.getLine(n);
      ...
      if (i && i.value in this.indentKeywords) return this.foldingRules.rubyBlock(e, t, n, !0);
    }, this.$id = "ace/mode/ruby", this.snippetFileId = "ace/snippets/ruby";
  }.call(l.prototype), t.Mode = l;
}), define("ace/mode/slim", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/slim_highlight_rules", "ace/mode/javascript", "ace/mode/markdown", "ace/mode/coffee", "ace/mode/scss", "ace/mode/sass", "ace/mode/less", "ace/mode/ruby", "ace/mode/css"], function (e, t, n) {
  "use strict";
