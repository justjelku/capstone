...
define("ace/occur", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search", "ace/edit_session", "ace/search_highlight", "ace/lib/dom"], function (e, t, n) {
  "use strict";
  ...
  var f = e("./lib/dom");
  f.importCssString(".ace_occur-highlight {\n    border-radius: 4px;\n    background-color: rgba(87, 255, 8, 0.25);\n    position: absolute;\n    z-index: 4;\n    box-sizing: border-box;\n    box-shadow: 0 0 4px rgb(91, 255, 50);\n}\n.ace_dark .ace_occur-highlight {\n    background-color: rgb(80, 140, 85);\n    box-shadow: 0 0 4px rgb(60, 120, 70);\n}\n", "incremental-occur-highlighting", !1), t.Occur = a;
}), define("ace/commands/occur_commands", ["require", "exports", "module", "ace/config", "ace/occur", "ace/keyboard/hash_handler", "ace/lib/oop"], function (e, t, n) {
  function f() {}
...
}), define("ace/commands/incremental_search_commands", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/keyboard/hash_handler", "ace/commands/occur_commands"], function (e, t, n) {
  function u(e) {
    this.$iSearch = e;
  }
  ...
  t.iSearchStartCommands = [{
    ...
    exec: function exec(e) {
      var t = e.$editor,
          ...
          r = n && n.cache ? n.cache.reduce(function (e, t) {
        return e.concat(t ? t : []);
      }, []) : [];
...
}), define("ace/incremental_search", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search", "ace/search_highlight", "ace/commands/incremental_search_commands", "ace/lib/dom", "ace/commands/command_manager", "ace/editor", "ace/config"], function (e, t, n) {
  "use strict";
  ...
  var d = e("./lib/dom");
  d.importCssString(".ace_marker-layer .ace_isearch-result {  position: absolute;  z-index: 6;  box-sizing: border-box;}div.ace_isearch-result {  border-radius: 4px;  background-color: rgba(255, 200, 0, 0.5);  box-shadow: 0 0 4px rgb(255, 200, 0);}.ace_dark div.ace_isearch-result {  background-color: rgb(100, 110, 160);  box-shadow: 0 0 4px rgb(80, 90, 140);}", "incremental-search-highlighting", !1);
...
}), define("ace/keyboard/emacs", ["require", "exports", "module", "ace/lib/dom", "ace/incremental_search", "ace/commands/incremental_search_commands", "ace/keyboard/hash_handler", "ace/lib/keys"], function (e, t, n) {
  "use strict";
  ...
  p.forEach(function (e) {
    ...
    _typeof(e) == "object" && (e = e[this.platform]);
    if (!e) return;
    ...
    if (o == "c-" || e.count) {
      ...
      if (typeof u == "number" && !isNaN(u)) return e.count = Math.max(e.count, 0) || 0, e.count = 10 * e.count + u, {
        command: "null"
      };
    }
    ...
    if (a === "universalArgument") return e.count = -4, {
      command: "null"
    };
    var f;
    ...
    if (e.count) {
      ...
      f || (f = {}), _typeof(f) == "object" && (f.count = u);
    }
    ...
    recenterTopBottom: function recenterTopBottom(e) {
      var t = e.renderer,
    ...
    selectRectangularRegion: function selectRectangularRegion(e) {
    ...
    setMark: {
      exec: function exec(e, t) {
        ...
        if (s && (n || !o)) {
          e.inMultiSelectMode ? e.forEachSelection({
            exec: e.clearSelection.bind(e)
          }) : e.clearSelection(), n && e.pushEmacsMark(null);
          return;
        }
    ...
    yankRotate: function yankRotate(e) {
    ...
    killRingSave: {
      exec: function exec(e) {
        ...
        t.killRing.add(e.getCopyText()), setTimeout(function () {
          ...
          e.$handlesEmacsOnCopy = !1, e.inMultiSelectMode ? e.forEachSelection({
            exec: t
          }) : t(), e.setEmacsMark(null), e.session.$emacsMarkRing = n.concat(r.reverse());
        }, 0);
      },
      readOnly: !0
    },
    keyboardQuit: function keyboardQuit(e) {
      e.selection.clearSelection(), e.setEmacsMark(null), e.keyBinding.$data.count = null;
    },
    focusCommandLine: function focusCommandLine(e, t) {
