 ...
 */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).ApexCharts = e();
}(void 0, function () {
  "use strict";
    ...
    return r(t, [{
      ...
      value: function value(t) {
        ...
        l.push(n.config.chart.toolbar["export"].csv.headerCategory), i.map(function (t, e) {
          ...
          n.globals.axisCharts && l.push(i.split(s).join("") ? i.split(s).join("") : "series-".concat(e));
          ...
          n.globals.axisCharts ? function (t, e) {
            if (l.length && 0 === e && h.push(l.join(s)), t.data && t.data.length) for (var a = 0; a < t.data.length; a++) {
              ...
              if (r || (d.isFormatXY() ? r = i[e].data[a].x : d.isFormat2DArray() && (r = i[e].data[a] ? i[e].data[a][0] : "")), 0 === e) {
                ...
                for (var o = 0; o < n.globals.series.length; o++) {
                  d.isFormatXY() ? l.push(i[o].data[a].y) : l.push(n.globals.series[o][a]);
                }
              }
