...
$(function () {
  ...
  var fontFamily = "'Roboto', Helvetica, sans-serif"; // Apex Line chart start
  ...
  if ($('#apexArea').length) {
    ...
    var generateDayWiseTimeSeries = function generateDayWiseTimeSeries(s, count) {
  ...
  if ($('#apexMixed').length) {
    ...
    var chart = new ApexCharts(document.querySelector("#apexMixed"), options);
    chart.render();
  ...
  if ($('#apexScatter').length) {
    ...
    var chart = new ApexCharts(document.querySelector("#apexScatter"), options);
    chart.render();
